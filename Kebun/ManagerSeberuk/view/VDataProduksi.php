...
if ($jabatan_valid == 'Manager Seberuk') {
...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksi, "SELECT * FROM produksi_karet a  WHERE tanggal = '$tanggal_awal'");
  $table2 = mysqli_query($koneksi, "SELECT SUM (keping) AS total_keping, nama_buruh FROM produksi_karet a  WHERE tanggal = '$tanggal_awal' GROUP BY nama_buruh");
  ...
  $table = mysqli_query($koneksi, "SELECT * FROM produksi_karet a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $table2 = mysqli_query($koneksi, "SELECT SUM(keping) AS total_keping, nama_buruh FROM produksi_karet a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_buruh");
