...
';
    ...
    while($data = mysqli_fetch_array($table)){
        ...
        <h3 class="panel-title" align="Center" style = "margin-bottom: 1px; margin-top: 1px;"><img style=" max-height: 50px; width: 100%; text-align:center; ">GAJI KARYAWAN KEBUN SEBERUK</h3>
