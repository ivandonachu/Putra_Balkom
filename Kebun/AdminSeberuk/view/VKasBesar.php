...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table2 = mysqli_query($koneksi, "SELECT * FROM kas_besar_seberuk a  WHERE tanggal = '$tanggal_awal' GROUP BY nama_akun");
  ...
  $table2 = mysqli_query($koneksi, "SELECT * FROM kas_besar_seberuk a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_akun");
