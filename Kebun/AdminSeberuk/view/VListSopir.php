...
$table = mysqli_query($koneksi, "SELECT * FROM list_sopir_seberuk");
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VListSopir><h5 class='text-center sm' style='color:white; margin-top: 8px; '>List Sopir</h5></a>"; ?>
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
   ...
   <div class="row">
    ...
    <div class="col-md-2">
      ...
      <div align="right">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i>Tambah Sopir</button> <br> <br>
      </div>
      <!-- Form Modal  -->
       ...
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          <div class="modal-header">
            <h5 class="modal-title"> Form Pencatatan Sopir</h5>
          ...
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/proses_sopir_seberuk' enctype='multipart/form-data' method='POST'>";  ?>
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input class="form-control form-control-sm" type="text" id="nama_sopir" name="nama_sopir" required="">
              </div>    
...
<table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table)){
      $no_sopir = $data['no_sopir'];
      $nama_sopir =$data['nama_sopir'];
      $no_urut = $no_urut +1;
      echo "<tr>
      <td style='font-size: 14px' align = 'center'>$no_urut</td>
      <td style='font-size: 14px' align = 'center'>$nama_sopir</td>
      "; ?>
      <?php echo "<td style='font-size: 12px' align = 'center'>"; ?>
      <button href="#" type="button" class="fas fa-edit bg-warning mr-2 rounded" data-toggle="modal" data-target="#formedit<?php echo $data['no_sopir']; ?>">Edit</button>

      <!-- Form EDIT DATA -->

      <div class="modal fade" id="formedit<?php echo $data['no_sopir']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role ="document">
          <div class="modal-content"> 
            <div class="modal-header">
            ...
            <div class="modal-body">
              <form action="../proses/edit_sopir_seberuk" enctype="multipart/form-data" method="POST">

                <input type="hidden" name="no_sopir" value="<?php echo $no_sopir;?>"> 

                 <div class="row">
              <div class="col-md-6">
                <label>Nama Sopir</label>
                <input class="form-control form-control-sm" type="text" id="nama_sopir" name="nama_sopir" required="" value="<?php echo $nama_sopir;?>">
              </div>    
...
<!-- Button Hapus -->
<button href="#" type="submit" class="fas fa-trash-alt bg-danger mr-2 rounded" data-toggle="modal" data-target="#PopUpHapus<?php echo $data['no_sopir']; ?>" data-toggle='tooltip' title='Hapus Data Dokumen'>Hapus</button>
<div class="modal fade" id="PopUpHapus<?php echo $data['no_sopir']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
 <div class="modal-dialog" role ="document">
   <div class="modal-content"> 
    ...
    <div class="modal-body">
      <form action="../proses/hapus_sopir_seberuk" method="POST">
        <input type="hidden" name="no_sopir" value="<?php echo $no_sopir;?>">
