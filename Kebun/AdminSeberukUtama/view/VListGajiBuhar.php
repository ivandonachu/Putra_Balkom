...
?>
 ...
 <head>
  ...
  <title>List Gaji Buruh Harian Seberuk</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VListGaji'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>List Gaji Buruh Harian Seberuk</h5></a>"; ?>
       ...
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          <div class="modal-header">
            <h5 class="modal-title">Persetujuan Rekap Gaji Buruh Harian</h5>
          ...
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/proses_rekap_gaji_burhar_seberuk' enctype='multipart/form-data' method='POST'>";  ?>
      ...
      <div class="modal fade bd-example-modal-lg" id="input" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <!-- Form Input Data -->
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/proses_list_gaji_burhar_seberuk' enctype='multipart/form-data' method='POST'>";  ?>
    ...
    <tr>  
      ...
      ?>
        ...
        <?php while($data2 = mysqli_fetch_array($table)){
          $no_buruh_harian = $data2['no_buruh_harian'];
          ...
          <button href="#" type="button" class="fas fa-edit bg-warning mr-2 rounded" data-toggle="modal" data-target="#formedit<?php echo $data2['no_buruh_harian']; ?>">Edit</button>

          <!-- Form EDIT DATA -->

          <div class="modal fade bd-example-modal-lg" id="formedit<?php echo $data2['no_buruh_harian']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
           <div class="modal-dialog modal-lg" role ="document">
             <div class="modal-content"> 
              <div class="modal-header">
          ...
          <div class="modal-body">
              <form action="../proses/edit_list_gaji_buhar_seberuk" enctype="multipart/form-data" method="POST">
                
            <input type="hidden" name="no_buruh_harian" value="<?php echo $no_buruh_harian;?>"> 
...
<div class="modal fade" id="PopUpHapus<?php echo $no_buruh_harian; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
 <div class="modal-dialog" role ="document">
   <div class="modal-content"> 
    <div class="modal-header">
      <h4 class="modal-title"> <b> Hapus Gaji Buruh Harian </b> </h4>
      <button type="button" class="close" data-dismiss="modal" aria-label="close">
        <span aria-hidden="true"> &times; </span>
      </button>
    </div>
    ...
    <div class="modal-body">
      <form action="../proses/hapus_list_gaji_buhar_seberuk" method="POST">
        <input type="hidden" name="no_buruh_harian" value="<?php echo $no_buruh_harian;?>">
