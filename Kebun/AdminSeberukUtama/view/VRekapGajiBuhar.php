...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM rekap_gaji_burhar_seberuk WHERE tanggal = '$tanggal_awal'");
...
?>
 ...
 <head>
  ...
  <title>Rekap Gaji Buruh Harian Seberuk</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VRekapGaji'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Rekap Gaji Buruh Harian Seberuk</h5></a>"; ?>
...
<div>   
  ...
  <?php echo "<form  method='POST' action='VRekapGajiBuhar' style='margin-bottom: 15px;'>" ?>
            <div>
  ...
  <div class="row">
    ...
    <div class="col-md-2">
      ...
      <div align="right">
      <?php echo "<a href='VPrintSlipGajiBuhar?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' target='_blank'><button style='color:black;
       ...
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/hapus_seluruh_rekap_gaji_burhar_seberuk?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
    ...
    <div class="col-md-2">
      ...
      <div class="modal fade bd-example-modal-lg" id="input" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          <div class="modal-header">
            <h5 class="modal-title"> Form Gaji Buruh Harian</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div> 
          ...
          <!-- Form Input Data -->
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/proses_tambah_rekap_gaji_burhar_seberuk?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
            ...
            <div class="row">
              <div class="col-md-3">
                ...
                <div class="col-md-3">
                <label>HK</label>
                <input class="form-control form-control-sm" type="text" name="hk" required="" >
                </div>
                <div class="col-md-3">
                <label>Upah</label>
                <input class="form-control form-control-sm" type="number" name="upah" required="" value="0">
                </div>
           </div>
...
<div style="overflow-x: auto" align = 'center';>
  ...
  <thead>
    <tr>  
          ...
          <th style="font-size: 14px" scope="col">Nama Buruh Harian</th>
          <th style="font-size: 14px" scope="col">HK</th>
          <th style="font-size: 14px" scope="col">Upah</th>
      ...
      ?>
        ...
        <?php while($data2 = mysqli_fetch_array($table)){
          ...
          <td style='font-size: 14px'>$nama_buruh_harian</td>
          <td style='font-size: 14px'>$hk Hari</td>
          <td style='font-size: 14px'>"; ?> <?= formatuang($upah); ?> <?php echo " / Hari</td>
          ...
          <div class="modal fade bd-example-modal-lg" id="formedit<?php echo $data2['no_riwayat']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
           <div class="modal-dialog modal-lg" role ="document">
             <div class="modal-content"> 
              <div class="modal-header">
                <h5 class="modal-title"> Form Edit Gaji Buruh Harian </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="close">
                  <span aria-hidden="true"> &times; </span>
                </button>
              </div>
          ...
          <div class="modal-body">
              <?php  echo "<form action='../proses/edit_rekap_gaji_burhar_seberuk?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
               <label>Nama Buruh Harian</label>
               <input class="form-control form-control-sm" type="text" name="nama_buruh_harian" required="" value="<?php echo $nama_buruh_harian;?>">
             </div>
            </div>
            <div class="row">
             <div class="col-md-4">
               <label>HK</label>
               <input class="form-control form-control-sm" type="text" name="hk" required="" value="<?php echo $hk;?>">
             </div>
             <div class="col-md-4">
               <label>Upah</label>
...
<div class="modal fade" id="PopUpHapus<?php echo $no_riwayat; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
 <div class="modal-dialog" role ="document">
   <div class="modal-content"> 
    <div class="modal-header">
      <h4 class="modal-title"> <b> Hapus Rekap Gaji Buruh Harian </b> </h4>
      <button type="button" class="close" data-dismiss="modal" aria-label="close">
        <span aria-hidden="true"> &times; </span>
      </button>
    </div>
    ...
    <div class="modal-body">
      ...
      <?php  echo "<form action='../proses/hapus_rekap_gaji_burhar_seberuk?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' method='POST'>";  ?>
        <input type="hidden" name="no_riwayat" value="<?php echo $no_riwayat;?>">
