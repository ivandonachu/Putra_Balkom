...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksi, "SELECT * FROM absensi_foto_seberuk a  WHERE tanggal = '$tanggal_awal'");
} else {

    $table = mysqli_query($koneksi, "SELECT * FROM absensi_foto_seberuk a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
}
...
<head>
    ...
    <title>Absensi Foto Seberuk</title>
            ...
            <div id="content">
                ...
                <div>
                    ...
                    <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                        ...
                        <?php echo "<form  method='POST' action='VAbsenfoto' style='margin-bottom: 15px;'>" ?>
                        <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <div align="right">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i> Catat Absen Foto </button> <br> <br>
                                </div>
                                <!-- Form Modal  -->
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" align="left">
                                                <?php echo "<form action='../proses/proses_absen_foto?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                            ...
                            <table id="example" class="table-sm table-striped table-bordered  nowrap" style="width:auto">
                                ...
                                <tbody>
                                    ...
                                    <?php while ($data = mysqli_fetch_array($table)) {
                                        ...
                                        <button href="#" type="button" class="fas fa-edit bg-warning mr-2 rounded" data-toggle="modal" data-target="#formlihat<?php echo $data['no_laporan']; ?>">Lihat</button>

                                        <!-- Form EDIT DATA -->

                                        <div class="modal fade" id="formlihat<?php echo $data['no_laporan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <img style="height: 100%; width: 100%;" s src="/Kebun/AdminSeberukUtama/file_admin_seberuk/<?= $file_bukti ?>">
                                                    </div>

                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-primary"><a style="color: black;" download="/Kebun/AdminSeberukUtama/file_admin_seberuk/<?= $file_bukti ?>" href="/Kebun/AdminSeberukUtama/file_admin_seberuk/<?= $file_bukti ?>">Download</a> </button>
                                        ...
                                        <div class="modal fade bd-example-modal-lg" id="formedit<?php echo $data['no_laporan']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">Form Edit Absen </h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="close">
                                                            <span aria-hidden="true"> &times; </span>
                                                        </button>
                                                    </div>
                                                    ...
                                                    <!-- Form Edit Data -->
                                                    <div class="modal-body">
                                                        <form action="../proses/edit_absen_foto" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="modal fade bd-example-modal-lg" id="PopUpHapus<?php echo $data['no_laporan']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="../proses/hapus_absen_foto" method="POST">
                                                            <input type="hidden" name="no_laporan" value="<?php echo $no_laporan; ?>">
                                                            <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
                                                            <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir; ?>">
