...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksi, "SELECT * FROM pengeluaran_buah_seberuk a  WHERE tanggal = '$tanggal_awal'");
  $table2 = mysqli_query($koneksi, "SELECT  nama_akun , SUM(jumlah) as total_jumlah FROM pengeluaran_buah_seberuk a  WHERE tanggal = '$tanggal_awal' GROUP BY nama_akun");
  

}
else{

  $table = mysqli_query($koneksi, "SELECT * FROM pengeluaran_buah_seberuk a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $table2 = mysqli_query($koneksi, "SELECT nama_akun , SUM(jumlah) as total_jumlah FROM pengeluaran_buah_seberuk a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_akun");
...
<head>
  ...
  <title>Pengeluaran Buah Seberuk</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VKasKecil?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Pengeluaran Buah Seberuk</h5></a>"; ?>
...
<div>   
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
    ...
    <?php  echo "<form  method='POST' action='VPengeluaranBuahSeberuk' style='margin-bottom: 15px;'>" ?>
    <div>
     ...
     <div class="modal-dialog modal-lg" role ="document">
       <div class="modal-content"> 
        <div class="modal-header">
          <h5 class="modal-title"> Form Pengeluaran Buah Seberuk </h5>
        ...
        <div class="modal-body" align="left">
          <?php  echo "<form action='../proses/proses_pengeluaran_buah_seberuk?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
            ...
            <div class="col-md-6">
                 <label>Akun</label>
                    <select class="form-control form-control-sm" name="nama_akun" class="form-control ">
                        <option>Biaya Alat Berat</option>
                        <option>BHL</option>
...
<div class="modal fade bd-example-modal-lg" id="formedit<?php echo $data['no_pengeluaran']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <div class="modal-content"> 
      ...
      <div class="modal-body">
        <form action="../proses/edit_pengeluaran_buah_seberuk" enctype="multipart/form-data" method="POST">
            ...
            <div class="col-md-6">
                 <label>Akun</label>
                    <select class="form-control form-control-sm" name="nama_akun" class="form-control ">
                        ...
                        <option <?php echo ($dataSelect == 'Biaya Alat Berat') ? "selected": "" ?> >Biaya Alat Berat</option>
                        <option <?php echo ($dataSelect == 'BHL') ? "selected": "" ?> >BHL</option>
                        ...
                        <option <?php echo ($dataSelect == 'Biaya Perawatan') ? "selected": "" ?> >Biaya Perawatan</option>
                        ...
                        <option <?php echo ($dataSelect == 'Biaya Pestisida') ? "selected": "" ?> >Biaya Pestisida</option>
       ...
       <div class="modal fade bd-example-modal-lg" id="PopUpHapus<?php echo $data['no_pengeluaran']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body">
            <form action="../proses/hapus_pengeluaran_buah_seberuk" method="POST">
              <input type="hidden" name="no_pengeluaran" value="<?php echo $no_pengeluaran; ?>">
              <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
              <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir;?>">
