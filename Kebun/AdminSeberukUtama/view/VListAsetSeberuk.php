...
$table = mysqli_query($koneksi, "SELECT * FROM list_aset_seberuk");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                    <?php echo "<a href='VListKendaraan><h5 class='text-center sm' style='color:white; margin-top: 8px; '>List Aset Seberuk</h5></a>"; ?>
                    ...
                    <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <div align="right">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i>Tambah Aset Seberuk</button> <br> <br>
                                </div>
                                <!-- Form Modal  -->
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"> Form Pencatatan Aset Seberuk</h5>
                                            ...
                                            <div class="modal-body" align="left">
                                                <?php echo "<form action='../proses/proses_aset_seberuk' enctype='multipart/form-data' method='POST'>";  ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control form-control-sm" type="text" name="jumlah_aset" required="">
                                                    </div>
                        ...
                        <table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
                            ...
                            <tbody>
                                ...
                                <?php while ($data = mysqli_fetch_array($table)) {
                                    ...
                                    <td style='font-size: 14px' align = 'center'>$jumlah_aset</td>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="../proses/edit_aset_seberuk" enctype="multipart/form-data" method="POST">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <label>Jumlah Aset</label>
                                                                <input class="form-control form-control-sm" type="text" name="jumlah_aset" required="" value="<?php echo $jumlah_aset; ?>">
                                                            </div>
                                    ...
                                    <!-- Button Hapus -->
                                    <button href="#" type="submit" class="fas fa-trash-alt bg-danger mr-2 rounded" data-toggle="modal" data-target="#PopUpHapus<?php echo $data['no_aset']; ?>" data-toggle='tooltip' title='Hapus Data Dokumen'>Hapus</button>
                                    <div class="modal fade" id="PopUpHapus<?php echo $data['no_aset']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="../proses/hapus_aset_seberuk" method="POST">
                                                        <input type="hidden" name="no_aset" value="<?php echo $no_aset; ?>">
                                                        <div class="form-group">
