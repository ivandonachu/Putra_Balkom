...
if($no_blok_1 != ''){
    $query = mysqli_query($koneksi,"INSERT INTO laporan_batang  VALUES('','$tanggal','$no_blok_1','$nama_penyadap_1','$jumlah_batang_1','$jumlah_batang_mati_1')");
}

if($no_blok_2 != ''){
    $query = mysqli_query($koneksi,"INSERT INTO laporan_batang  VALUES('','$tanggal','$no_blok_2','$nama_penyadap_2','$jumlah_batang_2','$jumlah_batang_mati_2')");
}

if($no_blok_3 != ''){
    $query = mysqli_query($koneksi,"INSERT INTO laporan_batang  VALUES('','$tanggal','$no_blok_3','$nama_penyadap_3','$jumlah_batang_3','$jumlah_batang_mati_3')");
}

if($no_blok_4 != ''){
    $query = mysqli_query($koneksi,"INSERT INTO laporan_batang  VALUES('','$tanggal','$no_blok_4','$nama_penyadap_4','$jumlah_batang_4','$jumlah_batang_mati_4')");
}

if($no_blok_5 != ''){
    $query = mysqli_query($koneksi,"INSERT INTO laporan_batang  VALUES('','$tanggal','$no_blok_5','$nama_penyadap_5','$jumlah_batang_5','$jumlah_batang_mati_5')");
}

if($no_blok_6 != ''){
    $query = mysqli_query($koneksi,"INSERT INTO laporan_batang  VALUES('','$tanggal','$no_blok_6','$nama_penyadap_6','$jumlah_batang_6','$jumlah_batang_mati_6')");
}

if($no_blok_7 != ''){
    $query = mysqli_query($koneksi,"INSERT INTO laporan_batang  VALUES('','$tanggal','$no_blok_7','$nama_penyadap_7','$jumlah_batang_7','$jumlah_batang_mati_7')");
}

if($no_blok_8 != ''){
    $query = mysqli_query($koneksi,"INSERT INTO laporan_batang  VALUES('','$tanggal','$no_blok_8','$nama_penyadap_8','$jumlah_batang_8','$jumlah_batang_mati_8')");
}

if($no_blok_9 != ''){
    $query = mysqli_query($koneksi,"INSERT INTO laporan_batang  VALUES('','$tanggal','$no_blok_9','$nama_penyadap_9','$jumlah_batang_9','$jumlah_batang_mati_9')");
}

if($no_blok_10 != ''){
    $query = mysqli_query($koneksi,"INSERT INTO laporan_batang  VALUES('','$tanggal','$no_blok_10','$nama_penyadap_10','$jumlah_batang_10','$jumlah_batang_mati_1')");
}
