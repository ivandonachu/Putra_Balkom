...
if ($nama_file == "") {
	...
	if ($file == '') {
            ...
            harga_karet = '$harga' ,total_pendapatan = '$total_pendapatan' , pembagi = '$pembagi' , upah_kotor = '$upah_kotor' , ongkos_angkut = '$oa' , bayar_kompor = '$b_kompor', tank_alpha = '$tank_alpha', cashbon = '$cashbon' , upah_bersih = '$upah_bersih' , keterangan = '$keterangan' 
