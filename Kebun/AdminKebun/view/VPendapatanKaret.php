...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM laporan_karet_lengkiti WHERE tanggal = '$tanggal_akhir' ");
    $table2 = mysqli_query($koneksi, "SELECT SUM(timbang_gudang) AS total_timbang_gudang, SUM(timbang_pabrik) AS total_timbang_pabrik , harga FROM laporan_karet_lengkiti WHERE WHERE tanggal = '$tanggal_akhir'");
    $data2 = mysqli_fetch_array($table2);
    $total_timbang_gudang = $data2['total_timbang_gudang'];
    $total_timbang_pabrik = $data2['total_timbang_pabrik'];
} else {
    $table = mysqli_query($koneksi, "SELECT * FROM laporan_karet_lengkiti WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  ORDER BY tanggal ASC");
    $table2 = mysqli_query($koneksi, "SELECT SUM(timbang_gudang) AS total_timbang_gudang, SUM(timbang_pabrik) AS total_timbang_pabrik , harga FROM laporan_karet_lengkiti WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
    $data2 = mysqli_fetch_array($table2);
    $total_timbang_gudang = $data2['total_timbang_gudang'];
    $total_timbang_pabrik = $data2['total_timbang_pabrik'];
}
...
<head>
    ...
    <title>Laporan Karet Lengkiti</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                    <?php echo "<a href='VPendapatanKaret?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Laporan Karet Lengkiti</h5></a>"; ?>
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" align="left">
                                                <?php echo "<form action='../proses/proses_karet_lengkiti?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="../proses/edit_karet_lengkiti" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="modal fade" id="PopUpHapus<?php echo $data['no_laporan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="../proses/hapus_karet_lengkiti" method="POST">
                                                                <input type="hidden" name="no_laporan" value="<?php echo $no_laporan; ?>">
                                                                <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
                                                                <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir; ?>">
                                                                <div class="form-group">
