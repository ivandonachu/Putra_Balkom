...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM stok_pupuk_msj WHERE tanggal = '$tanggal_awal'");
} else {
  $table = mysqli_query($koneksi, "SELECT * FROM stok_pupuk_msj WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
      ...
      <div id="content">
        ...
        <div>
          ...
          <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
            <?php echo "<form  method='POST' action='VLPupuk' style='margin-bottom: 15px;'>" ?>
            <div>
