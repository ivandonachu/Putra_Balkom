...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM list_aset_mesuji");
    $table2 = mysqli_query($koneksi, "SELECT * FROM monitoring_aset_mesuji WHERE tanggal = '$tanggal_awal'");
} else {
    $table = mysqli_query($koneksi, "SELECT * FROM list_aset_mesuji");
    $table2 = mysqli_query($koneksi, "SELECT * FROM monitoring_aset_mesuji WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                    <?php echo "<a href='VListKendaraan><h5 class='text-center sm' style='color:white; margin-top: 8px; '>List Aset Mesuji</h5></a>"; ?>
                ...
                <div>
                    ...
                    <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                        <?php echo "<form  method='POST' action='VListAsetMesuji' style='margin-bottom: 15px;'>" ?>
                        <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <div align="right">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i>Tambah Aset Mesuji</button> <br> <br>
                                </div>
                                <!-- Form Modal  -->
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"> Form Pencatatan Aset Mesuji</h5>
                            ...
                            <div class="col-md-2">
                                <!-- Button Input Data Bayar -->
                                <div align="right">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#inputmonitoring"> <i class="fas fa-plus-square mr-2"></i>Monitoring Aset Mesuji</button> <br> <br>
                                </div>
                                <!-- Form Modal  -->
                                <div class="modal fade bd-example-modal-lg" id="inputmonitoring" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"> Form Monitoring Aset Mesuji</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select id="tokens" class="selectpicker form-control" name="nama_aset" data-live-search="true">
                                                            ...
                                                            <?php
                                                            include 'koneksi.php';
                                                            $result2 = mysqli_query($koneksi, "SELECT * FROM list_aset_mesuji");
