...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi,"SELECT * FROM laporan_rit_msj  WHERE tanggal ='$tanggal_awal' ");
  $table2 = mysqli_query($koneksi,"SELECT * FROM laporan_rit_msj  WHERE tanggal ='$tanggal_awal' GROUP BY nama_driver ");

}

else{
  $table = mysqli_query($koneksi,"SELECT * FROM laporan_rit_msj WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ");
  $table2 = mysqli_query($koneksi,"SELECT * FROM laporan_rit_msj WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_driver");
...
<div id="content">
    ...
    <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Rit Driver Mesuji</h5></a>"; ?>
         ...
         <div class="row">
             ...
             <div class="col-md-6">
                ...
                <select id="nama_rute" name="nama_rute" class="form-control">
                    ...
                    <option>Muat Pupuk Mesuji Lengkiti</option>
        ...
        <form action="../proses/edit_rit" enctype="multipart/form-data" method="POST">
         ...
         <div class="row">
                ...
                <select id="nama_rute" name="nama_rute" class="form-control">
                    ...
                    <option <?php echo ($dataSelect == 'Muat Pupuk Mesuji Lengkiti') ? "selected": "" ?>>Muat Pupuk Mesuji Lengkiti</option>
...
<h5 align="center" >Rincian Gaji Driver Mesuji</h5>
<!-- Tabel -->    
<div style="overflow-x: auto" align = 'center' >
  ...
  <thead>
    <tr>
      ...
      <th>Rit Kampas Pupuk Mesuji Lenkiti</th>
      <th>Upah Kampas Pupuk Mesuji Lenkiti</th>
      <th>Rit Muat Batu</th>
  ...
  ?>
    <?php while($data = mysqli_fetch_array($table2)){
      ...
      // kebun lengkiti
      $table7 = mysqli_query($koneksi,"SELECT SUM(uang_gaji) AS uang_gaji_kebun_lengkiti , SUM(rit) AS rit_kebun_lengkiti FROM laporan_rit WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  AND  nama_driver = '$nama_driver'AND nama_rute = 'Muat Pupuk Mesuji Lengkiti'");
