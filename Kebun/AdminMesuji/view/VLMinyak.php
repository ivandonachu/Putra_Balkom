...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM laporan_solar_msj WHERE tanggal = '$tanggal_awal'");
} else {
  $table = mysqli_query($koneksi, "SELECT * FROM laporan_solar_msj WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  
  $table2 = mysqli_query($koneksi, "SELECT SUM(jumlah) AS total_stok  FROM laporan_solar_msj 
                                    WHERE  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND keterangan = 'Stok Masuk'");
  $data2 = mysqli_fetch_array($table2);
  $total_stok = $data2['total_stok'];

  $table3 = mysqli_query($koneksi, "SELECT SUM(jumlah) AS total_penggunaan  FROM laporan_solar_msj 
                                    WHERE  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND keterangan = 'Cobelco' ");
  $data3 = mysqli_fetch_array($table3);
  $total_penggunaan = $data3['total_penggunaan'];
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
          <?php echo "<a href='VLMinyak?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Stok Minyak</h5></a>"; ?>
        ...
        <div>
          ...
          <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
            <?php echo "<form  method='POST' action='VLMinyak' style='margin-bottom: 15px;'>" ?>
            <div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div align="right">
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i> Catat Stok Minyak </button> <br> <br>
                </div>
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title"> Form Stok Minyak</h5>
                      ...
                      <div class="modal-body" align="left">
                        <?php echo "<form action='../proses/proses_minyak?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
            ...
            <table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
              ...
              <tbody>
                ...
                <td style='font-size: 14px'>$jumlah Liter</td>"; ?>
                      ...
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="../proses/edit_minyak" enctype="multipart/form-data" method="POST">
                              ...
                              <div class="row">
                                <div class="col-md-6">
                                  ...
                                  <select id="keterangan" name="keterangan" class="form-control">
                                    ...
                                    <option <?php echo ($dataSelect == 'Cobelco') ? "selected" : "" ?>>Cobelco</option>
                                  </select>
                                </div>
                                <div class="col-md-6">
                                <label>Jumlah</label>
                    ...
                    <div class="modal fade" id="PopUpHapus<?php echo $data['no_laporan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="../proses/hapus_minyak" method="POST">
                              <input type="hidden" name="no_laporan" value="<?php echo $no_laporan; ?>">
                              <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
                              <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir; ?>">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            Total Stok Minyak</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=  $total_stok; ?> <?= 'Liter' ?></div>
          </div>
          <div class="col-auto">
    ...
    <div class="card border-left-success shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
            Total Minyak di Gunakan</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_penggunaan; ?> <?= 'Liter' ?></div>
          </div>
          <div class="col-auto">
            <i class="fas fa-gas-pump fa-2x text-gray-300"></i>
          </div>
    ...
    <div class="card border-left-success shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
            Sisa Stok Minyak</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_stok - $total_penggunaan; ?> <?= 'Liter' ?></div>
          </div>
          <div class="col-auto">
           <i class="fas fa-gas-pump  fa-2x text-gray-300"></i>
          </div>
