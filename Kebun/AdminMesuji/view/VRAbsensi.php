...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT *, SUM(rit) AS jumlah_absensi, SUM(potongan_bon) AS total_potongan FROM absensi_mesuji WHERE tanggal = '$tanggal_akhir' GROUP BY nama_karyawan ");
} else {
    $table = mysqli_query($koneksi, "SELECT *, SUM(rit) AS jumlah_absensi, SUM(potongan_bon) AS total_potongan FROM absensi_mesuji WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_karyawan");
}
