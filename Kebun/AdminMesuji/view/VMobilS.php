...
$table = mysqli_query($koneksi, "SELECT * FROM kendaraan_sawit_msj");
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VMobilS'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Kendaraan Sawit</h5></a>"; ?>
