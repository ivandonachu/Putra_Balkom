...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi,"SELECT * FROM laporan_kegiatan_msj WHERE tanggal ='$tanggal_awal' ");
}

else{
  $table = mysqli_query($koneksi,"SELECT * FROM laporan_kegiatan_msj WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ");
