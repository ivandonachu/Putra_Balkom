...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM laporan_batang_msj  WHERE tanggal ='$tanggal_awal' ");
} else {
    $table = mysqli_query($koneksi, "SELECT * FROM laporan_batang_msj WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ");
}
...
<head>
    ...
    <title>Laporan Batang Karet</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                    <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Laporan Batang Karet</h5></a>"; ?>
                ...
                <div>
                    ...
                    <div style="margin-right: 100px; margin-left: 100px;">
                        ...
                        <?php echo "<form  method='POST' action='VLBatang'>" ?>
                        <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <div align="right">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i>Input Laporan</button> <br> <br>
                                </div>
                                <!-- Form Modal  -->
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"> Form Pencatatan Batang Karet</h5>
                                            ...
                                            <div class="modal-body" align="left">
                                                <?php echo "<form action='../proses/proses_batang?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                        ...
                        <table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
                            ...
                            <tbody>
                                <?php
                                $urut = 0;
                                $total_seluruh_batang = 0;
                                $total_seluruh_batang_mati = 0;
                                ...
                                <?php while ($data = mysqli_fetch_array($table)) {
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="../proses/edit_batang" enctype="multipart/form-data" method="POST">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <label>Jumlah Batang</label>
                                                                <input class="form-control form-control-sm" type="text" name="jumlah_batang" value="<?php echo $jumlah_batang; ?>" required="">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label>Jumlah Batang Mati</label>
                                    ...
                                    <div class="modal fade" id="PopUpHapus<?php echo $data['no_laporan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title"> <b> Hapus Data </b> </h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="close">
                                                        <span aria-hidden="true"> &times; </span>
                                                    </button>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <form action="../proses/hapus_batang" method="POST">
                                                        <input type="hidden" name="no_laporan" value="<?php echo $no_laporan; ?>">
                                                        <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
                                                        <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir; ?>">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Total Seluruh Batang</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_seluruh_batang ?></div>
                                            </div>
                                            <div class="col-auto">
                                ...
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Seluruh Batang Mati</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_seluruh_batang_mati ?></div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fa-2x text-gray-300"></i>
                                            </div>
