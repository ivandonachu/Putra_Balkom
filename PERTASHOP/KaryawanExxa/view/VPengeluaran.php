...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM pengeluaran  a INNER JOIN pertashop b ON b.kode_perta=a.kode_perta WHERE tanggal = '$tanggal_awal' AND b.lokasi = '$lokasi' ");
}
else{
  $table = mysqli_query($koneksi, "SELECT * FROM pengeluaran  a INNER JOIN pertashop b ON b.kode_perta=a.kode_perta WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.lokasi = '$lokasi'");
}
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VPengeluaranPul2?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Pengeluaran $lokasi</h5></a>"; ?>
...
<div style="overflow-x: auto" align = 'center'>
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table)){
     ...
     echo "<tr>
     <td style='font-size: 12px'>$urut</td>
     <td style='font-size: 12px'>$tanggal</td>
     <td style='font-size: 12px'>$kode_perta</td>
     <td style='font-size: 12px'>$lokasi</td>
     <td style='font-size: 12px'>$nama_akun</td>
     <td style='font-size: 12px'>$keterangan</td>
     <td style='font-size: 12px'>"?>  <?= formatuang($jumlah); ?> <?php echo "</td>
     <td style='font-size: 12px'>"?>  <?= formatuang($total); ?> <?php echo "</td>
     <td style='font-size: 12px'>"; ?> <a download="../file_karyawan/<?= $file_bukti ?>" href="../file_karyawan/<?= $file_bukti ?>"> <?php echo "$file_bukti </a> </td> 
     "; ?>
