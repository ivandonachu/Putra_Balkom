...
if($lokasi_cor == 'Nusa Bakti' && $nama_barang == 'Pertamax'){
	...
	$result3 = mysqli_query($koneksi, "SELECT jumlah FROM ngecor WHERE no_cor = '$no_cor' ");
	$data_ngecor = mysqli_fetch_array($result3);
	$jumlah_cor = $data_ngecor['jumlah'];
	
	$stok_baru = (($stok_awal + $jumlah_cor) - $jumlah);
