...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksi, "SELECT * FROM ngecor WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_barang = 'Dexlite'  AND lokasi_cor = '$lokasi' ");
  $table2 = mysqli_query($koneksi, "SELECT * FROM barang ");
}
      ...
      <div id="content">
        ...
        <div>
          ...
          <div style="margin-right: 20px; margin-left: 20px;">
            ...
            <?php echo "<form  method='POST' action='VCorDexlite'>" ?>
            <div>
              ...
              <table id="example" class="table-sm table-striped table-bordered  nowrap" style="width:auto">
                ...
                <tbody>
                  ...
                  <?php while ($data = mysqli_fetch_array($table)) {
                    ...
                    } else if ($lokasi_cor == 'Wayheling') {

                      if ($jenis_cor == 'Sirkulasi') {
                        $cor_wh_sirkulasi = $cor_wh_sirkulasi + $jumlah;
                      } else {
                        $cor_wh_penjualan = $cor_wh_penjualan + $jumlah;
                      }
                    }
                ...
                <table class="table-sm table-striped table-bordered  nowrap" style="width:auto">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style='font-size: 11px' align='center'>Pertamax</td>
                      <td style='font-size: 11px' align='center'>Penjualan</td>
                      <td style='font-size: 11px' align='center'><?= ($cor_wh_penjualan); ?></td>
                    </tr>
                    <tr>
                      <td style='font-size: 11px' align='center'>Wayheling</td>
                      <td style='font-size: 11px' align='center'>Pertamax</td>
                      <td style='font-size: 11px' align='center'>Sirkulasi</td>
                      <td style='font-size: 11px' align='center'><?= ($cor_wh_sirkulasi); ?></td>
                    </tr>
