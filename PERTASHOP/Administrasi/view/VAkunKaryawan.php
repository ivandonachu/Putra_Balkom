...
$table = mysqli_query($koneksi, "SELECT * FROM akun_perta a INNER JOIN pertashop b ON a.kode_perta=b.kode_perta");
  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
       <?php echo "<a href='VPepindahanBaja1'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Akun Karyawan Pertashop</h5></a>"; ?>
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
    ...
    <div class="row">
      ...
      <div class="col-md-2">
        ...
        <!-- Button Input Data -->
        <div align="right">
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#inputkaryawan"> <i class="fas fa-plus-square mr-2"></i> Buat Akun </button> <br> <br>
        </div>
         ...
         <div class="modal-dialog" role ="document">
           <div class="modal-content"> 
            ...
            <div class="modal-body" align="left">
              <form action="../proses/proses_akun_karyawan" method="POST">
  ...
  <table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
    ...
    <tbody>
      ...
      <?php while($data = mysqli_fetch_array($table)){
        $id_kar_perta = $data['id_kar_perta'];
        $nama =$data['nama'];
        ...
        echo "<tr>
        <td style='font-size: 14px'>$id_kar_perta</td>
        ...
        <button href="#" type="button" class="fas fa-edit bg-warning mr-2 rounded" data-toggle="modal" data-target="#formedit<?php echo $data['id_kar_perta']; ?>">Edit</button>

        <!-- Form EDIT DATA -->

        <div class="modal fade" id="formedit<?php echo $data['id_kar_perta']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
          <div class="modal-dialog" role ="document">
            <div class="modal-content"> 
              <div class="modal-header">
              ...
              <div class="modal-body">
                <form action="../proses/edit_akun_karyawan.php" method="POST">


                  <div class="form-group">
                    <label> ID Karyawan </label>
                    <input type="text" name="id_kar_perta" class="form-control" value="<?php echo $id_kar_perta; ?>" disabled=""> 
                    <input type="hidden" name="id_kar_perta" value="<?php echo $id_kar_perta;?>">            
                  </div>
                  <div class="form-group">
                    <label>Nama Karyawan</label>
                    <input type="text" name="nama_karyawan" class="form-control" value="<?php echo $nama_karyawan;?>" required="" >             
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="password2" class="form-control"  value="<?php echo $password;?>" required="" >             
                  </div>
                <div class="form-group">
                  <label> Lokasi Pertashop</label>
         ...
         <button href="#" type="button" class="fas fa-edit bg-warning mr-2 rounded" data-toggle="modal" data-target="#formeditlokasi<?php echo $data['id_kar_perta']; ?>">Edit Lokasi</button>

        <!-- Form EDIT DATA LOKASI -->

        <div class="modal fade" id="formeditlokasi<?php echo $data['id_kar_perta']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
          <div class="modal-dialog" role ="document">
            <div class="modal-content"> 
              <div class="modal-header">
                <h5 class="modal-title"> Form Edit Akun </h5>
              ...
              <!-- Form Edit Data -->
              <div class="modal-body">
                <form action="../proses/edit_lokasi_karyawan.php" method="POST">
                  ...
                  <div class="form-group">
                    <label>Nama Karyawan</label>
                    <input type="text" name="nama_karyawan" class="form-control" disabled value="<?php echo $nama_karyawan;?>" required="" >             
                  </div>
