...
$result2 = mysqli_query($koneksi, "SELECT * FROM tagihan_ba WHERE lo = '$lo' AND tanggal = '$tanggal' ");
 if(mysqli_num_rows($result2) == 1 ){
  	echo "<script>alert('LO sudah tercatat :)'); window.location='../view/VTagihanBA?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir';</script>"; exit;
      }
...
$result3 = mysqli_query($koneksi, "SELECT * FROM master_tarif_ba WHERE delivery_point = '$delivery_point' ");
