...
$result = mysqli_query($koneksi, "SELECT * FROM tagihan_pl WHERE so = '$so' AND tanggal = '$tanggal' ");
 if(mysqli_num_rows($result) == 1 ){
  	echo "<script>alert('SO sudah tercatat :)'); window.location='../view/VTagihanPL?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir';</script>"; exit;
      }
...
$query = mysqli_query($koneksi,"INSERT INTO tagihan_pl VALUES('','$tanggal','$delivery_point','$so','$lo','$amt','$mt','$kode_pesanan','$total',1,'$file')");
