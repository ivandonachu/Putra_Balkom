...
if ($jns_trans == 'Lost') {
	...
	echo "<script>alert('Data Proses Berhasil :)'); window.location='../view/VPengirimanBA?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir';</script>";
	exit;
} else {
	if ($file == '') {
	...
	echo "<script>alert('Data Proses Berhasil :)'); window.location='../view/VPengirimanPL?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir';</script>";
	exit;
}
