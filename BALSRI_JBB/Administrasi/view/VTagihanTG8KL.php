...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM tagihan_tg_8kl a INNER JOIN master_tarif_tg_8kl b ON a.delivery_point=b.delivery_point WHERE tanggal = '$tanggal_awal'");

  $table2 = mysqli_query($koneksi, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihan_tg_8kl a INNER JOIN master_tarif_tg_8kl b ON a.delivery_point=b.delivery_point  WHERE tanggal = '$tanggal_awal'");
  $data2 = mysqli_fetch_array($table2);
  $total_tagihan = $data2['total_tagihan'];
  $total_jt = $data2['total_jt'];
  $total_rit = $data2['total_rit'];
} else {
  $table = mysqli_query($koneksi, "SELECT * FROM tagihan_tg_8kl a INNER JOIN master_tarif_tg_8kl b ON a.delivery_point=b.delivery_point WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  ORDER BY a.tanggal");

  $table2 = mysqli_query($koneksi, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihan_tg_8kl a INNER JOIN master_tarif_tg_8kl b ON a.delivery_point=b.delivery_point WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $data2 = mysqli_fetch_array($table2);
  $total_tagihan = $data2['total_tagihan'];
  $total_jt = $data2['total_jt'];
  $total_rit = $data2['total_rit'];
...
<head>
  ...
  <title>Tagihan Angkutan Pertashop Tanjung Gerem 8KL</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
          <?php echo "<a href='VTagihanTG8KL?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Tagihan Angkutan Pertashop Tanjung Gerem 8KL</h5></a>"; ?>
        ...
        <div>
          ...
          <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
            ...
            <?php echo "<form  method='POST' action='VTagihanTG8KL' style='margin-bottom: 15px;'>" ?>
            <div>
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body" align="left">
                        <?php echo "<form action='../proses/proses_tagihan_TG8KL?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            ...
                            <select id="tokens" class="selectpicker form-control" name="delivery_point" multiple data-live-search="true">
                              <?php
                              include 'koneksi.php';
                              $result2 = mysqli_query($koneksi, "SELECT * FROM master_tarif_tg_8kl");
                    ...
                    <div class="modal fade bd-example-modal-lg" id="formedit<?php echo $data['no_tagihan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          ...
                          <!-- Form Edit Data -->
                          <div class="modal-body" align="left">
                            <form action="../proses/edit_tagihan_TG8KL" enctype="multipart/form-data" method="POST">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <select id="tokens" class="selectpicker form-control" name="delivery_point" multiple data-live-search="true">
                                    ...
                                    $result = mysqli_query($koneksi, "SELECT * FROM master_tarif_tg_8kl");
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="../proses/hapus_tagihan_TG8KL" method="POST">
