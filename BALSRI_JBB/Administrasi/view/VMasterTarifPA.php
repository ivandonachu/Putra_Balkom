...
$table = mysqli_query($koneksi, "SELECT * FROM master_tarif_pa ");
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VMasterTarifPA'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Master Tarif PA</h5></a>"; ?>
       ...
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/proses_master_tarif_PA' enctype='multipart/form-data' method='POST'>";  ?>
        ...
        <div class="modal-dialog modal-lg" role ="document">
          <div class="modal-content"> 
            ...
            <div class="modal-body">
              <form action="../proses/edit_master_tarif_PA" enctype="multipart/form-data" method="POST">
...
<div class="modal fade" id="PopUpHapus<?php echo $data['delivery_point']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
 <div class="modal-dialog" role ="document">
   <div class="modal-content"> 
    ...
    <div class="modal-body">
      <form action="../proses/hapus_master_tarif_PA" method="POST">
        <input type="hidden" name="delivery_point" value="<?php echo $delivery_point;?>">
