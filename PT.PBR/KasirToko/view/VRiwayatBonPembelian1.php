    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
          <a href="VRiwayatBonPembelian1">
            <h5 class="text-center sm" style="color:white; margin-top: 8px;">Riwayat Bon Dagang Toko</h5>
          </a>
        ...
        <div>
          ...
          <td style='font-size: 14px'>$status_piutang</td>
                    ...
                    <div class="modal fade" id="PopUpBalik<?php echo $data['no_transaksi']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          //pinjam
                          $no_laporan2 = $data['no_piutang'];
                          $queryP = mysqli_query($koneksi, "SELECT * FROM piutang_dagang where no_piutang = '$no_laporan2'");
                          ...
                          <div class="modal-body" align="left">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                ...
                                <input type="hidden" name="no_piutang" value="<?php echo $dataP['no_piutang']; ?>">
                                <div>
                                  <label>Tanggal</label>
                                  <input type="date" id="tanggal" name="tanggal_bayar" required="">
                                </div>
                              </div>
                            </div>
                            <script>
