...
$table4 = mysqli_query($koneksi, "SELECT * FROM inventory a INNER JOIN baja b ON a.kode_baja=b.kode_baja WHERE b.kode_baja != 'L03K01' AND b.kode_baja != 'L12K01' AND b.kode_baja != 'B05K01' AND b.kode_baja != 'B12K01'");
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="pinggir1" style="margin-right: 20px; margin-left: 20px; color:black;">
    <h5 align="center" >Inventory</h3>
      ...
      <tbody>
        ...
        <?php while($data2 = mysqli_fetch_array($table4)){
