...
if ($tanggal_awal == $tanggal_akhir) {
 ...
 WHERE tanggal = '$tanggal_awal' AND pembayaran = 'Cash' AND referensi = 'MES' OR tanggal = '$tanggal_awal' AND pembayaran ='Deposit' AND referensi = 'MES' ORDER BY no_transaksi DESC");
}
else{
  $table = mysqli_query($koneksi, "SELECT * FROM riwayat_penjualan a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun INNER JOIN baja c ON a.kode_baja=c.kode_baja
 WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND pembayaran = 'Cash' AND referensi = 'MES' OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND pembayaran ='Deposit' AND referensi = 'MES' ORDER BY no_transaksi DESC");
}
 ...
 <head>
  ...
  <title>Rincian Pendapatan MES</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Pendapatan MES</h5></a>"; ?>
