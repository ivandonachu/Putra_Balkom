...
$table = mysqli_query($koneksi, "SELECT * FROM riwayat_penjualan a INNER JOIN riwayat_deposit b ON a.no_transaksi=b.no_transaksi INNER JOIN baja c ON c.kode_baja=a.kode_baja");
