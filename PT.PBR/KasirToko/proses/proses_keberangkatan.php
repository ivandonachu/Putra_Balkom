...
if ($status == 'Hanya Kamvas') {
		...
		$query = mysqli_query($koneksi,"INSERT INTO riwayat_keberangkatan VALUES ('','$tanggal','$referensi','$id_driver','$no_polisi','$posisi_bongkar','$tujuan_berangkat','$total_UJ','$L03K11','$L03K00','$L12K11','$L12K00','$B05K11','$B05K00','$B12K11','$B12K00','$status',1,'$keterangan','$file')");
