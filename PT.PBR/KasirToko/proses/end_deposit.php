...
$status_deposit = 'Sudah Diambil';
	...
	if ($kode_baja == 'L03K01') {
		...
		$query6 = mysqli_query($koneksi,"UPDATE riwayat_deposit SET tanggal_ambil = '$tanggal_selesai',status_deposit = '$status_deposit' WHERE no_deposit = '$no_deposit' ");
	...
	elseif ($kode_baja == 'L03K10') {
		...
		$query3 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal_selesai','$no_laporan','Gudang','Keluar','$qty_deposit')");
		//Update Status Deposit
		$query4 = mysqli_query($koneksi,"UPDATE riwayat_deposit SET tanggal_ambil = '$tanggal_selesai',status_deposit = '$status_deposit' WHERE no_deposit = '$no_deposit' ");
		echo "<script> window.location='../view/VRiwayatDeposit1';</script>";exit;
	}
