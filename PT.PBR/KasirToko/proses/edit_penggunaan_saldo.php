...
if($akun == 'Setor Pendapatan' ){
	if($rekening == 'MES' && $referensi == 'MES' ){

	}
	else if($rekening == 'PBR' && $referensi == 'PBR' ){
	
	}
	else{
		echo "<script>alert('Saldo dan referensi tidak sesuai :)');  window.location='../view/VPenggunaanSaldo2?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir';</script>";exit;
	
	}
}

else if($akun == 'Dana Masuk' ){
	if($rekening == 'CBM' && $referensi == 'MES' ){

	}
	else if($rekening == 'CBM' && $referensi == 'PBR' ){
