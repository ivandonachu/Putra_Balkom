...
$table = mysqli_query($koneksi, "SELECT * FROM riwayat_perpindahan_baja_md a INNER JOIN baja b ON a.kode_baja=b.kode_baja");
...
<head>
  ...
  <title>Perpindahan Baja MES/PBR</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VPindahBajaMD'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Perpindahan Baja MES/PBR</h5></a>"; ?>
         ...
         <div class="modal-dialog modal-lg" role ="document">
           <div class="modal-content"> 
            ...
            <div class="modal-body" align="left">
              <?php  echo "<form action='../proses/proses_pindah_baja_MD' enctype='multipart/form-data' method='POST'>";  ?>
            ...
            <div class="col-md-4">
              <label>Asal/Tujuan Baja</label>
              <select id="asal_baja" name="asal_baja" class="form-control">
                <option>CBM</option>
              </select>
            </div>            
...
<table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table)){
      ...
      <td style='font-size: 14px'>$status_barang</td>
      <td style='font-size: 14px'>$asal_barang</td>
      <td style='font-size: 14px'>$keterangan</td>
      "; ?> 
      <?php echo "<td style='font-size: 12px'>"; ?>

      <button href="#" type="submit" class="fas fa-trash-alt bg-danger mr-2 rounded" data-toggle="modal" data-target="#PopUpHapus<?php echo $data['no_perpindahan']; ?>" data-toggle='tooltip' title='Hapus Transaksi'></button>

      <div class="modal fade" id="PopUpHapus<?php echo $data['no_perpindahan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
       <div class="modal-dialog" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body">
            <form action="../proses/hapus_pindah_baja_MD" method="POST">
              <input type="hidden" name="no_pindah" value="<?php echo $no_pindah;?>">
              <input type="hidden" name="status_barang" value="<?php echo $status_barang; ?>">
