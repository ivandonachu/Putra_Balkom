...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM penjualan_s WHERE tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Nyicil' AND kode_input = 'a14' OR 
                                                                   tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Bon' AND kode_input = 'a14' ORDER BY no_penjualan ASC");


  $table2 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak ,  SUM(jumlah) AS uang_zak  FROM penjualan_s WHERE tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Cash' AND satuan = 'Zak' AND kode_input = 'a14' OR  
                                                                                                                        tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Zak' AND kode_input = 'a14'");
  $data2 = mysqli_fetch_array($table2);
  $penjualan_zak = $data2['penjualan_zak'];
  $uang_zak = $data2['uang_zak'];

  $table3 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak_bon ,  SUM(jumlah) AS uang_zak_bon  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Bon'AND satuan = 'Zak' AND kode_input = 'a14' OR  
                                                                                                                                 tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Nyicil'AND satuan = 'Zak' AND kode_input = 'a14'");
  $data3 = mysqli_fetch_array($table3);
  $penjualan_zak_bon = $data3['penjualan_zak_bon'];
  $uang_zak_bon = $data3['uang_zak_bon'];

  $table4 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag ,  SUM(jumlah) AS uang_bag  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Cash' AND satuan = 'Bag' AND kode_input = 'a14' OR  
                                                                                                                         tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Bag' AND kode_input = 'a14'");
  $data4 = mysqli_fetch_array($table4);
  $penjualan_bag = $data4['penjualan_bag'];
  $uang_bag = $data4['uang_bag'];

  $table5 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag_bon ,  SUM(jumlah) AS uang_bag_bon  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Bon'AND satuan = 'Bag' AND kode_input = 'a14' OR 
                                                                                                                                 tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Nyicil'AND satuan = 'Bag' AND AND kode_input = 'a14'");
  $data5 = mysqli_fetch_array($table5);
  $penjualan_bag_bon = $data5['penjualan_bag_bon'];
  $uang_bag_bon = $data5['uang_bag_bon'];

} else {
  $table = mysqli_query($koneksi, "SELECT * FROM penjualan_s WHERE tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil' AND kode_input = 'a14' OR  
                                                                   tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon' AND kode_input = 'a14' ORDER BY tanggal_kirim ASC");
...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM penjualan_s WHERE tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Nyicil' AND kode_input = 'a3' OR  tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Bon' AND kode_input = 'a3' OR 
                                                                   tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Nyicil' AND kode_input = '' OR  tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Bon' AND kode_input = '' ORDER BY no_penjualan ASC");


  $table2 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak ,  SUM(jumlah) AS uang_zak  FROM penjualan_s WHERE tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Cash' AND satuan = 'Zak' AND kode_input = 'a3' OR 
                                                                                                                        tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Zak' AND kode_input = 'a3' OR 
                                                                                                                        tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Cash' AND satuan = 'Zak' AND kode_input = '' OR 
                                                                                                                        tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Zak' AND kode_input = ''");
  $data2 = mysqli_fetch_array($table2);
  $penjualan_zak = $data2['penjualan_zak'];
  $uang_zak = $data2['uang_zak'];

  $table3 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak_bon ,  SUM(jumlah) AS uang_zak_bon  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Bon'AND satuan = 'Zak' AND kode_input = 'a3' OR  
                                                                                                                                 tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Nyicil'AND satuan = 'Zak' AND kode_input = 'a3' OR
                                                                                                                                 tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Bon'AND satuan = 'Zak' AND kode_input = '' OR  
                                                                                                                                 tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Nyicil'AND satuan = 'Zak' AND kode_input = ''");
  $data3 = mysqli_fetch_array($table3);
  $penjualan_zak_bon = $data3['penjualan_zak_bon'];
  $uang_zak_bon = $data3['uang_zak_bon'];

  $table4 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag ,  SUM(jumlah) AS uang_bag  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Cash' AND satuan = 'Bag' AND kode_input = 'a3' OR  
                                                                                                                         tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Bag' AND kode_input = 'a3' OR
                                                                                                                         tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Cash' AND satuan = 'Bag' AND kode_input = '' OR  
                                                                                                                         tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Bag' AND kode_input = ''");
  $data4 = mysqli_fetch_array($table4);
  $penjualan_bag = $data4['penjualan_bag'];
  $uang_bag = $data4['uang_bag'];

  $table5 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag_bon ,  SUM(jumlah) AS uang_bag_bon  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Bon'AND satuan = 'Bag' AND kode_input = 'a3' OR 
                                                                                                                                 tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Nyicil'AND satuan = 'Bag' AND kode_input = 'a3' OR
                                                                                                                                 tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Bon'AND satuan = 'Bag' AND kode_input = '' OR 
                                                                                                                                 tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Nyicil'AND satuan = 'Bag' AND kode_input = ''");
  $data5 = mysqli_fetch_array($table5);
  $penjualan_bag_bon = $data5['penjualan_bag_bon'];
  $uang_bag_bon = $data5['uang_bag_bon'];

} else {
  $table = mysqli_query($koneksi, "SELECT * FROM penjualan_s WHERE tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil' AND kode_input = 'a3' OR  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon' AND kode_input = 'a3' OR 
                                                                   tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil' AND kode_input = '' OR  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon' AND kode_input = '' ORDER BY no_penjualan ASC");
