...
<table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  ...
  <tbody>
    ...
    $tablexk = mysqli_query($koneksi, "SELECT no_do FROM penjualan_sl WHERE no_do = '$no_do_pembelian'");
    if(mysqli_num_rows($tablexk) == 1 ){
      ...
      $tablexj = mysqli_query($koneksi, "SELECT no_do FROM penjualan_s WHERE  no_do = '$no_do_pembelian'");
