...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksi, "SELECT * FROM pengiriman_s WHERE tanggal_antar = '$tanggal_awal' AND kode_input = 'a3' OR tanggal_antar = '$tanggal_awal' AND kode_input = '' ");
  
  $table2 = mysqli_query($koneksi, "SELECT no_polisi,  SUM(uj) AS total_uj, SUM(ug) AS total_ug, SUM(om) AS total_om, SUM(bs) AS total_bs FROM pengiriman_s WHERE tanggal_antar = '$tanggal_awal' AND kode_input = 'a3' OR tanggal_antar = '$tanggal_awal' AND kode_input = '' GROUP BY no_polisi");
} else {

  $table = mysqli_query($koneksi, "SELECT * FROM pengiriman_s WHERE tanggal_antar BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  AND kode_input = 'a3' OR tanggal_antar BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  AND kode_input = '' ORDER BY tanggal_antar ASC");

  $table2 = mysqli_query($koneksi, "SELECT no_polisi,  SUM(uj) AS total_uj, SUM(ug) AS total_ug, SUM(om) AS total_om, SUM(bs) AS total_bs FROM pengiriman_s WHERE tanggal_antar BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kode_input = 'a3' OR tanggal_antar BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kode_input = '' GROUP BY no_polisi");
}
