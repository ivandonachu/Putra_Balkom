...
<div class="modal-footer">
  ...
  <button type="reset" class="btn btn-danger"> RESET</button>
      ...
      <button type="button" class="fas fa-shipping-fast bg-info mr-2 rounded" data-toggle="modal" data-target="#inputpengiriman<?php echo $data['no_penjualan']; ?>"></i></button> <br> <br>
...
<button href="#" type="submit" class="fas fa-trash-alt bg-danger mr-2 rounded" data-toggle="modal" data-target="#PopUpHapus<?php echo $data['no_penjualan']; ?>" data-toggle='tooltip' title='Hapus Transaksi'></button>
