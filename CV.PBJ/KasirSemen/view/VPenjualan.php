...
if($id1 == 'a14'){
  ...
  $table = mysqli_query($koneksi, "SELECT * FROM penjualan_s WHERE tanggal_kirim = '$tanggal_akhir' AND kode_input = 'a14' ORDER BY no_penjualan ASC");


  $table2 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak ,  SUM(jumlah) AS uang_zak  FROM penjualan_s WHERE tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Cash'  AND satuan = 'Zak' AND kode_input = 'a14' OR tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Zak' AND kode_input = 'a14'");
  $data2 = mysqli_fetch_array($table2);
  $penjualan_zak = $data2['penjualan_zak'];
  $uang_zak = $data2['uang_zak'];

  $table3 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak_bon ,  SUM(jumlah) AS uang_zak_bon  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Bon'AND satuan = 'Zak' AND kode_input = 'a14' OR tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Nyicil' AND satuan = 'Zak' AND kode_input = 'a14'");
  $data3 = mysqli_fetch_array($table3);                                                                                          
  $penjualan_zak_bon = $data3['penjualan_zak_bon'];
  $uang_zak_bon = $data3['uang_zak_bon'];

  $table4 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag ,  SUM(jumlah) AS uang_bag  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Cash' AND satuan = 'Bag' AND kode_input = 'a14' OR tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Bag' AND kode_input = 'a14'");
  $data4 = mysqli_fetch_array($table4);
  $penjualan_bag = $data4['penjualan_bag'];
  $uang_bag = $data4['uang_bag'];

  $table5 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag_bon ,  SUM(jumlah) AS uang_bag_bon  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Bon' AND satuan = 'Bag' AND kode_input = 'a14' OR tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Nyicil'AND satuan = 'Bag' AND kode_input = 'a14'");
  $data5 = mysqli_fetch_array($table5);
  $penjualan_bag_bon = $data5['penjualan_bag_bon'];
  $uang_bag_bon = $data5['uang_bag_bon'];
} else {
  $table = mysqli_query($koneksi, "SELECT * FROM penjualan_s WHERE tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kode_input = 'a14' ORDER BY tanggal_kirim ASC");


  $table2 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak ,  SUM(jumlah) AS uang_zak  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Zak' AND kode_input = 'a14' OR 
                                                                                                                         tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Zak' AND kode_input = 'a14'");
  $data2 = mysqli_fetch_array($table2);
  $penjualan_zak = $data2['penjualan_zak'];
  $uang_zak = $data2['uang_zak'];
  ...
  $table3 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak_bon ,  SUM(jumlah) AS uang_zak_bon  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Zak' AND kode_input = 'a14' OR 
                                                                                                                                 tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Zak' AND kode_input = 'a14'");
  $data3 = mysqli_fetch_array($table3);
  $penjualan_zak_bon = $data3['penjualan_zak_bon'];
  $uang_zak_bon = $data3['uang_zak_bon'];
  ...
  $table4 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag ,  SUM(jumlah) AS uang_bag  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Bag' AND kode_input = 'a14' OR 
                                                                                                                         tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Bag' AND kode_input = 'a14'");
  $data4 = mysqli_fetch_array($table4);
  $penjualan_bag = $data4['penjualan_bag'];
  $uang_bag = $data4['uang_bag'];
  ...
  $table5 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag_bon ,  SUM(jumlah) AS uang_bag_bon  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Bag' AND kode_input = 'a14' OR 
                                                                                                                                 tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Bag' AND kode_input = 'a14'");
  $data5 = mysqli_fetch_array($table5);
  $penjualan_bag_bon = $data5['penjualan_bag_bon'];
  $uang_bag_bon = $data5['uang_bag_bon'];
  ...
  $table5 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_curah ,  SUM(jumlah) AS uang_curah  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Curah' AND kode_input = 'a14' OR 
                                                                                                                             tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Curah' AND kode_input = 'a14'");
  $data5 = mysqli_fetch_array($table5);
  ...
  $table6 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_curah_bon ,  SUM(jumlah) AS uang_curah_bon  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Curah' AND kode_input = 'a14' OR 
                                                                                                                                     tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Curah' AND kode_input = 'a14'");
  ...
  $table2 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak ,  SUM(jumlah) AS uang_zak  FROM penjualan_s WHERE tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Cash'  AND satuan = 'Zak' AND kode_input = 'a15' OR tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Zak' AND kode_input = 'a15'");
  $data2 = mysqli_fetch_array($table2);
  $penjualan_zak = $data2['penjualan_zak'];
  $uang_zak = $data2['uang_zak'];

  $table3 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak_bon ,  SUM(jumlah) AS uang_zak_bon  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Bon'AND satuan = 'Zak' AND kode_input = 'a15' OR tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Nyicil' AND satuan = 'Zak' AND kode_input = 'a15'");
  $data3 = mysqli_fetch_array($table3);                                                                                          
  $penjualan_zak_bon = $data3['penjualan_zak_bon'];
  $uang_zak_bon = $data3['uang_zak_bon'];

  $table4 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag ,  SUM(jumlah) AS uang_bag  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Cash' AND satuan = 'Bag' AND kode_input = 'a15' OR tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Bag' AND kode_input = 'a15'");
  $data4 = mysqli_fetch_array($table4);
  $penjualan_bag = $data4['penjualan_bag'];
  $uang_bag = $data4['uang_bag'];

  $table5 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag_bon ,  SUM(jumlah) AS uang_bag_bon  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Bon' AND satuan = 'Bag' AND kode_input = 'a15' OR tanggal_kirim = '$tanggal_awal' AND status_bayar = 'Nyicil'AND satuan = 'Bag' AND kode_input = 'a15'");
  $data5 = mysqli_fetch_array($table5);
  $penjualan_bag_bon = $data5['penjualan_bag_bon'];
  $uang_bag_bon = $data5['uang_bag_bon'];
} else {
  $table = mysqli_query($koneksi, "SELECT * FROM penjualan_s WHERE tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kode_input = 'a15' ORDER BY tanggal_kirim ASC");
  ...
  $table5 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_curah ,  SUM(jumlah) AS uang_curah  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Curah' AND kode_input = 'a15' OR 
                                                                                                                             tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Curah' AND kode_input = 'a15'");
  $data5 = mysqli_fetch_array($table5);
  $penjualan_curah = $data5['penjualan_curah'];
  $uang_curah = $data5['uang_curah'];
  ...
  $table6 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_curah_bon ,  SUM(jumlah) AS uang_curah_bon  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Curah' AND kode_input = 'a15' OR 
                                                                                                                                     tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Curah' AND kode_input = 'a15'");
  $data6 = mysqli_fetch_array($table6);
  $penjualan_curah_bon = $data6['penjualan_curah_bon'];
  $uang_curah_bon = $data6['uang_curah_bon'];
}
 ...
 if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM penjualan_s WHERE tanggal_kirim = '$tanggal_akhir'  AND kode_input = 'a3'
                                                                OR tanggal_kirim = '$tanggal_akhir'  AND kode_input = '' ORDER BY tanggal_kirim ASC");

  $table2 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak ,  SUM(jumlah) AS uang_zak  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Zak' AND kode_input = 'a3' OR 
                                                                                                                         tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Zak' AND kode_input = 'a3' OR 
                                                                                                                         tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Zak' AND kode_input = '' OR 
                                                                                                                         tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Zak' AND kode_input = ''");
  $data2 = mysqli_fetch_array($table2);
  $penjualan_zak = $data2['penjualan_zak'];
  $uang_zak = $data2['uang_zak'];
  ...
  $table3 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak_bon ,  SUM(jumlah) AS uang_zak_bon  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Zak' AND kode_input = 'a3' OR 
                                                                                                                                 tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Zak' AND kode_input = 'a3' OR 
                                                                                                                                 tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Zak' AND kode_input = '' OR 
                                                                                                                                 tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Zak' AND kode_input = ''");
  $data3 = mysqli_fetch_array($table3);
  $penjualan_zak_bon = $data3['penjualan_zak_bon'];
  $uang_zak_bon = $data3['uang_zak_bon'];
  ...
  $table4 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag ,  SUM(jumlah) AS uang_bag  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Bag' AND kode_input = 'a3' OR 
                                                                                                                         tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Bag' AND kode_input = 'a3' OR 
                                                                                                                         tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Zak' AND kode_input = '' OR 
                                                                                                                         tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Zak' AND kode_input = ''");
  $data4 = mysqli_fetch_array($table4);
  $penjualan_bag = $data4['penjualan_bag'];
  ...
  $table5 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag_bon ,  SUM(jumlah) AS uang_bag_bon  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Bag' AND kode_input = 'a3' OR 
                                                                                                                                 tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Bag' AND kode_input = 'a3' OR
                                                                                                                                 tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Bag' AND kode_input = '' OR 
                                                                                                                                 tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Bag' AND kode_input = ''");
  $data5 = mysqli_fetch_array($table5);
  $penjualan_bag_bon = $data5['penjualan_bag_bon'];
  $uang_bag_bon = $data5['uang_bag_bon'];
  ...
  $table5 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_curah ,  SUM(jumlah) AS uang_curah  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Curah' AND kode_input = 'a3' OR 
                                                                                                                             tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Curah' AND kode_input = 'a3' OR
                                                                                                                             tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Curah' AND kode_input = '' OR 
                                                                                                                             tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Curah' AND kode_input = ''");
  $data5 = mysqli_fetch_array($table5);
  $penjualan_curah = $data5['penjualan_curah'];
  $uang_curah = $data5['uang_curah'];
  ...
  $table6 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_curah_bon ,  SUM(jumlah) AS uang_curah_bon  FROM penjualan_s WHERE  tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Curah' AND kode_input = 'a3' OR 
                                                                                                                                     tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Curah' AND kode_input = 'a3' OR
                                                                                                                                     tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Curah' AND kode_input = '' OR 
                                                                                                                                     tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Curah' AND kode_input = ''");
  $data6 = mysqli_fetch_array($table6);
  $penjualan_curah_bon = $data6['penjualan_curah_bon'];
  $uang_curah_bon = $data6['uang_curah_bon'];
  ...
  $table = mysqli_query($koneksi, "SELECT * FROM penjualan_s WHERE tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kode_input = 'a3' OR tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kode_input = '' ORDER BY tanggal_kirim ASC");


  $table2 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak ,  SUM(jumlah) AS uang_zak  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Zak' AND kode_input = 'a3' OR 
                                                                                                                         tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Zak' AND kode_input = 'a3' OR
                                                                                                                         tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Zak' AND kode_input = '' OR 
                                                                                                                         tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Zak' AND kode_input = ''");
  $data2 = mysqli_fetch_array($table2);
  $penjualan_zak = $data2['penjualan_zak'];
  $uang_zak = $data2['uang_zak'];
  ...
  $table3 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_zak_bon ,  SUM(jumlah) AS uang_zak_bon  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Zak' AND kode_input = 'a3' OR 
                                                                                                                                 tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Zak' AND kode_input = 'a3' OR
                                                                                                                                 tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Zak' AND kode_input = '' OR 
                                                                                                                                 tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Zak' AND kode_input = ''");
  $data3 = mysqli_fetch_array($table3);
  $penjualan_zak_bon = $data3['penjualan_zak_bon'];
  $uang_zak_bon = $data3['uang_zak_bon'];
  ...
  $table4 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag ,  SUM(jumlah) AS uang_bag  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Bag' AND kode_input = 'a3' OR 
                                                                                                                         tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Bag' AND kode_input = 'a3' OR 
                                                                                                                         tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Bag' AND kode_input = '' OR 
                                                                                                                         tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Bag' AND kode_input = ''");
  $data4 = mysqli_fetch_array($table4);
  $penjualan_bag = $data4['penjualan_bag'];
  $uang_bag = $data4['uang_bag'];
  ...
  $table5 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_bag_bon ,  SUM(jumlah) AS uang_bag_bon  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Bag' AND kode_input = 'a3' OR 
                                                                                                                                 tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Bag' AND kode_input = 'a3' OR 
                                                                                                                                 tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Bag' AND kode_input = '' OR 
                                                                                                                                 tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Bag' AND kode_input = ''");
  $data5 = mysqli_fetch_array($table5);
  $penjualan_bag_bon = $data5['penjualan_bag_bon'];
  $uang_bag_bon = $data5['uang_bag_bon'];
  ...
  $table5 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_curah ,  SUM(jumlah) AS uang_curah  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Curah' AND kode_input = 'a3' OR 
                                                                                                                             tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Curah' AND kode_input = 'a3' OR
                                                                                                                             tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Cash' AND satuan = 'Curah' AND kode_input = '' OR 
                                                                                                                             tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Lunas Transfer' AND satuan = 'Curah' AND kode_input = ''");
  $data5 = mysqli_fetch_array($table5);
  $penjualan_curah = $data5['penjualan_curah'];
  $uang_curah = $data5['uang_curah'];
  ...
  $table6 = mysqli_query($koneksi, "SELECT SUM(qty) AS penjualan_curah_bon ,  SUM(jumlah) AS uang_curah_bon  FROM penjualan_s WHERE  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Curah' AND kode_input = 'a3' OR 
                                                                                                                                     tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Curah' AND kode_input = 'a3' OR
                                                                                                                                     tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon'AND satuan = 'Curah' AND kode_input = '' OR 
                                                                                                                                     tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil'AND satuan = 'Curah' AND kode_input = ''");
  $data6 = mysqli_fetch_array($table6);
  $penjualan_curah_bon = $data6['penjualan_curah_bon'];
  $uang_curah_bon = $data6['uang_curah_bon'];
}
                          ...
                          <div class="modal-body" align="left">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                ...
                                <input class="form-control form-control-sm" type="number" id="uj" name="uj" value="0">
                              </div>


                              <div class="col-md-6">
                                <label>Uang Gaji</label>
                                <input class="form-control form-control-sm" type="number" id="ug" name="ug" value="0">
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-md-6">
                                <label>Ongkos Mobil</label>
                                <input class="form-control form-control-sm" type="number" id="om" name="om" value="0">
                              </div>

                              <div class="col-md-6">
                                <label>Biaya Sewa Kendaraan Luar</label>
                                <input class="form-control form-control-sm" type="number" id="bs" name="bs" value="0">
                              </div>
