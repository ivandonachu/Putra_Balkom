...
if($id1 == 'a14'){
  ...
  if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM keuangan_s WHERE tanggal = '$tanggal_awal' AND kode_input = 'a3' OR tanggal = '$tanggal_awal' AND kode_input = '' ORDER BY no_transaksi ASC");

  $table2 = mysqli_query($koneksi, "SELECT nama_akun,  SUM(jumlah) AS total_jumlah FROM keuangan_s  WHERE tanggal = '$tanggal_awal' AND kode_input = 'a3' OR tanggal = '$tanggal_awal' AND kode_input = '' GROUP BY nama_akun");
  
} else {
  $table = mysqli_query($koneksi, "SELECT * FROM keuangan_s WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_input = 'a3' OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_input = '' ORDER BY tanggal ASC");

  
  $table2 = mysqli_query($koneksi, "SELECT nama_akun,  SUM(jumlah) AS total_jumlah FROM keuangan_s  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kode_input = 'a3' OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kode_input = '' GROUP BY nama_akun");
}
