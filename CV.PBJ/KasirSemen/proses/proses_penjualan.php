...
if ($nama_file == "") {
	...
	$query = mysqli_query($koneksi,"INSERT INTO penjualan_s VALUES('','$tanggal_do','$tanggal_kirim','$no_do','$driver','$no_polisi','$tujuan_pengiriman','$qty','$satuan','$harga','$jumlah','$toko_do','$tempo','$tanggal_bayar','$status_bayar'
