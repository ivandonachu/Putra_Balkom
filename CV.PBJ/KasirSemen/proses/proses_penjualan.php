...
if ($nama_file == "") {
	...
	$query = mysqli_query($koneksi,"INSERT INTO penjualan_s VALUES('','$tanggal_do','$tanggal_kirim','$no_do','$no_so','$driver','$no_polisi','$tujuan_pengiriman','$wilayah','$qty','$satuan','$harga_beli','$harga','$jumlah','$toko_do','$tempo','$tanggal_bayar','$status_bayar'
