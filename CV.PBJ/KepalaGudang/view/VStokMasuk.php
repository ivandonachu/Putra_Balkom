...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM laporan_stok_masuk_gudang  WHERE tanggal ='$tanggal_awal' AND kode_gudang = '$kode_gudang' ");
} else {
    $table = mysqli_query($koneksi, "SELECT * FROM laporan_stok_masuk_gudang WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kode_gudang = '$kode_gudang'  ");
}
...
<head>
    ...
    <title>Laporan Stok Masuk Gudang</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                    <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Laporan Stok Masuk Gudang</h5></a>"; ?>
                ...
                <div>
                    ...
                    <div style="margin-right: 100px; margin-left: 100px;">
                        ...
                        <?php echo "<form  method='POST' action='VStokMasuk'>" ?>
                        <div>
                                            ...
                                            <div class="modal-body" align="left">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input class="form-control form-control-sm" type="text" name="expenditur" required="">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label>Jenis Angkutan</label>
                                                        <input class="form-control form-control-sm" type="text" name="jenis_angkutan" required="">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label>Driver</label>
                        ...
                        <h4 align='center'> Laporan Stok Masuk Gudang <?= $kode_gudang; ?></h4>
                        <!-- Tabel -->
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="../proses/edit_stok_masuk" enctype="multipart/form-data" method="POST">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <label>Expenditur Angkutan</label>
                                                                    <input class="form-control form-control-sm" type="text" name="expenditur" required="" value="<?php echo $expenditur; ?>">
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <label>Jenis Angkutan</label>
                                                                    <input class="form-control form-control-sm" type="text" name="jenis_angkutan" required="" value="<?php echo $jenis_angkutan; ?>">
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <label>Driver</label>
