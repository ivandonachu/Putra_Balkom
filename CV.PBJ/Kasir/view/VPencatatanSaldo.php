...
if ($tanggal_awal == $tanggal_akhir) {
 $table = mysqli_query($koneksi, "SELECT * FROM riwayat_pencatatan_saldo WHERE tanggal = '$tanggal_awal'");
  ...
  $table = mysqli_query($koneksi, "SELECT * FROM riwayat_pencatatan_saldo WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  ORDER BY tanggal ASC");
}
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VLSaldo'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Pencatatan Saldo</h5></a>"; ?>
...
<div>   
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
    ...
    <?php  echo "<form  method='POST' action='VPencatatanSaldo' style='margin-bottom: 15px;'>" ?>
    <div>
  ...
  <div class="row">
   ...
   <div class="col-md-2">
    <!-- Button Pindah Baja -->
    <div align="right">
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i> Pencatatan Saldo </button> <br> <br>
    </div>
    <!-- Form Modal  -->
     ...
     <div class="modal-dialog modal-lg" role ="document">
       <div class="modal-content"> 
        <div class="modal-header">
          <h5 class="modal-title"> Form Pencatatan Saldo </h5>
        ...
        <div class="modal-body" align="left">
          <?php  echo "<form action='../proses/proses_pencatatan_saldo?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
      ...
      <div class="row">
         <div class="col-md-4">
          ...
          <select id="jenis_transaksi" name="jenis_transaksi" class="form-control">
            ...
            <option>Pengeluaran Saldo</option>
             <option>Sisa Saldo Bulan Lalu</option>
          </select>
        </div>    
        <div class="col-md-4">
          <label>Pengeluaran/Penambahan</label>
          <input class="form-control form-control-sm" type="number" id="jumlah" name="jumlah"value='0'  required="">
        </div>    
              <div class="col-md-4">
          <label>Biaya Transfer</label>
          <input class="form-control form-control-sm" type="number" id="biaya_transfer" name="biaya_transfer" value='0' required="">
        </div>    
      </div>
          ...
          <div class="modal-dialog" role ="document">
            <div class="modal-content"> 
              ...
              <div class="modal-body">
                <form action="../proses/proses_edit_catsal.php"  enctype="multipart/form-data" method="POST">
...
<br>
        ...
        <div class="col-md-6">
          ...
          <?php $dataSelect = $data['bank']; ?>
            <option <?php echo ($dataSelect == 'BRI') ? "selected": "" ?> >BRI</option>
            <option <?php echo ($dataSelect == 'Mandiri') ? "selected": "" ?> >Mandiri</option>
            <option <?php echo ($dataSelect == 'Bank Lampung') ? "selected": "" ?> >Bank Lampung</option>
            <option <?php echo ($dataSelect == 'BCA') ? "selected": "" ?> >BCA</option>
            <option <?php echo ($dataSelect == 'BNI') ? "selected": "" ?> >BNI</option>
            <option <?php echo ($dataSelect == 'Bank Sumsel') ? "selected": "" ?> >Bank Sumsel</option>
            <option <?php echo ($dataSelect == 'Bank Permata') ? "selected": "" ?> >Bank Permata</option>
      ...
      <div class="row">
         <div class="col-md-4">
          <label>Jenis Transaksi</label>
          <select id="jenis_transaksi" name="jenis_transaksi" class="form-control">
            <?php $dataSelect = $data['jenis_transaksi']; ?>
            <option <?php echo ($dataSelect == 'Penambahan Saldo') ? "selected": "" ?> >Penambahan Saldo</option>
            <option <?php echo ($dataSelect == 'Pengeluaran Saldo') ? "selected": "" ?> >Pengeluaran Saldo</option>
            <option <?php echo ($dataSelect == 'Sisa Saldo Bulan Lalu') ? "selected": "" ?> >Sisa Saldo Bulan Lalu</option>
          </select>
        </div>    
        <div class="col-md-4">
          <label>Pengeluaran/Penambahan</label>
          <input class="form-control form-control-sm" type="number" id="jumlah" name="jumlah" value='<?php echo $jumlah;?>'  required="">
              ...
              <div class="col-md-4">
          <label>Biaya Transfer</label>
          <input class="form-control form-control-sm" type="number" id="biaya_transfer"  name="biaya_transfer" value='<?php echo $biaya_transfer;?>' required="">
        </div>    
      </div>
