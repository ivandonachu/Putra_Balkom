...
$table = mysqli_query($koneksi, "SELECT * FROM lokasi_kirim ");
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VMasterTarif'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Master Tarif</h5></a>"; ?>
       ...
       <div class="modal-dialog modal-lg" role ="document">
          ...
          <div class="modal-body" align="left">
            ...
            <div class="row">
              <div class="col-md-6">
               ...
               <input class="form-control form-control-sm" type="text" id="nm_perusahaan" name="nm_perusahaan" required="">
             </div>
             <div class="col-md-6">
               <label>Nama Lokasi</label>
               <input class="form-control form-control-sm" type="text" id="nm_lokasi" name="nm_lokasi" required="">
             </div>
           </div>
           ...
           <div class="row">
            <div class="col-md-6">
             <label>Jarak</label>
             <input class="form-control form-control-sm" type="text" id="jarak" name="jarak" required="">
           </div>
         ...
         <div class="row">
          <div class="col-md-6">
            ...
            <input class="form-control form-control-sm" type="number" id="uj" name="uj" required="">
          </div>    
          <div class="col-md-6">
            <label>Gaji</label>
            <input class="form-control form-control-sm" type="number" id="gaji" name="gaji" required="">
          </div>
        </div>
...
<table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table)){
      ...
      <td style='font-size: 14px' align = 'center'>$jarak</td>
      ...
      <button href="#" type="button" class="fas fa-edit bg-warning mr-2 rounded" data-toggle="modal" data-target="#formedit<?php echo $data['no_lokasi']; ?>">Edit</button>

      <!-- Form EDIT DATA -->

      <div class="modal fade" id="formedit<?php echo $data['no_lokasi']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role ="document">
          <div class="modal-content"> 
            <div class="modal-header">
            ...
            <div class="modal-body">
              ...
              <div class="col-md-6">
               <label>Nama Perusahaan</label>
               <input class="form-control form-control-sm" type="text" id="nm_perusahaan" name="nm_perusahaan" required=""  value="<?php echo $nm_perusahaan;?>" >
             </div>
             <div class="col-md-6">
               <label>Nama Lokasi</label>
               <input class="form-control form-control-sm" type="text" id="nm_lokasi" name="nm_lokasi" required="" value="<?php echo $nm_lokasi;?>" >
             </div>
           </div>
           ...
           <div class="row">
            <div class="col-md-6">
             <label>Jarak</label>
             <input class="form-control form-control-sm" type="text" id="jarak" name="jarak" required=""  value="<?php echo $jarak;?>" >
           </div>

           <div class="col-md-6">
             <label>Harga</label>
             <input class="form-control form-control-sm" type="text" id="harga" name="harga" required=""  value="<?php echo $harga;?>" >
           </div>            
         </div>
         ...
         <div class="row">
          <div class="col-md-6">
            <label>Uang Jalan</label>
            <input class="form-control form-control-sm" type="number" id="uj" name="uj" required=""  value="<?php echo $uj;?>">
          </div>    
          <div class="col-md-6">
            <label>Gaji</label>
            <input class="form-control form-control-sm" type="number" id="gaji" name="gaji" required=""  value="<?php echo $gaji;?>">
          </div>           
...
<!-- Button Hapus -->
<button href="#" type="submit" class="fas fa-trash-alt bg-danger mr-2 rounded" data-toggle="modal" data-target="#PopUpHapus<?php echo $data['no_lokasi']; ?>" data-toggle='tooltip' title='Hapus Data Dokumen'>Hapus</button>
<div class="modal fade" id="PopUpHapus<?php echo $data['no_lokasi']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
