...
if (isset($_GET['tanggal1'])) {
 ...
 if ($tanggal_awal == $tanggal_akhir) {
    ...
    //Tonase OKUT
    $table2 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_okut FROM pembelian_sl WHERE  tanggal = '$tanggal_akhir' AND kota = 'Kab Ogn Kmrg Ulu Tim'");
    $data2 = mysqli_fetch_array($table2);
    $total_qty_okut = $data2['qty_okut'];
    $total_tonase_okut = $total_qty_okut/20;

    //Tonase OKUS
    $table3 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_okus FROM pembelian_sl WHERE  tanggal = '$tanggal_akhir' AND kota = 'Kab Ogn Kmrg Ulu Sel'");
    $data3 = mysqli_fetch_array($table3);
    $total_qty_okus = $data3['qty_okus'];
    $total_tonase_okus = $total_qty_okus/20;

    //Tonase Mesuji
    $table4 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_mesuji FROM pembelian_sl WHERE  tanggal = '$tanggal_akhir' AND kota = 'Kab Mesuji'");
    $data4 = mysqli_fetch_array($table4);
    $total_qty_mesuji = $data4['qty_mesuji'];
    $total_tonase_mesuji = $total_qty_mesuji/20;

    //Tonase WAY KANAN
    $table5 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_way_kanan FROM pembelian_sl WHERE  tanggal = '$tanggal_akhir' AND kota = 'KAB WAY KANAN'");
    $data5 = mysqli_fetch_array($table5);
    $total_qty_way_kanan = $data5['qty_way_kanan'];
    $total_tonase_way_kanan = $total_qty_way_kanan/20;
    
    //Tonase Tuba
    $table6 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_tuba FROM pembelian_sl WHERE  tanggal = '$tanggal_akhir' AND kota = 'Kab Tlg Bwg'");
    $data6 = mysqli_fetch_array($table6);
    $total_qty_tuba = $data6['qty_tuba'];
    $total_tonase_tuba = $total_qty_tuba/20;

    //Tonase Bag
    $table7 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_bag FROM pembelian_sl WHERE  tanggal = '$tanggal_akhir' AND material = 'Big Bag OPC Type 1'");
    $data7 = mysqli_fetch_array($table7);
    $total_tonase_bag = $data7['qty_bag'];

    //Tonase Curah
    $table8 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_curah FROM pembelian_sl WHERE  tanggal = '$tanggal_akhir' AND material = 'Curah OPC Type 1'");
    ...
    $table = mysqli_query($koneksi,"SELECT * FROM pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  ORDER BY tanggal ASC");
     ...
     //Tonase OKUT
     $table2 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_okut FROM pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'Kab Ogn Kmrg Ulu Tim'");
     $data2 = mysqli_fetch_array($table2);
     $total_qty_okut = $data2['qty_okut'];
     $total_tonase_okut = $total_qty_okut/20;
 
     //Tonase OKUS
     $table3 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_okus FROM pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'Kab Ogn Kmrg Ulu Sel'");
     $data3 = mysqli_fetch_array($table3);
     $total_qty_okus = $data3['qty_okus'];
     $total_tonase_okus = $total_qty_okus/20;
 
     //Tonase Mesuji
     $table4 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_mesuji FROM pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'Kab Mesuji'");
     $data4 = mysqli_fetch_array($table4);
     $total_qty_mesuji = $data4['qty_mesuji'];
     $total_tonase_mesuji = $total_qty_mesuji/20;
 
     //Tonase WAY KANAN
     $table5 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_way_kanan FROM pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'KAB WAY KANAN'");
     $data5 = mysqli_fetch_array($table5);
     $total_qty_way_kanan = $data5['qty_way_kanan'];
     $total_tonase_way_kanan = $total_qty_way_kanan/20;
     
     //Tonase Tuba
     $table6 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_tuba FROM pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'Kab Tlg Bwg'");
     $data6 = mysqli_fetch_array($table6);
     $total_qty_tuba = $data6['qty_tuba'];
     $total_tonase_tuba = $total_qty_tuba/20;
 
     //Tonase Bag
     $table7 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_bag FROM pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND material = 'Big Bag OPC Type 1'");
     $data7 = mysqli_fetch_array($table7);
     $total_tonase_bag = $data7['qty_bag'];
 
     //Tonase Curah
     $table8 = mysqli_query($koneksi, "SELECT SUM(qty) AS qty_curah FROM pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND material = 'Curah OPC Type 1'");
     $data8 = mysqli_fetch_array($table8);
     $total_tonase_curah = $data8['qty_curah'];
