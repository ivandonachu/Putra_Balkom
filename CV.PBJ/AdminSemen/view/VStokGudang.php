...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM stok_gudang WHERE tanggal = '$tanggal_awal'");
} else {
    $table = mysqli_query($koneksi, "SELECT * FROM stok_gudang WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ");
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                    <?php echo "<a href='VLSaldo'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Stok Gudang PBJ</h5></a>"; ?>
                ...
                <div>
                    ...
                    <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                        ...
                        <?php echo "<form  method='POST' action='VStokGudang' style='margin-bottom: 15px;'>" ?>
                        <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <!-- Button Pindah Baja -->
                                <div align="right">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i> Input Stok </button> <br> <br>
                                </div>
                                <!-- Form Modal  -->
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"> Form Pencatatan</h5>
                                            ...
                                            <div class="modal-body" align="left">
                                                <?php echo "<form action='../proses/proses_stok_gudang?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select id="gudang" name="gudang" class="form-control">
                                                            <option>Gudang Mesuji</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label>Stok</label>
                                                        <input class="form-control form-control-sm" type="number" id="stok" name="stok">
                                                    </div>
                                                </div>
                            ...
                            <table id="example" class="table-sm table-striped table-bordered  nowrap" style="width:auto">
                                ...
                                <tbody>
                                    ...
                                    <?php while ($data = mysqli_fetch_array($table)) {
                                        ...
                                        <td style='font-size: 14px'>$stok SAK</td>
                                        "; ?>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="../proses/edit_stok_gudang" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label>Gudang</label>
                                                                    <select id="gudang" name="gudang" class="form-control">
                                                                        <?php $dataSelect = $data['gudang']; ?>
                                                                        <option <?php echo ($dataSelect == 'Gudang Mesuji') ? "selected" : "" ?>>Gudang Mesuji</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label>Stok</label>
                                                                    <input class="form-control form-control-sm" type="number" id="stok" name="stok" value="<?php echo $stok; ?>">
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="modal fade" id="PopUpHapus<?php echo $data['no_laporan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="../proses/hapus_stok_gudang" method="POST">
                                                            <input type="hidden" name="no_laporan" value="<?php echo $no_laporan; ?>">
                                                            <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
                                                            <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir; ?>">
