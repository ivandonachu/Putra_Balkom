...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table1 = mysqli_query($koneksi, "SELECT no_polisi, kota, qty FROM pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND tipe_semen = 'Pranko' OR  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND tipe_semen = 'FRC'  ");
  ...
  while ($data1 = mysqli_fetch_array($table1)) {
    ...
    if ($kota == 'Kab Ogn Kmrg Ulu Tim' || $kota == 'KAB OKU TIMUR') {
      ...
      $table2p = mysqli_query($koneksi, "SELECT status_kendaraan FROM kendaraan_sl WHERE no_polisi  = '$no_polisi_ts' ");
      ...
      } else if ($pemilik == 'MAP' && $kontrak == 'RLI' ||  $pemilik == 'MAP' && $kontrak == '') {
        $total_map = $total_map + $total_angkut;
        $total_angkutan_map_okut = $total_angkutan_map_okut + $total_angkut;
      } else if ($pemilik == 'Eki Bangunan' && $kontrak == 'RLI' ||  $pemilik == 'Eki Bangunan' && $kontrak == '') {
      ...
      $table2p = mysqli_query($koneksi, "SELECT kontrak, status_kendaraan FROM kendaraan_sl WHERE no_polisi  = '$no_polisi_ts' ");
      $data2p = mysqli_fetch_array($table2p);
      if (isset($data2p['status_kendaraan'])) {
        $pemilik = $data2p['status_kendaraan'];
        $kontrak = $data2p['kontrak'];
      ...
      <div id="content">
        ...
        <div>
          ...
          <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
            ...
            <h5 align='center'>Rekap Pranko RLI Eki Bangunan</h5>
            <!-- Tabel -->
