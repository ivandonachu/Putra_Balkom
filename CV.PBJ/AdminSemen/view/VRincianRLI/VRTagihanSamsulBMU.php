...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $total_angkutan_samsul_okut = 0;
    $total_angkutan_samsul_okus = 0;
    $total_angkutan_samsul_md_kota = 0;
    $total_angkutan_samsul_mesuji = 0;
    $total_angkutan_samsul_tlg_bwg = 0;
    $total_angkutan_samsul_way_kanan = 0;
    while ($data1 = mysqli_fetch_array($table1)) {
        ...
        if ($kota == 'Kab Ogn Kmrg Ulu Tim' || $kota == 'KAB OKU TIMUR') {
            ...
            if ($pemilik == 'Samsul' && $kontrak == 'BMU') {
                ...
                $total_angkutan_samsul_okut = $total_angkutan_samsul_okut + $total_angkut_bmu;
            } 
            ...
            if ($pemilik == 'Samsul' && $kontrak == 'BMU') {
                $total_angkutan_samsul = $total_angkutan_samsul + $total_angkut_bmu;
                $total_angkutan_samsul_mesuji = $total_angkutan_samsul_mesuji + $total_angkut_bmu;
            } 
            ...
            if ($pemilik == 'Samsul' && $kontrak == 'BMU') {
                $total_angkutan_samsul = $total_angkutan_samsul + $total_angkut_bmu;
                $total_angkutan_samsul_tlg_bwg = $total_angkutan_samsul_tlg_bwg + $total_angkut_bmu;
            } 
            ...
            if ($pemilik == 'Samsul' && $kontrak == 'BMU') {
                $total_angkutan_samsul = $total_angkutan_samsul + $total_angkut_bmu;
                $total_angkutan_samsul_way_kanan = $total_angkutan_samsul_way_kanan + $total_angkut_bmu;
            } 
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= formatuang($total_angkutan_samsul_okut) ?></div>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= formatuang($total_angkutan_samsul_okus) ?></div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= formatuang($total_angkutan_samsul_md_kota) ?></div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= formatuang($total_angkutan_samsul_tlg_bwg) ?></div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= formatuang($total_angkutan_samsul_way_kanan) ?></div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= formatuang($total_angkutan_samsul_mesuji) ?></div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= formatuang($total_angkutan_samsul) ?></div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                                            </div>
