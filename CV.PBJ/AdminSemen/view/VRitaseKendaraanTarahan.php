...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  //TARAHAN AND PANJANG
  $table13 = mysqli_query($koneksi,"SELECT no_polisi, count(*) AS total_rit FROM  pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'KAB. TULANG BAWANG' AND plant = '79A1' OR  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'KAB.TULANG BAWANG' AND plant = '79A1' GROUP BY no_polisi  ");
  $table14 = mysqli_query($koneksi,"SELECT no_polisi, count(*) AS total_rit FROM  pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'KAB. LAMPUNG TIMUR' AND plant = '79A1' OR  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'KAB.LAMPUNG TIMUR' AND plant = '79A1' GROUP BY no_polisi  ");
  $table15 = mysqli_query($koneksi,"SELECT no_polisi, count(*) AS total_rit FROM  pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'KAB MESUJI' AND plant = '79A1' OR   tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'KAB MESUJI' AND plant = '79A1' GROUP BY no_polisi  ");
  $table16 = mysqli_query($koneksi,"SELECT no_polisi, count(*) AS total_rit FROM  pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'KAB WAY KANAN' AND plant = '79A1' OR  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'KAB WAY KANAN' AND plant = '79A1' GROUP BY no_polisi  ");
  //PANJANG
  $table17 = mysqli_query($koneksi,"SELECT no_polisi, count(*) AS total_rit FROM  pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'KAB. LAMPUNG TIMUR' AND plant = '79H9' OR  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'KAB.LAMPUNG TIMUR' AND plant = '79H9' GROUP BY no_polisi  ");
