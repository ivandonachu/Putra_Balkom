...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM penjualan_sl WHERE tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Nyicil' AND tujuan_pengiriman = '$tujuan_pengiriman'  OR  tanggal_kirim = '$tanggal_akhir' AND status_bayar = 'Bon' AND tujuan_pengiriman = '$tujuan_pengiriman' ");
} else {
    $table = mysqli_query($koneksi, "SELECT * FROM penjualan_sl WHERE tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Nyicil'  AND tujuan_pengiriman = '$tujuan_pengiriman'  OR  tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_bayar = 'Bon' AND tujuan_pengiriman = '$tujuan_pengiriman'  ORDER BY tanggal_kirim ASC");
}
                                          ...
                                          <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body" align="left">
                                                <form action="../proses/edit_piutang_r2" enctype="multipart/form-data" method="POST">
                                                  <script>
                                                    function sum2() {
