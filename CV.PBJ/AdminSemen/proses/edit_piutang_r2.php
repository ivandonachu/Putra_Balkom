...
$no_pengiriman = $data_perta['no_pengiriman'];
	...
	echo "<script>alert('Data Berhasil Di Edit :)'); window.location='../view/RincianPiutangR2?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&&tujuan_pengiriman=$tujuan_pengiriman';</script>";exit;
