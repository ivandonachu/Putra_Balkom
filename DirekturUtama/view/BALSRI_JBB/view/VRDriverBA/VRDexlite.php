...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksibalsri_jbb, "SELECT  SUM(a.u_dex) AS total_uang_dex , SUM(dexlite) AS total_dexlite FROM pengiriman_ba a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");

}

else{
    $table = mysqli_query($koneksibalsri_jbb, "SELECT SUM(a.u_dex) AS total_uang_dex , SUM(a.dexlite) AS total_dexlite , b.no_polisi FROM pengiriman_ba a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND  b.no_polisi = '$no_polisilr' ");
...
<head>
  ...
  <title>Rincian Dexlite  <?= $no_polisilr; ?> (Balongan)</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Dexlite  $no_polisilr (Balongan)</h5></a>"; ?>
