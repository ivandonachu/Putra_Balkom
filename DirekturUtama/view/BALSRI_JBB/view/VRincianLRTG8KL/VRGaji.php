...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksibalsri_jbb, "SELECT * FROM riwayat_penggajian WHERE tanggal  = '$tanggal_awal'  AND referensi = 'Driver TG 8KL' OR tanggal  = '$tanggal_awal'  AND referensi = 'BALSRI TG 8KL'");
  
  }
  
  else{
    $table = mysqli_query($koneksibalsri_jbb, "SELECT * FROM riwayat_penggajian WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'Driver TG 8KL' OR tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'BALSRI TG 8KL'");
...
?>
 ...
 <head>
  ...
  <title>Rincian Gaji Karyawan dan Driver Tj Gerem 8KL</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRGaji'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Gaji Karyawan dan Driver Tj Gerem 8KL</h5></a>"; ?>
