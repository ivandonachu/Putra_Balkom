...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  //pengeluran Pul Biaya Kantor
   ...
   // Denda Kreit
   $table623 = mysqli_query($koneksibalsri, "SELECT SUM(jumlah) AS jumlah_denda_kredit FROM pengeluaran_pul_tg WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Denda Kredit' ");
