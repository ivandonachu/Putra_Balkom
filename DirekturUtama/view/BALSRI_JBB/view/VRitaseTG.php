  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table)){
      ...
      $tgl_perbaikan = $data['tgl_perbaikan'];
       ...
       INNER JOIN pengiriman_tg b ON a.no=b.no WHERE tanggal BETWEEN '$tgl_perbaikan' AND '$tanggal_akhir' AND no_polisi = '$no_polisi' ");
     ...
     ?>
      ...
      <td align = 'center'><a href='VRincianRitKenTG?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisi'>Rincian</a></td> </tr>";
}
