...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksibalsri_jbb, "SELECT * FROM riwayat_perbaikan_ba WHERE tanggal = '$tanggal_awal'");

}
else{

  $table = mysqli_query($koneksibalsri_jbb, "SELECT * FROM riwayat_perbaikan_ba  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $table2 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jml_pengeluaran) AS jumlah_perbaikan, no_polisi FROM riwayat_perbaikan_ba WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY no_polisi ");
}
...
<head>
  ...
  <title>Rincian Perbaikan Kendaraan Balongan</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Perbaikan Kendaraan Balongan</h5></a>"; ?>
