...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksibalsri_jbb, "SELECT * FROM pengeluaran_pul_ba WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Alat Tulis Kantor' ");
}
else{
  $table = mysqli_query($koneksibalsri_jbb, "SELECT * FROM pengeluaran_pul_ba WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Alat Tulis Kantor'");
}
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Rincian ATK Balongan</h5></a>"; ?>
