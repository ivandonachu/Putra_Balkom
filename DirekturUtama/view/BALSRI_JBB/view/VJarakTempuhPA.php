...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksibalsri_jbb, "SELECT * FROM pengiriman_pa a INNER JOIN driver b ON a.no_driver=b.no_driver INNER JOIN kendaraan c ON c.no=a.no WHERE tanggal = '$tanggal_awal'");

}
else{

  $table = mysqli_query($koneksibalsri_jbb, "SELECT * FROM pengiriman_pa a INNER JOIN driver b ON a.no_driver=b.no_driver INNER JOIN kendaraan c ON c.no=a.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VJarakTempuhPA?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Riwayat Jarak Tempuh PA</h5></a>"; ?>
...
<div>   
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
    ...
    <?php  echo "<form  method='POST' action='VJarakTempuhPA' style='margin-bottom: 15px;'>" ?>
    <div>
