...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksibalsri_jbb, "SELECT * FROM pengiriman_pa a INNER JOIN driver b ON a.no_driver=b.no_driver INNER JOIN kendaraan c ON c.no=a.no WHERE tanggal = '$tanggal_awal' ORDER BY a.tanggal");

  $table2 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jt_gps) AS total_jt_gps, SUM(jt_odo) AS total_jt_odo , SUM(dexlite) AS total_dex, SUM(um) AS uang_makan, SUM(ug) AS uang_gaji, SUM(uj) AS uang_jalan FROM pengiriman_pa WHERE tanggal = '$tanggal_awal'");
  ...
  $table3 = mysqli_query($koneksibalsri_jbb,"SELECT * FROM pengiriman_pa WHERE tanggal = '$tanggal_awal' AND jns_trans = 'Lost' ");
  ...
  $table4 = mysqli_query($koneksibalsri_jbb,"SELECT * FROM pengiriman_pa WHERE tanggal = '$tanggal_awal' AND jns_trans = 'Surplus' ");
  ...
  $table = mysqli_query($koneksibalsri_jbb, "SELECT * FROM pengiriman_pa a INNER JOIN driver b ON a.no_driver=b.no_driver INNER JOIN kendaraan c ON c.no=a.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY a.tanggal");

  $table2 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jt_gps) AS total_jt_gps, SUM(jt_odo) AS total_jt_odo , SUM(dexlite) AS total_dex, SUM(um) AS uang_makan, SUM(ug) AS uang_gaji, SUM(uj) AS uang_jalan FROM pengiriman_pa WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $data2 = mysqli_fetch_array($table2);
  $jml_jt_gps= $data2['total_jt_gps'];
  $jml_jt_odo= $data2['total_jt_odo'];
  $jml_dex= $data2['total_dex'];
  ...
  $table3 = mysqli_query($koneksibalsri_jbb,"SELECT SUM(jml_trans) AS lost FROM pengiriman_pa WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND jns_trans = 'Lost' ");
  $data3 = mysqli_fetch_array($table3);
  $total_lost = $data3['lost'];
  if (!isset($data3['lost'])) {
    $total_lost = 0;
}
  $table4 = mysqli_query($koneksibalsri_jbb,"SELECT SUM(jml_trans) AS surplus FROM pengiriman_pa WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND jns_trans = 'Surplus' ");
  $data4 = mysqli_fetch_array($table4);
