...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksibalsri_jbb, "SELECT SUM(a.u_dex) AS total_uang_dex ,  SUM(dexlite) AS total_dexlite FROM pengiriman_pl a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");

}

else{
    $table = mysqli_query($koneksibalsri_jbb, "SELECT SUM(a.u_dex) AS total_uang_dex , SUM(a.dexlite) AS total_dexlite , b.no_polisi FROM pengiriman_pl a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY b.no_polisi ");
...
<head>
  ...
  <title>Rincian Dexlite Plumpang</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Dexlite Plumpang</h5></a>"; ?>
