...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksibalsri_jbb, "SELECT * FROM riwayat_perbaikan_pl  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $table2 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jml_pengeluaran) AS jumlah_perbaikan, no_polisi FROM riwayat_perbaikan_pl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY no_polisi ");
}
...
<head>
  ...
  <title>Rincian Perbaikan Kendaraan Plumpang</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Perbaikan Kendaraan Plumpang</h5></a>"; ?>
