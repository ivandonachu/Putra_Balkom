...
if ($tanggal_awal == $tanggal_akhir) {
  // Tagihan
  $table = mysqli_query($koneksibalsri_jbb, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihan_tg_8kl a INNER JOIN master_tarif_tg_8kl b ON a.delivery_point=b.delivery_point  WHERE tanggal = '$tanggal_awal'");
  $data = mysqli_fetch_array($table);
  $total_tagihan= $data['total_tagihan'];
  //pengiriman_tg_8kl
  $table2 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(dexlite) AS total_dex, SUM(um) AS uang_makan, SUM(ug) AS uang_gaji FROM pengiriman_tg_8kl WHERE tanggal = '$tanggal_awal'");
  ...
  //pengeluran Pul Biaya Kantor
   $table3 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jumlah) AS jumlah_biaya_kantor FROM pengeluaran_pul_tg_8kl WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Biaya Kantor' ");
   ...
   $table4 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jumlah) AS jumlah_listrik FROM pengeluaran_pul_tg_8kl WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Listrik & Telepon' ");
   ...
   $table5 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jumlah) AS jumlah_sewa FROM pengeluaran_pul_tg_8kl WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Biaya Sewa' ");
   ...
   $table6 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jumlah) AS jumlah_atk FROM pengeluaran_pul_tg_8kl WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Alat Tulis Kantor' ");
   ...
   $table7 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jml_pengeluaran) AS jumlah_perbaikan FROM riwayat_perbaikan_tg_8kl WHERE tanggal = '$tanggal_awal'");
   ...
   $jml_perbaikan = $data7['jumlah_perbaikan'];
    ...
    // Tagihan
  $table = mysqli_query($koneksibalsri_jbb, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihan_tg_8kl a INNER JOIN master_tarif_tg_8kl b ON a.delivery_point=b.delivery_point  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $data = mysqli_fetch_array($table);
  $total_tagihan= $data['total_tagihan'];
  ...
  //pengiriman_tg_8kl
  $table2 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(dexlite) AS total_dex, SUM(um) AS uang_makan FROM pengiriman_tg_8kl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $data2 = mysqli_fetch_array($table2);
  ...
  $total_dexlite = 0;
  $total_bbm = 0;
  $table222 = mysqli_query($koneksibalsri_jbb, "SELECT jt_gps, uj , dexlite FROM pengiriman_tg_8kl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  ...
  //pengeluran Pul Biaya Kantor
   $table3 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jumlah) AS jumlah_biaya_kantor FROM pengeluaran_pul_tg_8kl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Kantor' ");
   $data3 = mysqli_fetch_array($table3);
   $jml_biaya_kantor = $data3['jumlah_biaya_kantor'];
    if (!isset($data3['jumlah_biaya_kantor'])) {
    $jml_biaya_kantor = 0;
   ...
   //pengeluran Pul Listrik & Telepon
   $table4 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jumlah) AS jumlah_listrik FROM pengeluaran_pul_tg_8kl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Listrik & Telepon' ");
   $data4 = mysqli_fetch_array($table4);
   $jml_listrik = $data4['jumlah_listrik'];
   ...
   //pengeluran Biaya Sewa
   $table5 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jumlah) AS jumlah_sewa FROM pengeluaran_pul_tg_8kl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Sewa' ");
   $data5 = mysqli_fetch_array($table5);
   $jml_sewa = $data5['jumlah_sewa'];
    if (!isset($data5['jumlah_sewa'])) {
    $jml_sewa = 0;
   ...
   //pengeluran Alat Tulis Kantor
   $table6 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jumlah) AS jumlah_atk FROM pengeluaran_pul_tg_8kl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Alat Tulis Kantor' ");
   $data6 = mysqli_fetch_array($table6);
   $jml_atk = $data6['jumlah_atk'];
    if (!isset($data6['jumlah_atk'])) {
    $jml_atk = 0;
   ...
   $table61 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jumlah) AS jumlah_transport FROM pengeluaran_pul_tg_8kl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Transport / Perjalanan Dinas' ");
   ...
   $table62 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jumlah) AS jumlah_konsumsi FROM pengeluaran_pul_tg_8kl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Konsumsi' ");
   ...
   $jml_konsumsi = $data62['jumlah_konsumsi'];
    ...
    //pengeluran perbaikan
   $table7 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jml_pengeluaran) AS jumlah_perbaikan FROM riwayat_perbaikan_tg_8kl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ");
   $data7 = mysqli_fetch_array($table7);
   $jml_perbaikan = $data7['jumlah_perbaikan'];
    if (!isset($data7['jumlah_perbaikan'])) {
    $jml_perbaikan = 0;
     ...
     //Gaji karyawan
   $table8 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jumlah) AS jumlah_gaji FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'BALSRI TG 8KL' ");
   ...
   $gaji_karyawan = $data8['jumlah_gaji'];
    ...
    //Gaji dRIVER
   $table9 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(jumlah) AS jumlah_gaji FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'Driver TG 8KL' ");
   ...
   $gaji_driver = $data9['jumlah_gaji'];
    ...
    //list supir
    $table10 =  mysqli_query($koneksibalsri_jbb, "SELECT mt FROM tagihan_tg_8kl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY mt ");

    $table101 =  mysqli_query($koneksibalsri_jbb, "SELECT mt FROM tagihan_tg_8kl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY mt ");
    //totalkredit
    $total_kredit = 0;
...
<head>
    ...
    <title>Laporan LR Tj Gerem 8KL</title>
...
<div class="container" style="color : black;">
   <?php  echo "<form  method='POST' action='VLabaRugiTG8KL' style='margin-bottom: 15px;'>" ?>
   <div>
   ...
   <div class="col-md-12">
      <div class="panel panel-default">
         <div class="panel-heading">
            <h3 class="panel-title" align="Center"><strong>Laba Rugi Tj Gerem 8 KL</strong></h3>
        </div>
        ...
        <div class="panel-body">
            <div class="table-responsive">
             ...
             <tbody>
                ...
                <tr>
                 ...
                 <?php echo "<td class='text-right'><a href='VRincianLRTG8KL/VRTagihan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
             </tr>
            ...
            <tr>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRTG8KL/VRGaji?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-520</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRTG8KL/VRATK?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-570</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRTG8KL/VRSewa?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-530</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRTG8KL/VRPerjalanan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                 <td>4-101</td>
            ...
            <tr>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRTG8KL/VRBiayaKantor?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-550</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRTG8KL/VRListrik?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-560</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRTG8KL/VRKonsumsi?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            ...
            <tr>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRTG8KL/VRPerbaikan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-596</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRTG8KL/VRMakan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-597</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRTG8KL/VRDexlite?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-5971</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRTG8KL/VRDexlite?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'></a></td>"; ?>
            </tr>
            ...
            <tr>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRTG8KL/VRKredit?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr style="background-color:    #F0F8FF; ">
...
<thead>
  ...
  <tbody>
    ...
    $jenis_ken = $data_ken['jenis_kendaraan']; 
     ...
     <?php echo "<td class='text-center'><a href='VLRKendaraanTG8KL?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$mt'>LR Kendaraan</a></td>"; ?>
