   ...
   $gaji_driver = $data9['jumlah_gaji'];
    ...
    while($data = mysqli_fetch_array($table101)){
        ...
        if(isset($jml_kredit)){
            ...
            // Denda Kreit
            $table623 = mysqli_query($koneksibalsri, "SELECT SUM(jumlah) AS jumlah_denda_kredit FROM pengeluaran_pul_pa WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Denda Kredit' ");
