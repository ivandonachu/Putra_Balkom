...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksibalsri_jbb, "SELECT SUM(a.ug) AS uang_gaji , b.nama_driver FROM pengiriman_ub a INNER JOIN driver b ON a.no_driver=b.no_driver INNER JOIN kendaraan c ON c.no=a.no 
...
<head>
  ...
  <title>Rincian Gaji Driver  <?= $no_polisilr; ?> (Ujung Berung)</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Gaji Driver $no_polisilr (Ujung Berung)</h5></a>"; ?>
