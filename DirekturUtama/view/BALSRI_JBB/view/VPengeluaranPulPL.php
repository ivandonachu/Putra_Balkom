...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksibalsri_jbb, "SELECT * FROM pengeluaran_pul_pl WHERE tanggal = '$tanggal_awal'");
}
else{
  $table = mysqli_query($koneksibalsri_jbb, "SELECT * FROM pengeluaran_pul_pl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
}
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VPengeluaranPulPL?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Pengeluaran PUL PL</h5></a>"; ?>
