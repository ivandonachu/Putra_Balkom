...
if ($tanggal_awal == $tanggal_akhir) {
  // Tagihan
  $table = mysqli_query($koneksibalsri_jbb, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihan_tg_8kl a INNER JOIN master_tarif_tg_8kl b ON a.delivery_point=b.delivery_point  WHERE tanggal = '$tanggal_awal'  AND no_polisi ='$no_polisilr'");
  ...
  $total_dexlite = 0;
  $total_bbm = 0;
  $table222 = mysqli_query($koneksibalsri, "SELECT jt_gps, uj , dexlite FROM pengiriman_tg_8kl a INNER JOIN kendaraan b ON a.no=b.no WHERE  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  AND b.no_polisi = '$no_polisilr' ");
  while($data = mysqli_fetch_array($table222)){
   ...
   $jml_perbaikan = $data7['jumlah_perbaikan'];
    ...
    // Tagihan
  $table = mysqli_query($koneksibalsri_jbb, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihan_tg_8kl a INNER JOIN master_tarif_tg_8kl b ON a.delivery_point=b.delivery_point  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND mt = '$no_polisilr'");
  $data = mysqli_fetch_array($table);
  $total_tagihan= $data['total_tagihan'];
  //pengiriman_tg_8kl
  $table2 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(a.dexlite) AS total_dex, SUM(a.um) AS uang_makan FROM pengiriman_tg_8kl a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi = '$no_polisilr'");
  $data2 = mysqli_fetch_array($table2);

  $total_um= $data2['uang_makan'];
  $total_dexlite = 0;
  $total_bbm = 0;
  $table222 = mysqli_query($koneksibalsri_jbb, "SELECT jt_gps, uj , dexlite FROM pengiriman_tg_8kl a INNER JOIN kendaraan b ON a.no=b.no WHERE  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  AND b.no_polisi = '$no_polisilr' ");
  while($data = mysqli_fetch_array($table222)){
    $uang_jalan = $data['uj'];
    $jt_gps = $data['jt_gps'];
    $dexlite = $data['dexlite'];
  ...
  $total_kredit= $dataa['total_kredit'];
   ...
   $jml_perbaikan = $data7['jumlah_perbaikan'];
    ...
    //Gaji dRIVER
    $table9 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(a.ug) AS jumlah_gaji FROM pengiriman_tg_8kl a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi = '$no_polisilr'");
...
<div class="container" style="color : black;">
   ...
   <div>
   <div align="left">
      <?php echo "<a href='VLabaRugiTG8KL?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><button type='button' class='btn btn-primary'>Kembali</button></a>"; ?>
    </div>
</div>
</form>
   ...
   <div class="col-md-12">
      <div class="panel panel-default">
         <div class="panel-heading">
            <h3 class="panel-title" align="Center"><strong>Laba Rugi  <?= $no_polisilr; ?> (Tj Gerem 8KL)</strong></h3>
        </div>
        ...
        <div class="panel-body">
            <div class="table-responsive">
             ...
             <tbody>
                ...
                <tr>
                 ...
                 <?php echo "<td class='text-right'><a href='VRDriverTG8KL/VRTagihan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
             </tr>
             <tr>
                 <td>4-101</td>
            ...
            <tr>
                ...
                <?php echo "<td class='text-right'><a href='VRDriverTG8KL/VRGaji?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-595</td>
               ...
               <?php echo "<td class='text-right'><a href='VRDriverTG8KL/VRPerbaikan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-596</td>
                ...
                <?php echo "<td class='text-right'><a href='VRDriverTG8KL/VRMakan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-597</td>
                ...
                <?php echo "<td class='text-right'><a href='VRDriverTG8KL/VRDexlite?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-5971</td>
