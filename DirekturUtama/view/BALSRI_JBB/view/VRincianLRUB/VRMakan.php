...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksibalsri_jbb, "SELECT SUM(a.um) AS uang_makan , b.no_polisi FROM pengiriman_ub a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY b.no_polisi ");
    $table2 = mysqli_query($koneksibalsri_jbb, "SELECT SUM(a.um) AS uang_makan , b.nama_driver FROM pengiriman_ub a INNER JOIN driver b ON a.no_driver=b.no_driver WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY b.nama_driver ");
...
<head>
  ...
  <title>Rincian Uang Makan Driver Ujung Berung</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Uang Makan Driver Ujung Berung</h5></a>"; ?>
