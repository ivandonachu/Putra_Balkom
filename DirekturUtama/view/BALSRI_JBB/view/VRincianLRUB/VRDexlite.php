...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksibalsri_jbb, "SELECT SUM(a.dexlite) AS total_dexlite , b.no_polisi FROM pengiriman_ub a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY b.no_polisi ");
