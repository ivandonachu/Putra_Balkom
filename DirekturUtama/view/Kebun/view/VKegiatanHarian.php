...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksikebun, "SELECT * FROM kegiatan_harian_seberuk a  WHERE tanggal = '$tanggal_awal'");

}
else{

  $table = mysqli_query($koneksikebun, "SELECT * FROM kegiatan_harian_seberuk a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
