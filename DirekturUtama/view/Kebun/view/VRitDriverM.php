...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksikebun,"SELECT * FROM laporan_rit_msj  WHERE tanggal ='$tanggal_awal' ");
  $table2 = mysqli_query($koneksikebun,"SELECT * FROM laporan_rit_msj  WHERE tanggal ='$tanggal_awal' GROUP BY nama_driver ");

}

else{
  $table = mysqli_query($koneksikebun,"SELECT * FROM laporan_rit_msj WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ");
  $table2 = mysqli_query($koneksikebun,"SELECT * FROM laporan_rit_msj WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_driver");
...
<div>   
 ...
 <div style="margin-right: 100px; margin-left: 100px;">
  ...
  <?php  echo "<form  method='POST' action='VRitDriverM'>" ?>
  <div>
