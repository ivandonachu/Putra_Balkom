...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksikebun, "SELECT * FROM kas_kecil_seberuk a  WHERE tanggal = '$tanggal_awal'");
  $table2 = mysqli_query($koneksikebun, "SELECT * FROM kas_kecil_seberuk a  WHERE tanggal = '$tanggal_awal' GROUP BY nama_akun");
  

}
else{

  $table = mysqli_query($koneksikebun, "SELECT * FROM kas_kecil_seberuk a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $table2 = mysqli_query($koneksikebun, "SELECT * FROM kas_kecil_seberuk a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_akun");
