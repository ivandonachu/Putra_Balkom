...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksikebun, "SELECT * FROM list_aset_mesuji");
    $table2 = mysqli_query($koneksikebun, "SELECT * FROM monitoring_aset_mesuji WHERE tanggal = '$tanggal_awal'");
} else {
    $table = mysqli_query($koneksikebun, "SELECT * FROM list_aset_mesuji");
    $table2 = mysqli_query($koneksikebun, "SELECT * FROM monitoring_aset_mesuji WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                    <?php echo "<a href='VListKendaraan><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Karyawan  Mesuji</h5></a>"; ?>
                ...
                <div>
                    ...
                    <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                        <?php echo "<form  method='POST' action='VListAsetMesujiM' style='margin-bottom: 15px;'>" ?>
                        <div>
