...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksikebun, "SELECT * FROM timbangan_getah a  WHERE tanggal = '$tanggal_awal'");
  ...
  $table = mysqli_query($koneksikebun, "SELECT * FROM timbangan_getah a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY tanggal");
