...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksikebun, "SELECT * FROM laporan_solar_msj WHERE tanggal = '$tanggal_awal'");
} else {
  $table = mysqli_query($koneksikebun, "SELECT * FROM laporan_solar_msj WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  
  $table2 = mysqli_query($koneksikebun, "SELECT SUM(jumlah) AS total_stok  FROM laporan_solar_msj 
                                    WHERE  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND keterangan = 'Stok Masuk'");
  $data2 = mysqli_fetch_array($table2);
  $total_stok = $data2['total_stok'];

  $table3 = mysqli_query($koneksikebun, "SELECT SUM(jumlah) AS total_penggunaan  FROM laporan_solar_msj 
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
          <?php echo "<a href='VLMinyak?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Stok Minyak Mesuji</h5></a>"; ?>
        ...
        <div>
          ...
          <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
            <?php echo "<form  method='POST' action='VLMinyakM' style='margin-bottom: 15px;'>" ?>
            <div>
            ...
            <table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
              ...
              <tbody>
                ...
                <td style='font-size: 14px'>$jumlah Liter</td></tr>";
                }
