...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksikebun, "SELECT * FROM produksi_karet a  WHERE tanggal = '$tanggal_awal'");
  $table2 = mysqli_query($koneksikebun, "SELECT SUM (keping) AS total_keping, nama_buruh FROM produksi_karet a  WHERE tanggal = '$tanggal_awal' GROUP BY nama_buruh");
  $table3 = mysqli_query($koneksikebun, "SELECT SUM (keping) AS total_keping, tanggal FROM produksi_karet a  WHERE tanggal = '$tanggal_awal' GROUP BY tanggal");
} else {

  $table = mysqli_query($koneksikebun, "SELECT * FROM produksi_karet a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $table2 = mysqli_query($koneksikebun, "SELECT SUM(keping) AS total_keping, nama_buruh FROM produksi_karet a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_buruh");
  $table3 = mysqli_query($koneksikebun, "SELECT SUM(keping) AS total_keping, tanggal FROM produksi_karet a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY tanggal");
}
...
<head>
  ...
  <title>Data Produksi Karet</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
          <?php echo "<a href='VAbsensiBuruh?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Data Produksi Karet</h5></a>"; ?>
        ...
        <div>
          ...
          <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
            ...
            <?php echo "<form  method='POST' action='VDataProduksi' style='margin-bottom: 15px;'>" ?>
            <div>
      ...
      <td style='font-size: 14px'>$keping</td>
            ...
            <h5 align="center">Rincian Data Produksi Karet Per Buruh</h5>
            <!-- Tabel -->
