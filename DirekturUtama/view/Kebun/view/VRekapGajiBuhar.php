...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksikebun, "SELECT * FROM rekap_gaji_burhar_seberuk WHERE tanggal = '$tanggal_awal'");
} else {
  $table = mysqli_query($koneksikebun, "SELECT * FROM rekap_gaji_burhar_seberuk WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
}
