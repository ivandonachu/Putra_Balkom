...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table2 = mysqli_query($koneksikebun, "SELECT SUM(timbang_gudang) AS total_timbang_gudang, SUM(timbang_pabrik) AS total_timbang_pabrik , harga FROM laporan_karet_seberuk WHERE WHERE tanggal = '$tanggal_akhir'");
