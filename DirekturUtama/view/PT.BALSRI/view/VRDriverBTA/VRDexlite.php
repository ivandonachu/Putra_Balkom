...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksibalsri, "SELECT SUM(a.dexlite) AS total_dexlite , b.no_polisi FROM pengiriman_br a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND  b.no_polisi = '$no_polisilr' ");
