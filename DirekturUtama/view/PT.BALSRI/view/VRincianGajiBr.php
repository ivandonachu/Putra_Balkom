...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksibalsri, "SELECT * FROM pengiriman_br a INNER JOIN driver b ON a.no_driver=b.no_driver INNER JOIN kendaraan c ON c.no=a.no WHERE tanggal = '$tanggal_awal' AND nama_driver = '$nama_driver' " );

}
else{

  $table = mysqli_query($koneksibalsri, "SELECT * FROM pengiriman_br a INNER JOIN driver b ON a.no_driver=b.no_driver INNER JOIN kendaraan c ON c.no=a.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_driver = '$nama_driver' ");
