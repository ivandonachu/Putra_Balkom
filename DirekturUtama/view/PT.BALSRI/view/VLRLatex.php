...
if ($tanggal_awal == $tanggal_akhir) {
      ...
      // Tagihan
  $table = mysqli_query($koneksilatex, "SELECT SUM(total) AS total_tagihan FROM tagihan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  ...
  //pengeluran Pul Biaya Kantor
   $table3 = mysqli_query($koneksilatex, "SELECT SUM(jumlah) AS jumlah_biaya_kantor FROM pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Kantor' ");
   ...
   $table4 = mysqli_query($koneksilatex, "SELECT SUM(jumlah) AS jumlah_listrik FROM pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Listrik & Telepon' ");
   ...
   $table5 = mysqli_query($koneksilatex, "SELECT SUM(jumlah) AS jumlah_sewa FROM pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Sewa' ");
   ...
   $table6 = mysqli_query($koneksilatex, "SELECT SUM(jumlah) AS jumlah_atk FROM pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Alat Tulis Kantor' ");
   ...
   $table61 = mysqli_query($koneksilatex, "SELECT SUM(jumlah) AS jumlah_transport FROM pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Transport / Perjalanan Dinas' ");
   ...
   $table62 = mysqli_query($koneksilatex, "SELECT SUM(jumlah) AS jumlah_konsumsi FROM pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Konsumsi' ");
   ...
   $table7 = mysqli_query($koneksilatex, "SELECT SUM(jml_pengeluaran) AS jumlah_perbaikan FROM riwayat_perbaikan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ");
   ...
   $jml_perbaikan = $data7['jumlah_perbaikan'];
    ...
    $jml_perbaikan = 0;
     ...
     //Gaji karyawan
   $table8 = mysqli_query($koneksilatex, "SELECT SUM(jumlah) AS jumlah_gaji FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'Karyawan' ");
   ...
   $gaji_karyawan = $data8['jumlah_gaji'];
    ...
    //Gaji dRIVER
   $table9 = mysqli_query($koneksilatex, "SELECT SUM(jumlah) AS jumlah_gaji FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'Driver' ");
   ...
   $gaji_driver = $data9['jumlah_gaji'];
    ...
    $total_gaji_karaywan = $gaji_karyawan ;

    //list kendaraan
    $table10 =  mysqli_query($koneksilatex, "SELECT b.no_polisi FROM tagihan a INNER JOIN kendaraan b ON b.no=a.no_kendaraan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY b.no_polisi ");
...
<div class="container" style="color : black;">
   <?php  echo "<form  method='POST' action='VLRLatex' style='margin-bottom: 15px;'>" ?>
   <div>
   ...
   <div class="col-md-12">
      <div class="panel panel-default">
         <div class="panel-heading">
            <h3 class="panel-title" align="Center"><strong>Laba Rugi Latex</strong></h3>
        </div>
        ...
        <div class="panel-body">
            <div class="table-responsive">
             ...
             <tbody>
                ...
                <tr>
                 ...
                 <?php echo "<td class='text-right'><a href='VRincianLRLx/VRTagihan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
             </tr>
            ...
            <tr>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRLx/VRATK?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-570</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRLx/VRSewa?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-530</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRLx/VRPerjalanan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                 <td>4-101</td>
            ...
            <tr>
                ...
                <td class="text-left"><?= formatuang(0); ?></td>
                <td class="text-left"><?= formatuang($total_ug); ?></td>
            ...
            <tr>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRLx/VRBiayaKantor?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-550</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRLx/VRListrik?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-560</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRLx/VRKonsumsi?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-595</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRLx/VRPerbaikan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-596</td>
                ...
                <?php echo "<td class='text-right'><a href='VRincianLRLx/VRMakan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-597</td>
...
<thead>
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table10)){
     ...
     $result = mysqli_query($koneksilatex, "SELECT * FROM kendaraan WHERE no_polisi = '$mt' ");
    ...
    $jenis_ken = $data_ken['jenis_kendaraan']; 
     ...
     <?php echo "<td class='text-center'><a href='VLRKendaraanLatex?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$mt'>LR Kendaraan</a></td>"; ?>
