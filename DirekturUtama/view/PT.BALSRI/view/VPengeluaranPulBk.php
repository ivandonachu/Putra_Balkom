...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksibalsri, "SELECT * FROM pengeluaran_pul_bk WHERE tanggal = '$tanggal_awal'");
  $table2 = mysqli_query($koneksibalsri, "SELECT nama_akun , SUM(jumlah) AS total_pengeluaran FROM pengeluaran_pul_bk WHERE tanggal = '$tanggal_awal' GROUP BY nama_akun");
}
else{
  $table = mysqli_query($koneksibalsri, "SELECT * FROM pengeluaran_pul_bk WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $table2 = mysqli_query($koneksibalsri, "SELECT nama_akun , SUM(jumlah) AS total_pengeluaran FROM pengeluaran_pul_bk WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_akun");
}
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VPengeluaranPulBk?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Pengeluaran PUL BK</h5></a>"; ?>
...
<div>   
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
    <?php  echo "<form  method='POST' action='VPengeluaranPulBk' style='margin-bottom: 15px;'>" ?>
    <div>
