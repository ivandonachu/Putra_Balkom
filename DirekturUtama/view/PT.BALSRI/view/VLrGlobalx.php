...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    //TAGIHAN
    // Tagihan baturaja
    $table_br = mysqli_query($koneksibalsri, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihan_brx a INNER JOIN master_tarif_brx b ON a.no=b.no  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
    $data_br = mysqli_fetch_array($table_br);
    $total_tagihan_br = $data_br['total_tagihan'];

    // Tagihan lampung
    $table_lmg = mysqli_query($koneksibalsri, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihanx a INNER JOIN master_tarifx b ON a.no=b.no  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
    ...
    // Tagihan palembang
    $table_plg = mysqli_query($koneksibalsri, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihan_px a INNER JOIN master_tarif_px b ON a.no=b.no  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
...
// PPH 23 global 2%
$pph_23_global = (($total_tagihan_global * 2) / 100);
// Potongan global 12.2%
$jumlah_potongan_global = ((($total_tagihan_global - $pph_23_global) * 12.2) / 100);
$total_laba_kotor = $total_tagihan_global - ($jumlah_potongan_global + $pph_23_global);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container" style="color : black;">
                    <?php echo "<form  method='POST' action='VLrGlobalx' style='margin-bottom: 15px;'>" ?>
                    <div>
                                        ...
                                        <table class="table table-condensed" style="color : black;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php echo "<td class='text-right'><a href='VRincianLRBTA/VRTagihanx?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'></a></td>"; ?>
                                                </tr>
                                                 <tr>
                                                    <td>4-101</td>
                                                ...
                                                <tr>
                                                    <td>4-101</td>
                                                    <td class="text-left">PPH 23 2%</td>
                                                    <td class="text-left"><?= formatuang($pph_23_global); ?></td>
                                                    <td class="text-left"><?= formatuang(0); ?></td>
                                                    <td class="text-left"></td>
                                                </tr>
                                                ...
                                                <tr style="background-color: navy;  color:white;">
                                                    ...
                                                    <?php } else if ($total_tagihan_global == 0) { ?>
