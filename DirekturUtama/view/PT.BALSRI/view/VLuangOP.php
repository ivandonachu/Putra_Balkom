            ...
            <div class="col-md-12">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title" align="Center"><strong>Laporan Uang Oprasional Global Region Sumatera</strong></h3>
                </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-condensed" style="color : black;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total Tagihan</td>
                          <td class="text-center"><?php echo formatuang($total_tagihan_lmg + $total_tagihan_spbu);  ?></td>
                        </tr>
                        <tr>
                          <td>Total Tagihan di Potong PPH 23 2%</td>
