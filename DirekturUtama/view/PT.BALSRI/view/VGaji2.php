...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksibalsri, "SELECT a.nama_driver , SUM(ug) AS total_gaji FROM driver a INNER JOIN pengiriman b ON a.no_driver=b.no_driver WHERE tanggal = '$tanggal_awal' GROUP BY a.nama_driver ");

}
else{

  $table = mysqli_query($koneksibalsri, "SELECT a.nama_driver , SUM(ug) AS total_gaji FROM driver a INNER JOIN pengiriman b ON a.no_driver=b.no_driver WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY a.nama_driver ");
...
<div>   
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
    ...
    <?php  echo "<form  method='POST' action='VGaji2' style='margin-bottom: 15px;'>" ?>
    <div>
