...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksilatex, "SELECT * FROM pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Kantor' ORDER BY tanggal");
}
