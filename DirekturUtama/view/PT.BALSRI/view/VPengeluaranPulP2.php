...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksibalsri, "SELECT * FROM pengeluaran_pul_p WHERE tanggal = '$tanggal_awal'");
  $table2 = mysqli_query($koneksibalsri, "SELECT nama_akun , SUM(jumlah) AS total_pengeluaran FROM pengeluaran_pul_p WHERE tanggal = '$tanggal_awal' GROUP BY nama_akun");
}
else{
  $table = mysqli_query($koneksibalsri, "SELECT * FROM pengeluaran_pul_p WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $table2 = mysqli_query($koneksibalsri, "SELECT nama_akun , SUM(jumlah) AS total_pengeluaran FROM pengeluaran_pul_p WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_akun");
}
