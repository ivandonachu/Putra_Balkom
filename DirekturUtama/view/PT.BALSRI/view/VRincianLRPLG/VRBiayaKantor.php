...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksibalsri, "SELECT * FROM pengeluaran_pul_p WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Biaya Kantor' ");
}
else{
  $table = mysqli_query($koneksibalsri, "SELECT * FROM pengeluaran_pul_p WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Kantor' ORDER BY tanggal");
}
...
<head>
  ...
  <title>Biaya Kantor Palembang</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VRBiayaKantor?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Rincian Biaya Kantor Palembang</h5></a>"; ?>
