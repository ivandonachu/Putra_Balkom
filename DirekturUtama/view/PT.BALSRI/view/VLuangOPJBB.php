...
// PPH 23 2%
$jumlah_pph_23_lmg = (($total_tagihan_lmg * 2) / 100);

$total_laba_pph23_lmg = $total_tagihan_lmg - $jumlah_pph_23_lmg;

// Potongan 12.2%
$jumlah_potongan_lmg = (($total_laba_pph23_lmg * 12.2) / 100);
...
// PPH 23 2%
$jumlah_pph_23_spbu_lmg = (($total_tagihan_spbu * 2) / 100);

$total_laba_pph23_spbu_lmg = $total_tagihan_spbu - $jumlah_pph_23_spbu_lmg;

// Potongan 12.2%
$jumlah_potongan_spbu_lmg = (($total_laba_pph23_spbu_lmg * 12.2) / 100);
...
// PPH 23 2%
$jumlah_pph_23_bta = (($total_tagihan_bta * 2) / 100);

$total_laba_pph23_bta = $total_tagihan_bta - $jumlah_pph_23_bta;

// Potongan 12.2%
$jumlah_potongan_bta = (($total_laba_pph23_bta * 12.2) / 100);
...
// PPH 23 2%
$jumlah_pph_23_plg = (($total_tagihan_plg * 2) / 100);

$total_laba_pph23_plg = $total_tagihan_plg - $jumlah_pph_23_plg;

// Potongan 12.2%
$jumlah_potongan_plg = (($total_laba_pph23_plg * 12.2) / 100);
...
// PPH 23 2%
$jumlah_pph_23_bb = (($total_tagihan_bb * 2) / 100);

$total_laba_pph23_bb = $total_tagihan_bb - $jumlah_pph_23_bb;

// Potongan 12.2%
$jumlah_potongan_bb = (($total_laba_pph23_bb * 12.2) / 100);
...
$total_gaji_karyawan_bb = $gaji_karyawan_bb;
...
// PPH 23 2%
$jumlah_pph_23_bk = (($total_tagihan_bk * 2) / 100);

$total_laba_pph23_bk = $total_tagihan_bk - $jumlah_pph_23_bk;

// Potongan 12.2%
$jumlah_potongan_bk = (($total_laba_pph23_bk * 12.2) / 100);
//pengiriman
...
$total_gaji_karyawan_bk = $gaji_karyawan_bk;
...
// PPH 23 2%
$jumlah_pph_23_bkl = (($total_tagihan_bkl * 2) / 100);

$total_laba_pph23_bkl = $total_tagihan_bkl - $jumlah_pph_23_bkl;

// Potongan 12.2%
$jumlah_potongan_bkl = (($total_laba_pph23_bkl * 12.2) / 100);

//pengiriman
$table2_bkl = mysqli_query($koneksistre, "SELECT SUM(dexlite) AS total_dex, SUM(um) AS uang_makan FROM pengiriman WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
$data2_bkl = mysqli_fetch_array($table2_bkl);
$jml_dex_bkl = $data2_bkl['total_dex'];
$total_um_bkl = $data2_bkl['uang_makan'];

$total_dexlite_bkl = $jml_dex_bkl * 9700;
...
$data6_bB = mysqli_fetch_array($table6_bkl);
$jml_atk_bkl = $data6_bB['jumlah_atk'];
if (!isset($data6_bB['jumlah_atk'])) {
  $jml_atk_bkl = 0;
}
...
//Gaji karyawan
$table8_bkl = mysqli_query($koneksistre, "SELECT SUM(jumlah) AS jumlah_gaji FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'BALSRI BL' ");
$data8_bkl = mysqli_fetch_array($table8_bkl);
$gaji_karyawan_bkl = $data8_bkl['jumlah_gaji'];
if (!isset($data8_bkl['jumlah_gaji'])) {
  $gaji_karyawan_bkl = 0;
}
//Gaji dRIVER
$table9_bkl = mysqli_query($koneksistre, "SELECT SUM(jumlah) AS jumlah_gaji FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'Driver BL' ");
...
$total_gaji_karyawan_bkl = $gaji_karyawan_bkl;
...
//totalkredit
$total_kredit_bkl = 0;
while ($data_bkl = mysqli_fetch_array($table101_bkl)) {
  $mt_bkl = $data_bkl['mt'];
  $tablee_bkl = mysqli_query($koneksistre, "SELECT SUM(jumlah) AS total_kredit FROM kredit_kendaraan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND no_polisi ='$mt_bkl'");
  $dataa_bkl = mysqli_fetch_array($tablee_bkl);
  $jml_kredit_bkl = $dataa_bkl['total_kredit'];
...
// PPH 23 2%
$jumlah_pph_23_ba = (($total_tagihan_ba * 2) / 100);

$total_laba_pph23_ba = $total_tagihan_ba - $jumlah_pph_23_ba;

// Potongan 12.2%
$jumlah_potongan_ba = (($total_laba_pph23_ba * 12.2) / 100);
...
// PPH 23 2%
$jumlah_pph_23_pa = (($total_tagihan_pa * 2) / 100);

$total_laba_pph23_pa = $total_tagihan_pa - $jumlah_pph_23_pa;

// Potongan 12.2%
$jumlah_potongan_pa = (($total_laba_pph23_pa * 12.2) / 100);
...
// PPH 23 2%
$jumlah_pph_23_tg = (($total_tagihan_tg * 2) / 100);

$total_laba_pph23_tg = $total_tagihan_tg - $jumlah_pph_23_tg;

// Potongan 12.2%
$jumlah_potongan_tg = (($total_laba_pph23_tg * 12.2) / 100);
...
// PPH 23 2%
$jumlah_pph_23_ub = (($total_tagihan_tg * 2) / 100);

$total_laba_pph23_ub = $total_tagihan_tg - $jumlah_pph_23_ub;

// Potongan 12.2%
$jumlah_potongan_ub = (($total_laba_pph23_ub * 12.2) / 100);
...
$total_tagihan_global = $total_tagihan_lmg + $total_tagihan_plg + $total_tagihan_bta + $total_tagihan_bb + $total_tagihan_spbu + $total_tagihan_bk + $total_tagihan_bkl + $total_tagihan_latex +
  $total_tagihan_ba + $total_tagihan_pa + $total_tagihan_pl + $total_tagihan_tg + $total_tagihan_ub;

// PPH 23 2%
$jumlah_pph_23_global = (($total_tagihan_global * 2) / 100);

$total_laba_pph23_global = $total_tagihan_global - $jumlah_pph_23_global;

// Potongan 12.2%
$jumlah_potongan_global = (($total_laba_pph23_global * 12.2) / 100);
...
$biaya_kantor_global = $jml_biaya_kantor_lmg + $jml_biaya_kantor_plg + $jml_biaya_kantor_bta + $jml_biaya_kantor_bb + $jml_biaya_kantor_bk + $jml_biaya_kantor_bk + $jml_biaya_kantor_bkl + $jml_biaya_kantor_lx +
  $jml_biaya_kantor_ba + $jml_biaya_kantor_pa + $jml_biaya_kantor_pl + $jml_biaya_kantor_tg + $jml_biaya_kantor_ub;
$listrik_global = $jml_listrik_lmg + $jml_listrik_plg + $jml_listrik_bta + $jml_listrik_bb + $jml_listrik_bk + $jml_listrik_bkl + $jml_listrik_lx + $jml_listrik_ba + $jml_listrik_pl + $jml_listrik_pa + $jml_listrik_tg + $jml_listrik_ub;

$sewa_global = $jml_sewa_lmg + $jml_sewa_plg + $jml_sewa_bta + $jml_sewa_bb + $jml_sewa_bk + $jml_sewa_bkl + $jml_sewa_lx + $jml_sewa_ba + $jml_sewa_pl + $jml_sewa_pa + $jml_sewa_tg + $jml_sewa_ub;

$atk_global = $jml_atk_lmg + $jml_atk_plg + $jml_atk_bta + $jml_atk_bb + $jml_atk_bk + $jml_atk_bkl + $jml_atk_lx + $jml_atk_ba + $jml_atk_pl + $jml_atk_pa + $jml_atk_tg + $jml_atk_ub;
...
$gaji_karyawan_global = $total_gaji_karyawan_lmg + $total_gaji_karyawan_plg + $total_gaji_karyawan_bta + $total_gaji_karyawan_bb + $total_gaji_karyawan_bk + $total_gaji_karyawan_bkl + $total_gaji_karyawan_lx +
  $total_gaji_karyawan_ba + $total_gaji_karyawan_pl + $total_gaji_karyawan_pa + $total_gaji_karyawan_tg + $total_gaji_karyawan_ub;

$transport_global = $jml_transport_lmg + $jml_transport_plg + $jml_transport_bta + $jml_transport_bb + $jml_transport_bk + $jml_transport_bkl + $jml_transport_lx + $jml_transport_ba + $jml_transport_pl + $jml_transport_pa + $jml_transport_tg + $jml_transport_ub;

$konsumsi_global = $jml_konsumsi_lmg + $jml_konsumsi_plg + $jml_konsumsi_bta + $jml_konsumsi_bb + $jml_konsumsi_bk + $jml_konsumsi_bkl + $jml_konsumsi_lx + $jml_konsumsi_ba + $jml_konsumsi_pl + $jml_konsumsi_pa + $jml_konsumsi_tg + $jml_konsumsi_ub;
...
$total_oprasional_global = $total_oprasional_bta + $total_oprasional_lmg + $total_oprasional_plg + $total_oprasional_bb + $total_oprasional_bk + $total_oprasional_bkl + $total_oprasional_lx +
  $total_oprasional_ba + $total_oprasional_pl + $total_oprasional_pa + $total_oprasional_tg + $total_oprasional_ub;
            ...
            <div class="col-md-12">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h3 class="panel-title" align="Center"><strong>Laporan Uang Oprasional Global Region Sumatera + Jawa</strong></h3>
                </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-condensed" style="color : black;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total Tagihan di Potong PPH 23 2%</td>
                          <td class="text-center"><?php echo formatuang($total_laba_pph23_global);  ?></td>
                        </tr>
                        <tr style="background-color:    #F0F8FF; ">
                          <td> <strong>Potongan Oprasional 12.2%</strong> </td>
                  ...
                  <div class="table-responsive">
                    <table class="table table-condensed" style="color : black;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total Tagihan di Potong PPH 23 2%</td>
                          <td class="text-center"><?php echo formatuang($total_laba_pph23_lmg + $total_laba_pph23_spbu_lmg );  ?></td>
                        </tr>
                        <tr style="background-color:    #F0F8FF; ">
                          <td> <strong>Potongan Oprasional 12.2%</strong> </td>
                          <td class="text-center"><strong><?php echo formatuang($jumlah_potongan_lmg + $jumlah_potongan_spbu_lmg);  ?></strong></td>
                        </tr>
                  ...
                  <div class="table-responsive">
                    <table class="table table-condensed" style="color : black;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total Tagihan di Potong PPH 23 2%</td>
                          <td class="text-center"><?php echo formatuang($total_laba_pph23_plg);  ?></td>
                        </tr>
                        <tr style="background-color:    #F0F8FF; ">
                          <td> <strong>Potongan Oprasional 12.2%</strong> </td>
                  ...
                  <div class="table-responsive">
                    <table class="table table-condensed" style="color : black;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total Tagihan di Potong PPH 23 2%</td>
                          <td class="text-center"><?php echo formatuang($total_laba_pph23_bta);  ?></td>
                        </tr>
                        <tr style="background-color:    #F0F8FF; ">
                          <td> <strong>Potongan Oprasional 12.2%</strong> </td>
                  ...
                  <div class="table-responsive">
                    <table class="table table-condensed" style="color : black;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Total Tagihan di Potong PPH 23 2%</td>
                          <td class="text-center"><?php echo formatuang($total_laba_pph23_bb);  ?></td>
                        </tr>
                        <tr style="background-color:    #F0F8FF; ">
                          <td> <strong>Potongan Oprasional 12.2%</strong> </td>
                    ...
                    <table class="table table-condensed" style="color : black;">
                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         <tr>
                          <td>Total Tagihan di Potong PPH 23 2%</td>
                          <td class="text-center"><?php echo formatuang($total_laba_pph23_bk);  ?></td>
                        </tr>
                        <tr style="background-color:    #F0F8FF; ">
                          <td> <strong>Potongan Oprasional 12.2%</strong> </td>
                    ...
                    <table class="table table-condensed" style="color : black;">
                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         <tr>
                          <td>Total Tagihan di Potong PPH 23 2%</td>
                          <td class="text-center"><?php echo formatuang($total_laba_pph23_bkl);  ?></td>
                        </tr>
                        <tr style="background-color:    #F0F8FF; ">
                          <td> <strong>Potongan Oprasional 12.2%</strong> </td>
                    ...
                    <table class="table table-condensed" style="color : black;">
                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         <tr>
                          <td>Total Tagihan di Potong PPH 23 2%</td>
                          <td class="text-center"><?php echo formatuang($total_laba_pph23_pa);  ?></td>
                        </tr>
                        <tr style="background-color:    #F0F8FF; ">
                          <td> <strong>Potongan Oprasional 12.2%</strong> </td>
                    ...
                    <table class="table table-condensed" style="color : black;">
                      ...
                      <tbody>
                        ...
                        <tr>
                         ...
                         <tr>
                          <td>Total Tagihan di Potong PPH 23 2%</td>
                          <td class="text-center"><?php echo formatuang($total_laba_pph23_pl);  ?></td>
                        </tr>
                        <tr style="background-color:    #F0F8FF; ">
                          <td> <strong>Potongan Oprasional 12.2%</strong> </td>
