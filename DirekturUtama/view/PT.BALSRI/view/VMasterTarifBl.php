...
$table = mysqli_query($koneksibalsri, "SELECT * FROM master_tarif_bl ");
       ...
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/proses_master_tarif_bl' enctype='multipart/form-data' method='POST'>";  ?>
        ...
        <div class="modal-dialog modal-lg" role ="document">
          <div class="modal-content"> 
            ...
            <div class="modal-body">
              <form action="../proses/edit_master_tarif_bl" enctype="multipart/form-data" method="POST">
           ...
           <div class="row">
            <div class="col-md-6">
             <label>pemilik</label>
             <input class="form-control form-control-sm" type="text" id="pemilik" name="pemilik" required=""  value="<?php echo $cluster;?>" >
           </div>
...
<div class="modal fade" id="PopUpHapus<?php echo $data['delivery_point']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
 <div class="modal-dialog" role ="document">
   <div class="modal-content"> 
    ...
    <div class="modal-body">
      <form action="../proses/hapus_master_tarif_bl" method="POST">
        <input type="hidden" name="delivery_point" value="<?php echo $delivery_point;?>">
