...
if ($tanggal_awal == $tanggal_akhir) {
  // Tagihan
  $table = mysqli_query($koneksilatex, "SELECT SUM(total) AS total_tagihan, SUM(rit) AS total_rit  FROM tagihan  WHERE tanggal = '$tanggal_awal'  AND no_polisi ='$no_polisilr'");
  ...
  //pengiriman
  $table2 = mysqli_query($koneksilatex, "SELECT SUM(uang_dexlite) AS total_dex, SUM(um) AS uang_makan, SUM(ug) AS uang_gaji FROM pengiriman WHERE tanggal = '$tanggal_awal'");
  ...
  $total_ug= $data2['uang_gaji'];
   ...
   $table7 = mysqli_query($koneksilatex, "SELECT SUM(jml_pengeluaran) AS jumlah_perbaikan FROM riwayat_perbaikan WHERE tanggal = '$tanggal_awal'");
   ...
   $jml_perbaikan = $data7['jumlah_perbaikan'];
    ...
    $jml_perbaikan = 0;
          ...
          // Tagihan
  $table = mysqli_query($koneksilatex, "SELECT SUM(total) AS total_tagihan FROM tagihan a INNER JOIN kendaraan b on b.no=a.no_kendaraan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi ='$no_polisilr'");
  $data = mysqli_fetch_array($table);
  $total_tagihan= $data['total_tagihan'];

  
  //pengiriman
  $table2 = mysqli_query($koneksilatex, "SELECT SUM(uang_dexlite) AS total_dex, SUM(um) AS uang_makan, SUM(ug) AS uang_gaji, SUM(mel) AS uang_mel FROM pengiriman a INNER JOIN kendaraan b ON a.no_kendaraan = b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi ='$no_polisilr'");
  $data2 = mysqli_fetch_array($table2);
  $total_dexlite= $data2['total_dex'];
  $total_um= $data2['uang_makan'];
  $total_ug= $data2['uang_gaji'];
  ...
  $total_kredit= $dataa['total_kredit'];
    ...
    //pengeluran perbaikan
   $table7 = mysqli_query($koneksilatex, "SELECT SUM(jml_pengeluaran) AS jumlah_perbaikan FROM riwayat_perbaikan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND no_polisi ='$no_polisilr' ");
   $data7 = mysqli_fetch_array($table7);
   $jml_perbaikan = $data7['jumlah_perbaikan'];
    if (!isset($data7['jumlah_perbaikan'])) {
    $jml_perbaikan = 0;
      ...
      $table10 =  mysqli_query($koneksilatex, "SELECT b.no_polisi FROM tagihan a INNER JOIN kendaraan b ON b.no=a.no_kendaraan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY b.no_polisi ");
        ...
        $total_biaya_usaha_final = $total_dexlite  + $jml_perbaikan + $total_um + $total_kredit + $total_mel + $total_ug;
   ...
   <div class="col-md-12">
      <div class="panel panel-default">
         <div class="panel-heading">
            <h3 class="panel-title" align="Center"><strong>Laba Rugi  <?= $no_polisilr; ?> (Latex)</strong></h3>
        </div>
        ...
        <div class="panel-body">
            <div class="table-responsive">
             ...
             <tbody>
                ...
                <tr>
                 ...
                 <?php echo "<td class='text-right'><a href='VRDriverLx/VRTagihan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
             </tr>
             <tr>
                 <td>4-101</td>
            ...
            <tr>
                ...
                <?php echo "<td class='text-right'><a href='VRDriverLx/VRGaji?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-595</td>
               ...
               <?php echo "<td class='text-right'><a href='VRDriverLx/VRPerbaikan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-596</td>
                ...
                <?php echo "<td class='text-right'><a href='VRDriverLx/VRMakan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-597</td>
            ...
            <tr>
                ...
                <?php echo "<td class='text-right'><a href='VRDriverLx/VRMel?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
