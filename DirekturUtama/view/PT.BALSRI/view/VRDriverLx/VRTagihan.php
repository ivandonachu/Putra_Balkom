...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksilatex, "SELECT * FROM tagihan a INNER JOIN driver_1 b on b.no_driver_1=a.no_driver_1
                                                                            ...
                                                                            WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND d.no_polisi = '$no_polisilr' ORDER BY tanggal");

$table2 = mysqli_query($koneksilatex, "SELECT SUM(total) AS total_tagihan, SUM(rit) AS total_rit  FROM tagihan a INNER JOIN kendaraan b on b.no=a.no_kendaraan WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi = '$no_polisilr'");
