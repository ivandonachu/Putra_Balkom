...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksilatex, "SELECT  SUM(uang_dexlite) AS total_dexlite FROM pengiriman a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");

}

else{

  $table = mysqli_query($koneksilatex, "SELECT b.no_polisi, SUM(uang_dexlite) AS total_dexlite  FROM pengiriman a INNER JOIN kendaraan b ON a.no_kendaraan=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi = '$no_polisilr'");
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VRMakantanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Dexlite  $no_polisilr (Latex)</h5></a>"; ?>
...
<table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table)){
      ...
      $total_dexlite = $data['total_dexlite'];
