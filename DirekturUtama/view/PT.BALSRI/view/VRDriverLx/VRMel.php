...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksilatex, "SELECT b.no_polisi, SUM(mel) AS total_mel  FROM pengiriman a INNER JOIN kendaraan b ON a.no_kendaraan=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi = '$no_polisilr' GROUP BY b.no_polisi");
}
