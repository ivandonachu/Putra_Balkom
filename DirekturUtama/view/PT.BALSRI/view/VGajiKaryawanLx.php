...
$table = mysqli_query($koneksilatex, "SELECT * FROM riwayat_penggajian ");
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VGajiKaryawanLx'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Pencatatan Gaji Karyawan Latex</h5></a>"; ?>
