...
$table = mysqli_query($koneksilatex, "SELECT * FROM kendaraan");
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VMTLx'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Pencatatan Kendaraan</h5></a>"; ?>
