...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksibalsri, "SELECT * FROM riwayat_penggajian WHERE tanggal  = '$tanggal_awal'  AND referensi = 'Driver LMG' OR tanggal  = '$tanggal_awal'  AND referensi = 'BALSRI BTA'");
