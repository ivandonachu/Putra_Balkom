...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksibalsri, "SELECT * FROM riwayat_penggajian WHERE tanggal  = '$tanggal_awal'  AND referensi = 'Driver LMG' OR tanggal  = '$tanggal_awal'  AND referensi = 'BALSRI LMG'");
  
  }
  
  else{
    $table = mysqli_query($koneksibalsri, "SELECT * FROM riwayat_penggajian WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'Driver LMG' OR tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'BALSRI LMG'");
...
?>
 ...
 <head>
  ...
  <title>Rincian Gaji Karyawan dan Driver Lampung</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRGaji'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Gaji Karyawan dan Driver Lampung</h5></a>"; ?>
