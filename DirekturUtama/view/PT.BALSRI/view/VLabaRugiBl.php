...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $total_dexlite = 0;
    $table222 = mysqli_query($koneksibalsri, "SELECT jt_gps, uj FROM pengiriman_bl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
    ...
    $table623 = mysqli_query($koneksibalsri, "SELECT SUM(jumlah) AS jumlah_denda_kredit FROM pengeluaran_pul_bl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Denda Kredit' ");
                                        ...
                                        <table class="table table-condensed" style="color : black;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php echo "<td class='text-right'><a href='VRincianLRBL/VRBiayaKantor?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
                                                <tr>
                                                    <td>5-550</td>
                                                    ...
                                                    <?php echo "<td class='text-right'><a href='VRincianLRBL/VRListrik?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
                                                <tr>
                                                    <td>5-560</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php echo "<td class='text-right'><a href='VRincianLRBL/VRPerbaikan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
                                                <tr>
                                                    <td>5-596</td>
                                                    ...
                                                    <?php echo "<td class='text-right'><a href='VRincianLRBL/VRMakan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
                                                <tr>
                                                    <td>5-597</td>
                                                    ...
                                                    <?php echo "<td class='text-right'><a href='VRincianLRBL/VRDexlite?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
                                                <tr>
                                                    <td>5-598</td>
                                                    ...
                                                    <?php echo "<td class='text-right'><a href='VRincianLRBL/VRKredit?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
                                                <tr>
                                                    <td>5-599</td>
                                                    ...
                                                    <?php echo "<td class='text-right'><a href='VRincianLRBL/VRDendaKredit?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
