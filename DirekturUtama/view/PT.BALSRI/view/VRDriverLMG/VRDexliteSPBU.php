...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksibalsri, "SELECT  SUM(dexlite) AS total_dexlite FROM pengiriman_spbu a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");

}

else{
  $table = mysqli_query($koneksibalsri, "SELECT jt_gps, uj FROM pengiriman_spbu a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi = '$no_polisilr'");
...
<head>
  ...
  <title>Rincian Dexlite  <?= $no_polisilr; ?> 8KL</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VRMakantanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Dexlite  $no_polisilr (Lampung) 8KL</h5></a>"; ?>
...
<td style='font-size: 14px'>$no_polisilr</td>
