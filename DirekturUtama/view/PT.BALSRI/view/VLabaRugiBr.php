...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $total_dexlite = 0;
    $total_bbm = 0;
    $table222 = mysqli_query($koneksibalsri, "SELECT jt_gps, uj , dexlite FROM pengiriman_br WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
...
<head>
    ...
    <title>Laba Rugi BALSRI Baturaja</title>
