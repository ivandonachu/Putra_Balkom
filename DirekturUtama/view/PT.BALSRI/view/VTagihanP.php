...
$table = mysqli_query($koneksibalsri,"SELECT * FROM pengiriman_p ")
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VTagihan'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Tagihan Angkutan Pertashop Palembang</h5></a>"; ?>
...
<div>   
 ...
 <div style="margin-right: 100px; margin-left: 100px;">
      ...
      <?php  echo "<form  method='POST' action='VTagihanP2.php'>" ?>
      <div>
