...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksibalsri, "SELECT * FROM tagihan_p a INNER JOIN master_tarif_p b ON a.delivery_point=b.delivery_point WHERE tanggal = '$tanggal_awal' AND mt = '$no_polisilr'" );
  ...
  $table = mysqli_query($koneksibalsri, "SELECT * FROM tagihan_p a INNER JOIN master_tarif_p b ON a.delivery_point=b.delivery_point WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND mt = '$no_polisilr' ORDER BY a.tanggal");
