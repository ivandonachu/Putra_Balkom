...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksibalsri, "SELECT SUM(a.ug) AS uang_gaji , b.nama_driver FROM pengiriman_p a INNER JOIN driver b ON a.no_driver=b.no_driver INNER JOIN kendaraan c ON c.no=a.no 
