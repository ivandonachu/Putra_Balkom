...
<head>
  ...
  <title>Rekap Do Penjualan Semen (Etty)</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rekap Do Penjualan Semen (Etty)</h5></a>"; ?>
...
<table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  ...
  <tbody>
    ...
    $tablexk = mysqli_query($koneksipbj, "SELECT no_do FROM penjualan_sl WHERE no_do = '$no_do_pembelian'");
    if(mysqli_num_rows($tablexk) == 1 ){
      ...
      $tablexj = mysqli_query($koneksipbj, "SELECT no_do FROM penjualan_s WHERE  no_do = '$no_do_pembelian'");
