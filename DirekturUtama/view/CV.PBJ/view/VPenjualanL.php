...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksipbr,"SELECT * FROM penjualan_sl WHERE tanggal_kirim = '$tanggal_akhir' ");
  //Curah OPC Type 1 bayar
  $table2 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_copct1 ,  SUM(jumlah) AS uang_copct1  FROM penjualan_sl WHERE  tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Curah OPC Type 1' OR  tanggal_kirim =  
  ...
  $table22 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_copct1_bon ,  SUM(jumlah) AS uang_copct1_bon  FROM penjualan_sl WHERE   tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Bon' AND satuan = 'Curah OPC Type 1'");
  $data22 = mysqli_fetch_array($table22);
  $penjualan_copct1_bon = $data22['penjualan_copct1_bon'];
  $uang_copct1_bon= $data22['uang_copct1_bon'];

  //Curah PCC bayar
  $table3 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_cpcc ,  SUM(jumlah) AS uang_cpcc  FROM penjualan_sl WHERE   tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Curah PCC' OR   tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Lunas Cash' AND satuan = 'Curah PCC'  ");
  $data3 = mysqli_fetch_array($table3);
  $penjualan_cpcc = $data3['penjualan_cpcc'];
  $uang_cpcc = $data3['uang_cpcc'];

  //Curah PCC Bon
  $table32 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_cpcc_bon ,  SUM(jumlah) AS uang_cpcc_bon  FROM penjualan_sl WHERE   tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Bon' AND satuan = 'Curah PCC'");
  ...
  $table4 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_bopct1 ,  SUM(jumlah) AS uang_bopct1  FROM penjualan_sl WHERE   tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Big Bag OPC Type 1' OR   tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Lunas Cash' AND satuan = 'Big Bag OPC Type 1'  ");
  $data4 = mysqli_fetch_array($table4);
  $penjualan_bopct1 = $data4['penjualan_bopct1'];
  $uang_bopct1 = $data4['uang_bopct1'];

  //Big Bag OPC Type 1 Bon
  $table42 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_bopct1_bon ,  SUM(jumlah) AS uang_bopct1_bon  FROM penjualan_sl WHERE   tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Bon' AND satuan = 'Big Bag OPC Type 1'");
  $data42 = mysqli_fetch_array($table42);
  $penjualan_bopct1_bon = $data42['penjualan_bopct1_bon'];
  $uang_bopct1_bon= $data42['uang_bopct1_bon'];

  //Big Bag PCC bayar
  $table5 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_bpcc ,  SUM(jumlah) AS uang_bpcc  FROM penjualan_sl WHERE   tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Big Bag PCC' OR   tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Lunas Cash' AND satuan = 'Big Bag PCC'  ");
  $data5 = mysqli_fetch_array($table5);
  $penjualan_bpcc = $data5['penjualan_bpcc'];
  $uang_bpcc = $data5['uang_bpcc'];

  //Big Bag PCC Bon
  $table52 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_bpcc_bon ,  SUM(jumlah) AS uang_bpcc_bon  FROM penjualan_sl WHERE  tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Bon' AND satuan = 'Big Bag PCC'");
  ...
  //Sak PCC 50 Kg bayar
  $table6 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_sakpcc ,  SUM(jumlah) AS uang_sakpcc  FROM penjualan_sl WHERE   tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Lunas Transfer' AND satuan = 'Sak PCC 50 Kg' OR   tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Lunas Cash' AND satuan = 'Sak PCC 50 Kg'  ");
  $data6 = mysqli_fetch_array($table6);
  $penjualan_sakpcc = $data6['penjualan_sakpcc'];
  $uang_sakpcc = $data6['uang_sakpcc'];

  //Sak PCC 50 Kg Bon
  $table62 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_sakpcc_bon ,  SUM(jumlah) AS uang_sakpcc_bon  FROM penjualan_sl WHERE   tanggal_kirim ='$tanggal_awal' AND status_bayar = 'Bon' AND satuan = 'Sak PCC 50 Kg'");
  ...
  $table = mysqli_query($koneksipbr,"SELECT * FROM penjualan_sl WHERE tanggal_kirim BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  ORDER BY tanggal_kirim ASC");

  //Curah OPC Type 1 bayar
  $table2 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_copct1 ,  SUM(jumlah) AS uang_copct1  FROM penjualan_sl WHERE  tanggal_kirim BETWEEN 
  ...
  //Curah OPC Type 1 Bon
  $table22 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_copct1_bon ,  SUM(jumlah) AS uang_copct1_bon  FROM penjualan_sl WHERE  tanggal_kirim BETWEEN 
  ...
  //Curah PCC bayar
  $table3 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_cpcc ,  SUM(jumlah) AS uang_cpcc  FROM penjualan_sl WHERE  tanggal_kirim BETWEEN 
  ...
  //Curah PCC Bon
  $table32 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_cpcc_bon ,  SUM(jumlah) AS uang_cpcc_bon  FROM penjualan_sl WHERE  tanggal_kirim BETWEEN 
  ...
  //Big Bag OPC Type 1 bayar
  $table4 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_bopct1 ,  SUM(jumlah) AS uang_bopct1  FROM penjualan_sl WHERE  tanggal_kirim BETWEEN 
  ...
  //Big Bag OPC Type 1 Bon
  $table42 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_bopct1_bon ,  SUM(jumlah) AS uang_bopct1_bon  FROM penjualan_sl WHERE  tanggal_kirim BETWEEN 
  ...
  //Big Bag PCC bayar
  $table5 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_bpcc ,  SUM(jumlah) AS uang_bpcc  FROM penjualan_sl WHERE  tanggal_kirim BETWEEN 
  ...
  //Big Bag PCC Bon
  $table52 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_bpcc_bon ,  SUM(jumlah) AS uang_bpcc_bon  FROM penjualan_sl WHERE  tanggal_kirim BETWEEN 
  ...
  //Sak PCC 50 Kg bayar
  $table6 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_sakpcc ,  SUM(jumlah) AS uang_sakpcc  FROM penjualan_sl WHERE  tanggal_kirim BETWEEN 
  ...
  //Sak PCC 50 Kg Bon
  $table62 = mysqli_query($koneksipbr, "SELECT SUM(qty) AS penjualan_sakpcc_bon ,  SUM(jumlah) AS uang_sakpcc_bon  FROM penjualan_sl WHERE  tanggal_kirim BETWEEN 
