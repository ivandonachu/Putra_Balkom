...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksipbj, "SELECT * FROM keuangan_s WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Ongkos Kuli' ");
  $table2 = mysqli_query($koneksipbj, "SELECT SUM(jumlah) AS total_pengeluaran  FROM keuangan_s WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Ongkos Kuli' ");
  $data2 = mysqli_fetch_array($table2);
  $total_pengeluaran = $data2['total_pengeluaran'];

  $tablex = mysqli_query($koneksipbj, "SELECT * FROM keuangan_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Ongkos Kuli' ");
  $table2x = mysqli_query($koneksipbj, "SELECT SUM(jumlah) AS total_pengeluaran  FROM keuangan_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Ongkos Kuli' ");
...
<h3 align='center' >Ongkos Kuli Region 1</h3>
<!-- Tabel -->    
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            Total Ongkos Kuli Region 1</div>
...
<h3 align='center' >Ongkos Kuli Region 2</h3>
<!-- Tabel -->    
<div style="overflow-x: auto" align = 'center' >
    ...
    <div class="card border-left-success shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
            Total Ongkos Kuli Region 2</div>
