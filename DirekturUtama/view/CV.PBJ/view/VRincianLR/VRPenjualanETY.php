...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksipbj,"SELECT * FROM penjualan_s WHERE tanggal_do = '$tanggal_awal'  AND status_bayar = 'Lunas Transfer' OR tanggal_do = '$tanggal_awal'  AND status_bayar = 'Lunas Cash' ");
  ...
  $table = mysqli_query($koneksipbj,"SELECT * FROM penjualan_s WHERE tanggal_do BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  AND status_bayar = 'Lunas Transfer' OR tanggal_do BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  AND status_bayar = 'Lunas Cash' ORDER BY tanggal_do ASC");
