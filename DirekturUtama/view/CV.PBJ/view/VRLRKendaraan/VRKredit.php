...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksipbj, "SELECT * FROM kredit_kendaraan WHERE tanggal = '$tanggal_awal' ");

}
else{

  $table = mysqli_query($koneksipbj, "SELECT * FROM kredit_kendaraan  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ");
