...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksipbj, "SELECT * FROM pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND tipe_semen = 'Pranko' AND plant = '79A1' OR  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND tipe_semen = 'FRC' AND plant = '79A1' ");
}
            ...
            <div id="content">
                ...
                <div>
                    ...
                    <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                        ...
                        <h5 align='center'>Rekap Tagihan SKB </h5>
                        <!-- Tabel -->
