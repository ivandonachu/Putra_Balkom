            ...
            <div id="content">
                ...
                <div>
                    ...
                    <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                        ...
                        <h5 align='center'>Rekap Ongkos BMU Samsul</h5>
                        <!-- Tabel -->
                        ...
                        <h5 align='center'>Rekap Ongkos BMU Samsul Kota Bumi</h5>
                        <!-- Tabel -->
                        <div align='center' style="overflow-x: auto">
                            <table id="example2" class="table-sm table-striped table-bordered  nowrap" style="width:auto">
                                ...
                                <tbody>
                                    ...
                                    <?php while ($data = mysqli_fetch_array($tabel_kotabumi2)) {
                                        ...
                                        if ($status_kendaraan == 'Samsul' && $kontrak = 'BMU') {
                                            $jumlah = $qty * $tarifx;
                                            $total = $total + $jumlah;
                        ...
                        <h5 align='center'>Rekap Ongkos BMU Samsul Lamteng</h5>
                        <!-- Tabel -->
                        <div align='center' style="overflow-x: auto">
