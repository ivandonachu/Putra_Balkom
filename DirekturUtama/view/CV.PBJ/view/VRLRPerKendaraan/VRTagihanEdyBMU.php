...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $tabel_kotabumi = mysqli_query($koneksipbj, "SELECT * FROM pembelian_kota_bumi WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND no_polisi = '$no_polisi_ts' ");
            ...
            <div id="content">
                ...
                <div>
                    ...
                    <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                        ...
                        <div align="left">
                            <?php echo "<a href='../VLRPerKendaraan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisi_ts'><button type='button' class='btn btn-primary'>Kembali</button></a>"; ?>
                        </div>
                        ...
                        <h5 align='center'>Rekap Pranko BMU <?=$no_polisi_ts;?> </h5>
                        <!-- Tabel -->
                        ...
                        <h5 align='center'>Rekap Pranko BMU Kota Bumi <?=$no_polisi_ts;?> </h5>
                        <!-- Tabel -->
                        <div align='center' style="overflow-x: auto">
                            <table id="example2" class="table-sm table-striped table-bordered  nowrap" style="width:auto">
                                ...
                                <tbody>
                                    ...
                                    $total_pembelian = 0;
                                    $total = 0;
                                    $tabel_kotabumi2 = mysqli_query($koneksipbj, "SELECT * FROM pembelian_kota_bumi WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND no_polisi = '$no_polisi_ts' ");
                                    ?>
                                    ...
                                    <?php while ($data = mysqli_fetch_array($tabel_kotabumi2)) {
                                        ...
                                        if ($status_kendaraan == 'Bapak Nyoman Edi' && $kontrak = 'BMU') {
                                            $jumlah = $qty * $tarifx;
                                            $total = $total + $jumlah;
                        ...
                        <h5 align='center'>Rekap Pranko BMU Lamteng <?=$no_polisi_ts;?> </h5>
                        <!-- Tabel -->
                        <div align='center' style="overflow-x: auto">
                            <table id="example3" class="table-sm table-striped table-bordered  nowrap" style="width:auto">
                                ...
                                <tbody>
                                    ...
                                    $total_pembelian = 0;
                                    $total = 0;
                                    $tabel_lamteng2 = mysqli_query($koneksipbj, "SELECT * FROM pembelian_lamteng WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND no_polisi = '$no_polisi_ts' ");
                                    ?>
