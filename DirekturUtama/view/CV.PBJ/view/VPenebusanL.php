...
<h3 class="text-center" >Do Pembelian belum Tercatat tetapi DO Penjualan (Etty) Sudah Tercatat</h3>
<table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  ...
  <tbody>
    ...
    $qty = $data['qty'];
      ...
      $tablexj = mysqli_query($koneksipbj, "SELECT no_do FROM pembelian_s WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND no_do = '$no_do_pembelian'");
