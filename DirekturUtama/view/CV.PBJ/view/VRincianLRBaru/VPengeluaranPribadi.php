...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksipbj, "SELECT * FROM keuangan_sL WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Pengeluaran Pribadi' ");
}
else{

  $table = mysqli_query($koneksipbj, "SELECT * FROM keuangan_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Pengeluaran Pribadi' ");
  $table2 = mysqli_query($koneksipbj, "SELECT SUM(jumlah) AS total_pengeluaran  FROM keuangan_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Pengeluaran Pribadi' ");
...
<h3 align='center' >Pengeluaran Pribadi</h3>
<!-- Tabel -->    
