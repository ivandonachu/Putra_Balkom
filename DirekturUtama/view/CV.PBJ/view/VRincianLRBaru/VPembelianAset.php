...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksipbj, "SELECT * FROM keuangan_sL WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Pembelian Aset' ");
}
else{
...
<h3 align='center' >Pembelian Aset</h3>
<!-- Tabel -->    
