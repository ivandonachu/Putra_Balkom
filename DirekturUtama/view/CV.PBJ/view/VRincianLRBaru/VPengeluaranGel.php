...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksipbj, "SELECT * FROM keuangan_sL WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Pengeluaran PT Gel Gel' ");
}
else{

  $table = mysqli_query($koneksipbj, "SELECT * FROM keuangan_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Pengeluaran PT Gel Gel' ");
  $table2 = mysqli_query($koneksipbj, "SELECT SUM(jumlah) AS total_pengeluaran  FROM keuangan_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Pengeluaran PT Gel Gel' ");
...
<head>
  ...
  <title>Pengeluaran PT Gel Gel</title>
...
<h3 align='center' >Pengeluaran PT Gel Gel</h3>
<!-- Tabel -->    
