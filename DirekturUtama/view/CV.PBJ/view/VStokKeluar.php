...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksipbj, "SELECT * FROM laporan_stok_keluar_gudang  WHERE tanggal ='$tanggal_awal' AND kode_gudang = '$kode_gudang' ");
} else {
    $table = mysqli_query($koneksipbj, "SELECT * FROM laporan_stok_keluar_gudang WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kode_gudang = '$kode_gudang'  ");
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                    <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Laporan Stok Keluar Gudang $kode_gudang </h5></a>"; ?>
