...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  //PANJANG
  $table = mysqli_query($koneksipbj,"SELECT no_polisi, count(*) AS total_rit FROM  pembelian_sl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'KAB. LAMPUNG TIMUR' AND plant = '79H9' OR  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kota = 'KAB.LAMPUNG TIMUR' AND plant = '79H9' GROUP BY no_polisi  "); 
...
<h5 align="center" >Rincian RIT Driver Lamtim Panjang</h5>
<!-- Tabel -->    
