            ...
            <div id="content">
                ...
                <div>
                    ...
                    <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                        <?php echo "<form  method='POST' action='VRekapSparepart' style='margin-bottom: 15px;'>" ?>
                        <div>
                            ...
                            <table id="example" class="table-sm table-striped table-bordered  nowrap" style="width:auto">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>No Polisi</th>
                                        <th>Total Pembelian Sparepatt</th>
                                        <th>Total Perbaikan</th>
                                        <th>Total Perbaikan + Sparepart</th>
                                        <th>Total Pendapat Kendaraan</th>
                                        <th>Total Sisa Pendapatan</th>
                                ...
                                <tbody>
                                    ...
                                    <?php while ($data = mysqli_fetch_array($table)) {
                                        ...
                                        $total_pembelian_sparepart = $data['total_pembelian_sparepart'];
                                        $total_perbaikan = $data['total_perbaikan'];
                                        $jumlah_pengeluaran = $total_pembelian_sparepart + $total_perbaikan;

                                        //pengiriman 1
                                        $table_om_1 = mysqli_query($koneksipbj, "SELECT SUM(om) AS total_om_1 FROM pengiriman_s WHERE tanggal_antar  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND no_polisi = '$no_polisi' ");
                                        $data_om_1 = mysqli_fetch_array($table_om_1);
                                        $total_om_1 = $data_om_1['total_om_1'];


                                        //pengiriman 1
                                        $table_om_2 = mysqli_query($koneksipbj, "SELECT SUM(om) AS total_om_2 FROM pengiriman_sl WHERE tanggal_antar  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND no_polisi = '$no_polisi' ");
                                        $data_om_2 = mysqli_fetch_array($table_om_2);
                                        $total_om_2 = $data_om_2['total_om_2'];

                                        $total_pendapatan = $total_om_1 + $total_om_2;


                                        $total_sisa_pendapatan = $total_pendapatan - $jumlah_pengeluaran;
                                        ...
                                        echo "<tr>
                                            ...
                                            <td style='font-size: 14px'>" ?> <?= formatuang($total_pembelian_sparepart); ?> <?php echo "</td>
                                            <td style='font-size: 14px'>" ?> <?= formatuang($total_perbaikan); ?> <?php echo "</td>
