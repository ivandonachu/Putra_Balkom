...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksistre, "SELECT * FROM pengeluaran_pul WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Transport / Perjalanan Dinas' ");
}
else{
  $table = mysqli_query($koneksistre, "SELECT * FROM pengeluaran_pul WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Transport / Perjalanan Dinas'");
}
