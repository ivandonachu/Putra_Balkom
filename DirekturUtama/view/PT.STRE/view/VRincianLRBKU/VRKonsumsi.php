...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksistre, "SELECT * FROM pengeluaran_pul WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Biaya Konsumsi' ");
}
else{
  $table = mysqli_query($koneksistre, "SELECT * FROM pengeluaran_pul WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Konsumsi'");
}
...
<head>
  ...
  <title>Biaya Konsumsi Bengkulu</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VRKonsumsi?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Biaya Konsumsi Bengkulu</h5></a>"; ?>
