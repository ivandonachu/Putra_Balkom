...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksistre,"SELECT * FROM kredit_kendaraan  WHERE tanggal ='$tanggal_awal' ");

}

else{
  $table = mysqli_query($koneksistre,"SELECT * FROM kredit_kendaraan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ");
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VPengiriman'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Bayar Kredit</h5></a>"; ?>
...
<div>   
 ...
 <div style="margin-right: 100px; margin-left: 100px;">
  ...
  <?php  echo "<form  method='POST' action='VBayarKredit'>" ?>
  <div>
