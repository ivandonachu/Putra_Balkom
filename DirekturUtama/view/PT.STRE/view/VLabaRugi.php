  ...
  //pengeluran Pul Biaya Kantor
   ...
   $jml_perbaikan = $data7['jumlah_perbaikan'];
    ...
    $jml_perbaikan = 0;
     ...
     //Gaji karyawan
   $table8 = mysqli_query($koneksistre, "SELECT SUM(jumlah) AS jumlah_gaji FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'BALSRI LMG' ");
   ...
   $gaji_karyawan = $data8['jumlah_gaji'];
    ...
    //Gaji dRIVER
   $table9 = mysqli_query($koneksistre, "SELECT SUM(jumlah) AS jumlah_gaji FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'Driver LMG' ");
