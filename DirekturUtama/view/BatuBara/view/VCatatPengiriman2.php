...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table4 = mysqli_query($koneksipbj, "SELECT b.nama_driver, SUM(gaji_tagihan) AS total_gaji FROM riwayat_pengiriman a INNER JOIN driver b ON a.no_driver=b.no_driver WHERE tanggal = '$tanggal_awal' GROUP BY b.nama_driver "); 
  ...
  $table3 = mysqli_query($koneksipbj, "SELECT b.no_polisi, SUM(rit) AS total_rit  FROM riwayat_pengiriman a INNER JOIN kendaraan b ON a.no_kendaraan=b.no_kendaraan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY b.no_polisi ");
