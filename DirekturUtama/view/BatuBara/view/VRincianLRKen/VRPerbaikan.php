...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksipbj, "SELECT * FROM riwayat_perbaikan a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun INNER JOIN driver c ON c.no_driver=a.no_driver INNER JOIN kendaraan d ON  d.no_kendaraan=a.no_kendaraan  WHERE tanggal = '$tanggal_awal' AND a.kode_akun = '5-595' AND d.no_polisi = '$no_polisi' ");

}
else{

  $table = mysqli_query($koneksipbj, "SELECT * FROM riwayat_perbaikan a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun INNER JOIN driver c ON c.no_driver=a.no_driver INNER JOIN kendaraan d ON  d.no_kendaraan=a.no_kendaraan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND a.kode_akun = '5-595' AND d.no_polisi = '$no_polisi'");
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VRPembelian?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Perbaikan Kendaraan $no_polisi</h5></a>"; ?>
