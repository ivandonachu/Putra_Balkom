...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksipbj, "SELECT * FROM riwayat_oprasional a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND a.kode_akun = '5-530'");
}
