...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table4 = mysqli_query($koneksipbj, "SELECT b.nama_driver, SUM(uj_tagihan) AS total_gaji FROM riwayat_pengiriman a INNER JOIN driver b ON a.no_driver=b.no_driver WHERE tanggal_keluar = '$tanggal_awal' GROUP BY b.nama_driver "); 

}
else{

 
   $table4 = mysqli_query($koneksipbj, "SELECT b.nama_driver, SUM(uj_tagihan) AS total_gaji FROM riwayat_pengiriman a INNER JOIN driver b ON a.no_driver=b.no_driver WHERE tanggal_keluar BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY b.nama_driver "); 
...
<head>
  ...
  <title>Rincian Uang Jalan</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VRGaji?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Rincian Uasng Jalan</h5></a>"; ?>
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table4)){
      ...
      <td style='font-size: 14px' align = 'center'>$nama_driver</td>
       ...
       <td  align = 'center'><a href='VRincianUJ?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&nama_driver=$nama_driver'>Rincian</a></td>
      </tr>";
}
?>
