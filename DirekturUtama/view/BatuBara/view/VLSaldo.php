...
if ($tanggal_awal == $tanggal_akhir) {
 $table = mysqli_query($koneksipbj, "SELECT * FROM riwayat_pencatatan_saldo WHERE tanggal = '$tanggal_awal'");

}
else{
  $table = mysqli_query($koneksipbj, "SELECT * FROM riwayat_pencatatan_saldo WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
}
            ...
            <li class="nav-item active" >
                ...
                <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" style="font-size: 15px;" href="/DirekturUtama/view/PERTASHOP/view/DsPertashop">Kebun</a>
