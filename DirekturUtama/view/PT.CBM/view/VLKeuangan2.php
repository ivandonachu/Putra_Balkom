...
// TOTAL P[ENDAPATAN
$table = mysqli_query($koneksicbm, "SELECT SUM(jumlah) AS total_pendapatan FROM riwayat_penjualan WHERE tanggal = '$tanggal_awal' AND pembayaran = 'Cash' OR tanggal = '$tanggal_awal' AND pembayaran ='Deposit' ");
...
$table2 = mysqli_query($koneksicbm, "SELECT SUM(jumlah_pengeluaran) AS total_pengeluaran FROM riwayat_pengeluaran WHERE tanggal = '$tanggal_awal' AND kode_akun != '5-580' ");
...
// TOTAL P[ENDAPATAN
$table = mysqli_query($koneksicbm, "SELECT SUM(jumlah) AS total_pendapatan FROM riwayat_penjualan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND pembayaran = 'Cash' OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND pembayaran ='Deposit' ");
$data_pendapatan = mysqli_fetch_array($table);
$data_total_pendapatan = $data_pendapatan['total_pendapatan'];
if (!isset($data_total_pendapatan)) {
    $data_total_pendapatan = 0;
}
$table4 = mysqli_query($koneksicbm, "SELECT SUM(jumlah_bayar_x) AS total_piutang FROM riwayat_pembayaran_piutang a INNER JOIN piutang_penjualan b ON b.no_piutang=a.no_piutang WHERE a.tanggal_bayar_x BETWEEN '$tanggal_awal' AND '$tanggal_akhir'   ");
$data_piutang = mysqli_fetch_array($table4);
$data_total_piutang= $data_piutang['total_piutang'];
if (!isset($data_total_piutang)) {
    $data_total_piutang = 0;
...
$table2 = mysqli_query($koneksicbm, "SELECT SUM(jumlah_pengeluaran) AS total_pengeluaran FROM riwayat_pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND kode_akun != '5-580' ");
$data_pengeluaran = mysqli_fetch_array($table2);
$data_total_pengeluaran = $data_pengeluaran['total_pengeluaran'];
if (!isset($data_total_pengeluaran)) {
    $data_total_pengeluaran = 0;
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               ...
               <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                        <?php echo "<a href='VLKeuangan2'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Laporan Keuangan</h5></a>"; ?>
