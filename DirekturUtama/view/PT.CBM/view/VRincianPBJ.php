...
if ($tanggal_awal == $tanggal_akhir) {
  $table  = mysqli_query($koneksicbm, "SELECT * FROM riwayat_saldo_armada WHERE tanggal = '$tanggal_awal' AND status_saldo = 'Masuk' AND nama_rekening = 'PBJ' AND referensi = 'CBM' 
                                                                         OR tanggal = '$tanggal_awal' AND status_saldo = 'Masuk' AND nama_rekening = 'PBJ' AND referensi = 'PBJ' 
                                                                         ...
                                                                         OR tanggal = '$tanggal_awal' AND status_saldo = 'Keluar' AND nama_rekening = 'PBJ' AND referensi = 'PBJ'
                                                                         OR tanggal = '$tanggal_awal' AND status_saldo = 'Keluar' AND nama_rekening = 'PBJ' AND referensi = 'BALSRI'
                                                                         OR tanggal = '$tanggal_awal' AND status_saldo = 'Keluar' AND nama_rekening = 'PBJ' AND referensi = 'Kebun Lengkiti'
                                                                         OR tanggal = '$tanggal_awal' AND status_saldo = 'Keluar' AND nama_rekening = 'PBJ' AND referensi = 'MES/PBR'
                                                                        
                                                                           ");
  
}
else{
$table = mysqli_query($koneksicbm, "SELECT * FROM riwayat_saldo_armada  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Masuk' AND nama_rekening = 'PBJ' AND referensi ='CBM' 
                                                                     OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Masuk' AND nama_rekening = 'PBJ' AND referensi = 'PBJ' 
                                                                     ...
                                                                     OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Keluar' AND nama_rekening = 'PBJ' AND referensi =  'PBJ' 
                                                                     OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Keluar' AND nama_rekening = 'PBJ' AND referensi =  'BALSRI'
                                                                     OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Keluar' AND nama_rekening = 'PBJ' AND referensi =  'Kebun Lengkiti'
                                                                     OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Keluar' AND nama_rekening = 'PBJ' AND referensi =  'MES/PBR' 
                                                                       ");
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                  <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                    <?php echo "<a href='VRincianPBJ'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Rincian Saldo PBJ</h5></a>"; ?>
...
<table  class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  ...
  <tbody>
    ...
    <?php 
      ...
      <td style='font-size: 14px'>";?> <?= formatuang($masuk_cbm_pbj + $masuk_mt_pbj + $keluar_pbj_balsri + $keluar_pbj_keling + $keluar_pbj_pbj + $keluar_pbj_pbr); ?> <?php echo "</td>
      <td style='font-size: 14px'>";?> <?= formatuang($setor_pbj_mt + $setor_pbj_cbm + $setor_pbj_pbj); ?> <?php echo "</td>
      <td style='font-size: 14px'>";?> <?= formatuang(($masuk_pbj_mt + $masuk_pbj_cbm + $masuk_pbj_pbj)-($setor_pbj_mt + $setor_pbj_cbm + $setor_pbj_pbj + $masuk_cbm_pbj + $masuk_mt_pbj + $keluar_pbj_balsri + $keluar_pbj_keling + $keluar_pbj_pbj + $keluar_pbj_pbr)); ?> <?php echo "</td>
