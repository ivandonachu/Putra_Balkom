...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksicbm, "SELECT * FROM laporan_stok_pesan_antar WHERE tanggal = '$tanggal_awal'");
} else {
    $table = mysqli_query($koneksicbm, "SELECT * FROM laporan_stok_pesan_antar WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY tanggal ASC");
}
            ...
            <div id="content">
                ...
                <div>
                    ...
                    <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                        ...
                        <?php echo "<form  method='POST' action='VLKeuanganPANPSO' style='margin-bottom: 15px;'>" ?>
                        <div>
