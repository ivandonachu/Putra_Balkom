...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksicbm, "SELECT * FROM rekap_gaji_pbr WHERE tanggal = '$tanggal_awal'");

} else {
  $table = mysqli_query($koneksicbm, "SELECT * FROM rekap_gaji_pbr WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
