...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksicbm, "SELECT * FROM mocash_cbm WHERE tanggal = '$tanggal_awal'");
  $table2 = mysqli_query($koneksicbm, "SELECT nama_akun, akun_mocash,  SUM(jumlah) AS total_jumlah FROM mocash_cbm  WHERE tanggal = '$tanggal_awal' GROUP BY akun_mocash");

}
else{

  $table = mysqli_query($koneksicbm, "SELECT * FROM mocash_cbm WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $table2 = mysqli_query($koneksicbm, "SELECT nama_akun, akun_mocash,  SUM(jumlah) AS total_jumlah FROM mocash_cbm  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY akun_mocash");
