...
//GUDANG
//patokan stok awal
$table35 = mysqli_query($koneksicbm, "SELECT no_laporan FROM laporan_inventory WHERE referensi = 'GD'  AND tanggal = '$tanggal_awal' ");
$data35 = mysqli_fetch_array($table35);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               ...
               <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                        <?php echo "<a href='VLPenjualan2'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Laporan Penjualan</h5></a>"; ?>
