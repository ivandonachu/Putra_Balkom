...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksicbm, "SELECT * FROM monitoring_rek_cashless_cbm WHERE tanggal = '$tanggal_awal'");
    $table2 = mysqli_query($koneksicbm, "SELECT nama_akun, rekening,  SUM(jumlah) AS total_jumlah FROM monitoring_rek_cashless_cbm  WHERE tanggal = '$tanggal_awal' GROUP BY nama_akun");
} else {

    $table = mysqli_query($koneksicbm, "SELECT * FROM monitoring_rek_cashless_cbm WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
    $table2 = mysqli_query($koneksicbm, "SELECT nama_akun, rekening,  SUM(jumlah) AS total_jumlah FROM monitoring_rek_cashless_cbm  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_akun");
}
...
<head>
    ...
    <title>Monitoring Rekening Cashless</title>
                                ...
                                <tbody>
                                    ...
                                    <?php while ($data = mysqli_fetch_array($table)) {
                                        ...
                                        if ($nama_akun == 'Saldo Awal' || $nama_akun == 'Pembayaran Pangkalan') {
                                            ...
                                            <td style='font-size: 14px'>"; ?> <a download="/PT.CBM/Admin/file_admin/<?= $file_bukti ?>" href="/PT.CBM/Admin/file_admin/<?= $file_bukti ?>"> <?php echo "$file_bukti </a> </td> </tr>";
                                    }
                                        ?>
