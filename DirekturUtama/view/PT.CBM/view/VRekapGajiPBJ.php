...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksicbm, "SELECT * FROM rekap_gaji_pbj WHERE tanggal = '$tanggal_awal'");

} else {
  $table = mysqli_query($koneksicbm, "SELECT * FROM rekap_gaji_pbj WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
...
<div>   
  ...
  <?php echo "<form  method='POST' action='VRekapGajiPVJ' style='margin-bottom: 15px;'>" ?>
            <div>
