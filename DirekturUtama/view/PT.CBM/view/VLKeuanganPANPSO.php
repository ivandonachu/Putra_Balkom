...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksicbm, "SELECT * FROM keuangan_pesan_antar_non_pso WHERE tanggal = '$tanggal_awal'");
} else {
  $table = mysqli_query($koneksicbm, "SELECT * FROM keuangan_pesan_antar_non_pso WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY tanggal ASC");
  $table2 = mysqli_query($koneksicbm, "SELECT nama_akun, SUM(jumlah) AS total_jumlah  FROM keuangan_pesan_antar_non_pso  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_akun");
}
...
<head>
  ...
  <title>Keuangan Pesan Antar Non PSO</title>
