...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksicbm, "SELECT * FROM riwayat_saldo_armada WHERE referensi = 'PBJ' AND nama_rekening = 'CBM' AND tanggal = '$tanggal_awal' ");

  $table2 = mysqli_query($koneksicbm, "SELECT * FROM riwayat_saldo_armada  WHERE referensi = 'CBM' AND nama_rekening = 'CBM' AND nama_akun ='Transfer Ke Bos' AND  tanggal = '$tanggal_awal' ");

  $table3 = mysqli_query($koneksicbm, "SELECT SUM(jumlah) AS total_pbj_keluar FROM  riwayat_saldo_armada WHERE referensi = 'PBJ' AND nama_rekening = 'CBM' AND tanggal = '$tanggal_awal' ");
  ...
  $table4 = mysqli_query($koneksicbm, "SELECT SUM(jumlah) AS total_cbm_keluar FROM riwayat_saldo_armada  WHERE referensi = 'CBM' AND nama_rekening = 'CBM' AND nama_akun ='Transfer Ke Bos' AND  tanggal = '$tanggal_awal' ");
  ...
  $table = mysqli_query($koneksicbm, "SELECT * FROM riwayat_saldo_armada  WHERE referensi = 'PBJ' AND nama_rekening = 'CBM' AND tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  ");
  $table2 =  mysqli_query($koneksicbm, "SELECT * FROM riwayat_saldo_armada  WHERE referensi = 'CBM' AND nama_rekening = 'CBM' AND nama_akun ='Transfer Ke Bos' AND tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  ");
  $table3 = mysqli_query($koneksicbm, "SELECT SUM(jumlah) AS total_pbj_keluar FROM  riwayat_saldo_armada WHERE referensi = 'PBJ' AND nama_rekening = 'CBM' AND tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  ");
  $data_pbj = mysqli_fetch_array($table3);
  $total_pbj_keluar = $data_pbj['total_pbj_keluar'];
  if (!isset($data_pbj['total_pbj_keluar'])) {
    $total_pbj_keluar = 0;
  ...
  $table4 = mysqli_query($koneksicbm, "SELECT SUM(jumlah) AS total_cbm_keluar FROM riwayat_saldo_armada  WHERE referensi = 'CBM' AND nama_rekening = 'CBM' AND nama_akun ='Transfer Ke Bos' AND tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ");
  $data_cbm = mysqli_fetch_array($table4);
  $total_pbj_ganti = $data_cbm['total_cbm_keluar'];
  if (!isset($data_cbm['total_cbm_keluar'])) {
    $total_pbj_ganti = 0;
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
          <?php echo "<a href='VUangPBJ'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Rincian Saldo PBJ</h5></a>"; ?>
