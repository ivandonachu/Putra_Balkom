...
if (isset($_GET['tanggal1'])) {
  ...
  if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksicbm, "SELECT * FROM rekap_gaji_driver_pbr WHERE tanggal = '$tanggal_awal'");
  
  } else {
    $table = mysqli_query($koneksicbm, "SELECT * FROM rekap_gaji_driver_pbr WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
