...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksicbm, "SELECT * FROM rekap_gaji_mes WHERE tanggal = '$tanggal_awal'");

} else {
  $table = mysqli_query($koneksicbm, "SELECT * FROM rekap_gaji_mes WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
...
?>
 ...
 <head>
  ...
  <title>Rekap Gaji Karyawan MES</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VRekapGajiMES'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Rekap Gaji Karyawan MES</h5></a>"; ?>
...
<div>   
  ...
  <?php echo "<form  method='POST' action='VRekapGajiMES' style='margin-bottom: 15px;'>" ?>
            <div>
  ...
  <div class="row">
    ...
    <div class="col-md-2">
      ...
      <div align="right">
      <?php echo "<a href='VPrintSlipGajiMES?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' target='_blank'><button style='color:black;
       ...
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/hapus_seluruh_rekap_gaji_mes?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
      ...
      <div class="modal fade bd-example-modal-lg" id="input" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <!-- Form Input Data -->
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/proses_tambah_rekap_gaji_mes?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
      ...
      ?>
        ...
        <?php while($data2 = mysqli_fetch_array($table)){
          ...
          <div class="modal-body">
              <?php  echo "<form action='../proses/edit_rekap_gaji_mes?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
 ...
 <div class="modal-dialog" role ="document">
   <div class="modal-content"> 
    ...
    <div class="modal-body">
      ...
      <?php  echo "<form action='../proses/hapus_rekap_gaji_mes?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' method='POST'>";  ?>
        <input type="hidden" name="no_riwayat" value="<?php echo $no_riwayat;?>">
