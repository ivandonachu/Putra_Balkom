...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksicbm, "SELECT * FROM surat_keluar_masuk WHERE tanggal = '$tanggal_awal' ORDER BY tanggal ASC");
} else {
  $table = mysqli_query($koneksicbm, "SELECT * FROM surat_keluar_masuk WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY tanggal ASC");
}
