...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksicbm, "SELECT * FROM setoran_pso WHERE tanggal = '$tanggal_awal'");
} else {
  $table = mysqli_query($koneksicbm, "SELECT * FROM setoran_pso WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY tanggal ASC");
}
...
<head>
  ...
  <title>Setoran Pesan Antar Non PSO</title>
      ...
      <div id="content">
        ...
        <div>
          ...
          <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
            ...
            <?php echo "<form  method='POST' action='VSetoranPANPSO' style='margin-bottom: 15px;'>" ?>
            <div>
