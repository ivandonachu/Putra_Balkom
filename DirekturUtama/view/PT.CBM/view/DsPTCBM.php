...
//patokan stok awal
$table3 = mysqli_query($koneksicbm, "SELECT MAX(no_laporan) FROM laporan_inventory WHERE referensi = 'TK' ");
...
//3KG isi keluar
//baja isi LPG 3kg
$table111 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_3_tk FROM riwayat_penjualan WHERE tanggal = '$tanggal' AND kode_baja = 'L03K01' AND referensi = 'TK' ");
...
//3KG isi Masuk
//baja isi LPG 3kg
$table222 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_3_tk FROM riwayat_pembelian WHERE tanggal = '$tanggal' AND kode_baja = 'L03K01' AND referensi = 'TK' ");
...
//konfirmasi retur
$tabel1 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_3_tk FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'L03K11' AND referensi = 'TK' ");
...
$tabel2 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_3_tk FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'L03K11' AND lokasi_awal = 'Gudang' ");
...
$tabel3 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_3_tkx FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'L03K11' AND lokasi_awal = 'Toko'  ");
...
$table6 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_3ksg_tk FROM riwayat_penjualan WHERE tanggal = '$tanggal' AND kode_baja = 'L03K10' AND referensi = 'TK' ");
...
$table7 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_3ksg_tk FROM riwayat_pembelian WHERE tanggal = '$tanggal' AND kode_baja = 'L03K10' AND referensi = 'TK' ");
...
//konfirmasi retur
$tabel4 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_3ksg_tk FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'L03K10' AND referensi = 'TK' ");
...
//Perpindahan baja masuk
$tabel5 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_3ksg_tk FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'L03K10' AND lokasi_awal = 'Gudang' ");
...
//Perpindahan baja Keluar
$tabel6 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_3ksg_tkx FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'L03K10' AND lokasi_awal = 'Toko'  ");
...
$table10 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'L03K10'");
...
//3KG RETUR 
//Perpindahan baja masuk
$tabelr1 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_3rt_tk FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'L03K00' AND lokasi_awal = 'Gudang' ");
...
//Perpindahan baja Keluar
$tabelr2 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_3rt_tkx FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'L03K00' AND lokasi_awal = 'Toko'  ");
...
$tab2 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'L03K00'");
...
$table11 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_12_tk FROM riwayat_penjualan WHERE tanggal = '$tanggal' AND kode_baja = 'L12K01' AND referensi = 'TK' ");
...
$table12 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_12_tk FROM riwayat_pembelian WHERE tanggal = '$tanggal'  AND kode_baja = 'L12K01' AND referensi = 'TK' ");
...
//konfirmasi retur
$tabel7 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_12_tk FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'L12K11' AND referensi = 'TK' ");
...
if (!isset($data_retur_12_tk['retur_12_tk'])) {
    $total_retur_12_tk = 0;}
//Perpindahan baja masuk
$tabel8 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_12_tk FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'L12K11' AND lokasi_awal = 'Gudang' ");
...
//Perpindahan baja Keluar
$tabel9 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_12_tkx FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'L12K11' AND lokasi_awal = 'Toko' ");
...
//stok akhir 12kg isi
$table14 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'L12K11'");
...
$table15 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_12ksg_tk FROM riwayat_penjualan WHERE tanggal = '$tanggal'  AND kode_baja = 'L12K10' AND referensi = 'TK' ");
...
$table16 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_12ksg_tk FROM riwayat_pembelian WHERE tanggal = '$tanggal'  AND kode_baja = 'L12K10' AND referensi = 'TK' ");
...
//konfirmasi retur
$tabel10 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_12ksg_tk FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'L12K10' AND referensi = 'TK' ");
...
//Perpindahan baja masuk
$tabel11 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_12ksg_tk FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'L12K10' AND lokasi_awal = 'Gudang' ");
...
//Perpindahan baja Keluar
$tabel12 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_12ksg_tkx FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'L12K10' AND lokasi_awal = 'Toko'  ");
...
$table18 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'L12K10'");
...
//12KG RETUR 
//Perpindahan baja masuk
$tabelr3 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_12rt_tk FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'L12K00' AND lokasi_awal = 'Gudang' ");
...
//Perpindahan baja Keluar
$tabelr4 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_12rt_tkx FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'L12K00' AND lokasi_awal = 'Toko'  ");
...
$tab4 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'L12K00'");
...
$table19 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_b05_tk FROM riwayat_penjualan WHERE tanggal = '$tanggal'  AND kode_baja = 'B05K01' AND referensi = 'TK' ");
...
$table20 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_b05_tk FROM riwayat_pembelian WHERE tanggal = '$tanggal' AND kode_baja = 'B05K01' AND referensi = 'TK' ");
...
//konfirmasi retur
$tabel13 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_b05_tk FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'B05K11' AND referensi = 'TK' ");
...
//Perpindahan baja masuk
$tabel14 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_b05_tk FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'B05K11' AND lokasi_awal = 'Gudang'");
...
//Perpindahan baja Keluar
$tabel15 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_b05_tkx FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'B05K11' AND lokasi_awal = 'Toko' ");
...
$table22 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'B05K11'");
...
$table23 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_b05ksg_tk FROM riwayat_penjualan WHERE tanggal = '$tanggal'  AND kode_baja = 'B05K10' AND referensi = 'TK' ");
...
$table24 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_b05ksg_tk FROM riwayat_pembelian WHERE tanggal = '$tanggal' AND kode_baja = 'B05K10' AND referensi = 'TK' ");
...
//konfirmasi retur
$tabel16 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_b05ksg_tk FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'B05K10' AND referensi = 'TK' ");
...
//Perpindahan baja masuk
$tabel17 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_b05ksg_tk FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'B05K10' AND lokasi_awal = 'Gudang'  ");
...
//Perpindahan baja Keluar
$tabel18 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_b05ksg_tkx FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'B05K10' AND lokasi_awal = 'Toko' ");
...
$table26 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'B05K10'");
...
//B05KG RETUR 
//Perpindahan baja masuk
$tabelr5 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_b05rt_tk FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'B05K00' AND lokasi_awal = 'Gudang' ");
...
//Perpindahan baja Keluar
$tabelr6 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_b05rt_tkx FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'B05K00' AND lokasi_awal = 'Toko'  ");
...
$tab6 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'B05K00'");
...
$table27 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_b12_tk FROM riwayat_penjualan WHERE tanggal = '$tanggal' AND kode_baja = 'B12K01' AND referensi = 'TK' ");
...
$table28 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_b12_tk FROM riwayat_pembelian WHERE tanggal = '$tanggal'  AND kode_baja = 'B12K01' AND referensi = 'TK' ");
...
//konfirmasi retur
$tabel19 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_b12_tk FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'B12K11' AND referensi = 'TK' ");
...
//Perpindahan baja masuk
$tabel20 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_b12_tk FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'B12K11' AND lokasi_awal = 'Gudang' ");
...
//Perpindahan baja Keluar
$tabel21 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_b12_tkx FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'B12K11' AND lokasi_awal = 'Toko' ");
...
//stok akhir 12kg isi
$table30 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'B12K11'");
...
$table31 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_b12ksg_tk FROM riwayat_penjualan WHERE tanggal = '$tanggal' AND kode_baja = 'B12K10' AND referensi = 'TK' ");
...
$table32 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_b12ksg_tk FROM riwayat_pembelian WHERE tanggal = '$tanggal'  AND kode_baja = 'B12K10' AND referensi = 'TK' ");
...
//konfirmasi retur
$tabel22 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_b12ksg_tk FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'B12K10' AND referensi = 'TK' ");
...
//Perpindahan baja masuk
$tabel23 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_b12ksg_tk FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'B12K10' AND lokasi_awal = 'Gudang'  ");
...
//Perpindahan baja Keluar
$tabel24 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_b12ksg_tkx FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'B12K10' AND lokasi_awal = 'Toko' ");
...
//stok akhir 5,5kg kosong
$table34 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'B05K10'");
...
//B12KG RETUR 
//Perpindahan baja masuk
$tabelr7 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_b12rt_tk FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'B12K00' AND lokasi_awal = 'Gudang' ");
...
//Perpindahan baja Keluar
$tabelr8 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS perpindahan_b12rt_tkx FROM riwayat_perpindahan_baja WHERE tanggal = '$tanggal' AND kode_baja = 'B12K00' AND lokasi_awal = 'Toko'  ");
...
//stok akhir 5,5kg retur
$tab8 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'B12K00'");
...
//GUDANG
//patokan stok awal
$table35 = mysqli_query($koneksicbm, "SELECT MAX(no_laporan) FROM laporan_inventory WHERE referensi = 'GD' ");
...
//3KG isi keluar
//baja isi LPG 3kg
$table36 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_3_gd FROM riwayat_penjualan WHERE tanggal = '$tanggal'  AND kode_baja = 'L03K01' AND referensi = 'GD' ");
...
//3KG isi Masuk
//baja isi LPG 3kg
$table37 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_3_gd FROM riwayat_pembelian WHERE tanggal = '$tanggal' AND kode_baja = 'L03K01' AND referensi = 'CBM' ");
...
//konfirmasi retur
$tabelgd1 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_3_gd FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'L03K11' AND referensi = 'GD' ");
...
//Keberangkatan
$tabelgd2 = mysqli_query($koneksicbm, "SELECT SUM(L03K11) AS brangkat_3 FROM riwayat_keberangkatan WHERE tanggal = '$tanggal' ");
...
//stok akhir 3kg isi
$table39 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'L03K11'");
...
//3KG KOSONG TK
//baja kosong LPG 3kg Keluar
$table40 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_3ksg_gd FROM riwayat_penjualan WHERE tanggal = '$tanggal'  AND kode_baja = 'L03K10' AND referensi = 'GD' ");
...
//baja kosong LPG 3kg Masuk
$table41 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_3ksg_gd FROM riwayat_pembelian WHERE tanggal = '$tanggal'  AND kode_baja = 'L03K10' AND referensi = 'CBM' ");
...
//konfirmasi retur
$tabelgd3 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_3ksg_gd FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'L03K10' AND referensi = 'GD' ");
...
//stok akhir 3kg kosong
$table43 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'L03K10'");
...
//stok akhir 3kg retur
$tabgd2 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'L03K00'");
$datgd2 = mysqli_fetch_array($tabgd2);
$stok_akhir_3kg_rt_gd = $datgd2['gudang'];
//KEBERANGKATAN
$tabelgd4 = mysqli_query($koneksicbm, "SELECT SUM(L03K00) AS brangkat_3_rtr FROM riwayat_keberangkatan WHERE tanggal = '$tanggal' ");
...
//LPG 12KG ISI
//baja isi LPG 12kg Keluar
$table44 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_12_gd FROM riwayat_penjualan WHERE tanggal = '$tanggal'  AND kode_baja = 'L12K01' AND referensi = 'GD' ");
...
//baja isi LPG 12kg Masuk
$table45 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_12_gd FROM riwayat_pembelian WHERE tanggal = '$tanggal'  AND kode_baja = 'L12K01' AND referensi = 'CBM' ");
...
//konfirmasi retur
$tabelgd5 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_12_gd FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'L12K11' AND referensi = 'GD' ");
...
//Keberangkatan
$tabelgd6 = mysqli_query($koneksicbm, "SELECT SUM(L12K11) AS brangkat_12 FROM riwayat_keberangkatan WHERE tanggal = '$tanggal' ");
...
//stok akhir 12kg isi
$table47 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'L12K11'");
...
//LPG 12KG kOSONG
//baja kosong LPG 12kg Keluar
$table48 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_12ksg_gd FROM riwayat_penjualan WHERE tanggal = '$tanggal'  AND kode_baja = 'L12K10' AND referensi = 'GD' ");
...
//baja kosong LPG 12kg Masuk
$table49 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_12ksg_gd FROM riwayat_pembelian WHERE tanggal = '$tanggal'  AND kode_baja = 'L12K10' AND referensi = 'CBM' ");
...
//konfirmasi retur
$tabelgd7 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_12ksg_gd FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'L12K10' AND referensi = 'GD' ");
...
//stok akhir 12kg kosong
$table51 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'L12K10'");
...
//stok akhir 3kg retur
$tabgd4 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'L12K00'");
$datgd4 = mysqli_fetch_array($tabgd4);
$stok_akhir_12_rt_gd = $datgd4['gudang'];
//keberangkatan
$tabelgd8 = mysqli_query($koneksicbm, "SELECT SUM(L12K00) AS brangkat_12_rtr FROM riwayat_keberangkatan WHERE tanggal = '$tanggal' ");
...
//BG 5,5 ISI
//baja isi BG 5,5kg Keluar
$table52 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_b05_gd FROM riwayat_penjualan WHERE tanggal = '$tanggal'  AND kode_baja = 'B05K01' AND referensi = 'GD' ");
...
//baja isi BG 5,5kg Masuk
$table53 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_b05_gd FROM riwayat_pembelian WHERE tanggal = '$tanggal'  AND kode_baja = 'B05K01' AND referensi = 'CBM' ");
...
//konfirmasi retur
$tabelgd9 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_b05_gd FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'B05K11' AND referensi = 'GD' ");
...
//Keberangkatan
$tabelgd10 = mysqli_query($koneksicbm, "SELECT SUM(B05K11) AS brangkat_b05 FROM riwayat_keberangkatan WHERE tanggal = '$tanggal' ");
...
//stok akhir 5,5kg isi
$table55 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'B05K11'");
...
//BG 5,5 Kosong 
//baja kosong BG 5,5kg Keluar
$table56 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_b05ksg_gd FROM riwayat_penjualan WHERE tanggal = '$tanggal'  AND kode_baja = 'B05K10' AND referensi = 'GD' ");
...
//baja kosong BG 5,5 KG Masuk
$table57 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_b05ksg_gd FROM riwayat_pembelian WHERE tanggal = '$tanggal'  AND kode_baja = 'B05K10' AND referensi = 'CBM' ");
...
//konfirmasi retur
$tabelgd11 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_b05ksg_gd FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'B05K10' AND referensi = 'GD' ");
...
//stok akhir 5,5kg kosong
$table59 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'B05K10'");
...
//stok akhir 3kg retur
$tabgd6 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'B05K00'");
$datgd6 = mysqli_fetch_array($tabgd6);
$stok_akhir_b05_rt_gd = $datgd6['gudang'];
//keberangkatan
$tabelgd12 = mysqli_query($koneksicbm, "SELECT SUM(B05K00) AS brangkat_b05_rtr FROM riwayat_keberangkatan WHERE tanggal = '$tanggal' ");
...
//BG 12KG ISI
//baja isi BG 12kg keluar
$table60 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_b12_gd FROM riwayat_penjualan WHERE tanggal = '$tanggal'  AND kode_baja = 'B12K01' AND referensi = 'GD' ");
...
//baja isi BG 12kg Masuk
$table61 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_b12_gd FROM riwayat_pembelian WHERE tanggal = '$tanggal'  AND kode_baja = 'B12K01' AND referensi = 'CBM' ");
...
//konfirmasi retur
$tabelgd13 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_b12_gd FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'B12K11' AND referensi = 'GD' ");
...
//Keberangkatan
$tabelgd14 = mysqli_query($koneksicbm, "SELECT SUM(B12K11) AS brangkat_b12 FROM riwayat_keberangkatan WHERE tanggal = '$tanggal' ");
...
//stok akhir 12kg isi
$table63 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'B12K11'");
...
//BG 12KH KOSONG
//baja kosong BG 12kg KELUAR
$table64 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS penjualan_b12ksg_gd FROM riwayat_penjualan WHERE tanggal = '$tanggal'  AND kode_baja = 'B12K10' AND referensi = 'GD' ");
...
//baja kosong BG 12kg Masuk
$table65 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS pembelian_b12ksg_gd FROM riwayat_pembelian WHERE tanggal = '$tanggal'  AND kode_baja = 'B12K10' AND referensi = 'CBM' ");
...
//konfirmasi retur
$tabelgd15 = mysqli_query($koneksicbm, "SELECT SUM(qty) AS retur_b12ksg_gd FROM riwayat_konfirmasi_retur WHERE tanggal = '$tanggal' AND kode_baja = 'B12K10' AND referensi = 'GD' ");
...
//stok akhir 5,5kg kosong
$table67 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'B12K10'");
...
//stok akhir 3kg retur
$tabgd8 = mysqli_query($koneksicbm, "SELECT * FROM inventory WHERE kode_baja = 'B12K00'");
$datgd8 = mysqli_fetch_array($tabgd8);
$stok_akhir_b12_rt_gd = $datgd8['gudang'];
//keberangkatan
$tabelgd16 = mysqli_query($koneksicbm, "SELECT SUM(B12K00) AS brangkat_b12_rtr FROM riwayat_keberangkatan WHERE tanggal = '$tanggal' ");
