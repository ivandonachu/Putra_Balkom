...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksicbm, "SELECT * FROM riwayat_penggajian WHERE tanggal = '$tanggal_awal'  ");
}
else{
  $table2 = mysqli_query($koneksicbm, "SELECT * FROM rekap_gaji_driver_cbm WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
}
