...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table2 = mysqli_query($koneksicbm, "SELECT * FROM riwayat_saldo_armada WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Biaya Konsumsi' AND referensi = 'CBM' ");
  $table3 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_cbm a  WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Biaya Konsumsi' AND referensi = 'CBM'");
}
else{
  ...
  $table2 = mysqli_query($koneksicbm, "SELECT * FROM riwayat_saldo_armada WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Konsumsi' AND referensi = 'CBM' ");
  $table3 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_cbm a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Konsumsi' AND referensi = 'CBM'");
}
 ...
 <head>
  ...
  <title>Rincian Biaya Konsumsi</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRListrik?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Konsumsi</h5></a>"; ?>
...
<br>
  ...
  <h3 align = 'center'>Rincian Biaya Konsumsi Operasional CBM</h3>
<!-- Tabel -->    
...
<br>
    ...
    <h3 align = 'center'>Rincian Biaya Konsumsi Kasir CBM</h3>
