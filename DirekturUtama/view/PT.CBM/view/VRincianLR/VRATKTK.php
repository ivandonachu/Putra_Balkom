...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksicbm, "SELECT * FROM riwayat_pengeluaran a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun WHERE tanggal = '$tanggal_awal' AND b.kode_akun = '5-520' ");
}
else{
  $table = mysqli_query($koneksicbm, "SELECT * FROM riwayat_pengeluaran a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.kode_akun = '5-520' ");
}
 ...
 <head>
  ...
  <title>Rincian ATK Kasir Toko</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRATKTK?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian ATK Kasir Toko</h5></a>"; ?>
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
    ...
    <div class="row" >
      <div class="col-md-11" align="right" >
         <?php echo "<a href='VRATKTK?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><button type='button' class='btn btn-primary'>Kasir Toko</button></a>"; ?>
      </div>
      <div class="col-md-1"  align="right">
         <?php echo "<a href='VRATKAD?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><button type='button' class='btn btn-primary'>Kas Kecil</button></a>"; ?>
      </div>
    </div>
<br>
<br>
