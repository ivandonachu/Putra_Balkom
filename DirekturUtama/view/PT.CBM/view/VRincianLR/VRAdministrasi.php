...
if ($tanggal_akhir == $tanggal_awal) {
  ...
  $table3 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_cbm a  WHERE tanggal = '$tanggal_awal'  AND nama_akun = 'Biaya Administrasi' ");
  $table2 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_admin WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Biaya Admin' AND referensi = 'CBM' ");
}
else{
 
  $table3 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_cbm a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Administrasi' ");
  $table2 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_admin WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Admin' AND referensi = 'CBM' ");
}
 ...
 <head>
  ...
  <title>Rincian Biaya Administrasi CBM</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRAdministrasi?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Biaya Administrasi CBM</h5></a>"; ?>
