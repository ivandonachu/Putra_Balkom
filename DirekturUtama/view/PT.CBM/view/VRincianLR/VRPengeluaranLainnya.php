...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table3 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_cbm a  WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Pengeluaran Lainnya' AND referensi = 'CBM'");
}
else{
  ...
  $table3 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_cbm a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Pengeluaran Lainnya' AND referensi = 'CBM'");
}
...
<br>
  ...
  <h3 align = 'center'>Rincian Biaya Pengeluaran Lainnya (Operasional)</h3>
<!-- Tabel -->    
