...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksicbm, "SELECT * FROM riwayat_kas_kecil WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Listrik & Telepon' ");
}
else{
  $table = mysqli_query($koneksicbm, "SELECT * FROM riwayat_kas_kecil WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Listrik & Telepon' ");
}
 ...
 <head>
  ...
  <title>Rincian Listrik & Telepon Kas Kecil</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRListrikAD?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Listrik & Telepon Kas Kecil</h5></a>"; ?>
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
    ...
    <div class="row" >
      <div class="col-md-11" align="right" >
         <?php echo "<a href='VRListrikTK?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><button type='button' class='btn btn-primary'>Kasir Toko</button></a>"; ?>
      </div>
      <div class="col-md-1"  align="right">
         <?php echo "<a href='VRListrikAD?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><button type='button' class='btn btn-primary'>Kas Kecil</button></a>"; ?>
      </div>
    </div>
<br>
<br>
