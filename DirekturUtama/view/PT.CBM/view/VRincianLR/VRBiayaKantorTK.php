...
if ($tanggal_awal == $tanggal_akhir) {
 ...
 <head>
  ...
  <title>Rincian Biaya Kantor Kasir Toko</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRBiayaKantorTK?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Biaya Kantor Kasir Toko</h5></a>"; ?>
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
   ...
   <div class="row" >
      <div class="col-md-11" align="right" >
         <?php echo "<a href='VRBiayaKantorTK?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><button type='button' class='btn btn-primary'>Kasir Toko</button></a>"; ?>
      </div>
      <div class="col-md-1"  align="right">
         <?php echo "<a href='VRBiayaKantorAD?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><button type='button' class='btn btn-primary'>Kas Kecil</button></a>"; ?>
      </div>
    </div>
<br>
<br>
