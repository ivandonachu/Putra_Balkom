...
if (isset($_GET['tanggal1'])) {
   ...
   if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksicbm, "SELECT * FROM transport_fee WHERE tanggal = '$tanggal_awal' AND referensi = 'CBM'");
    $table2 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_admin WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Transport Fee' AND referensi = 'CBM' ");
   }
   else{
    $table = mysqli_query($koneksicbm, "SELECT * FROM transport_fee WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'CBM' ");
    $table2 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_admin WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Transport Fee' AND referensi = 'CBM' ");
   }
