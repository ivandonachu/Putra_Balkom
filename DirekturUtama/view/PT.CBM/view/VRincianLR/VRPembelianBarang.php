...
WHERE  tanggal = '$tanggal_awal' AND b.kode_akun = '5-110' ");
}
else{
  $table = mysqli_query($koneksicbm, "SELECT * FROM riwayat_pembelian a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun INNER JOIN baja c ON a.kode_baja=c.kode_baja
WHERE  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.kode_akun = '5-110' ");
}
 ...
 <head>
  ...
  <title>Rincian Pembelian Barang</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRRefillLR?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Rincian Pembelian barang</h5></a>"; ?>
