...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksicbm, "SELECT * FROM riwayat_kas_kecil WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Biaya Kantor' ");
}
else{
  $table = mysqli_query($koneksicbm, "SELECT * FROM riwayat_kas_kecil WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Kantor' ");
}
 ...
 <head>
  ...
  <title>Rincian Biaya Kantor Kas Kecil</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRBiayaKantorAD?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Biaya Kantor Kas Kecil</h5></a>"; ?>
