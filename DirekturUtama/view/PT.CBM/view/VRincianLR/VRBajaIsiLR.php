...
if ($tanggal_awal == $tanggal_akhir) {
 ...
 WHERE tanggal = '$tanggal_awal' AND  a.kode_akun ='4-120' ");
}
else{
  $table = mysqli_query($koneksicbm, "SELECT * FROM riwayat_penjualan a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun INNER JOIN baja c ON a.kode_baja=c.kode_baja
 WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND  a.kode_akun ='4-120' ");
}
 ...
 <head>
  ...
  <title>Rincian Penjualan Baja + Isi CBM</title>
