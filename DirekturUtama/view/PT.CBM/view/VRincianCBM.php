...
if ($tanggal_awal == $tanggal_akhir) {
  $table  = mysqli_query($koneksicbm, "SELECT * FROM riwayat_saldo_armada WHERE tanggal = '$tanggal_awal' AND status_saldo = 'Masuk' AND nama_rekening = 'CBM' AND referensi = 'CBM' 
                                                                         OR tanggal = '$tanggal_awal' AND status_saldo = 'Masuk' AND nama_rekening = 'CBM' AND referensi = 'PBJ' 
                                                                         OR tanggal = '$tanggal_awal' AND status_saldo = 'Masuk' AND nama_rekening = 'CBM' AND referensi = 'Melodi Tani'
                                                                         OR tanggal = '$tanggal_awal' AND status_saldo = 'Masuk' AND nama_rekening = 'PBJ' AND referensi = 'CBM'
                                                                         OR tanggal = '$tanggal_awal' AND status_saldo = 'Masuk' AND nama_rekening = 'Melodi Tani' AND referensi = 'CBM'
                                                                         OR tanggal = '$tanggal_awal' AND status_saldo = 'Keluar' AND nama_rekening = 'CBM' AND referensi = 'CBM'
                                                                         OR tanggal = '$tanggal_awal' AND status_saldo = 'Keluar' AND nama_rekening = 'CBM' AND referensi = 'BALSRI'
                                                                         OR tanggal = '$tanggal_awal' AND status_saldo = 'Keluar' AND nama_rekening = 'CBM' AND referensi = 'Kebun Lengkiti'
                                                                         OR tanggal = '$tanggal_awal' AND status_saldo = 'Keluar' AND nama_rekening = 'CBM' AND referensi = 'MES/PBR'
...
$table = mysqli_query($koneksicbm, "SELECT * FROM riwayat_saldo_armada  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Masuk' AND nama_rekening = 'CBM' AND referensi ='CBM' 
                                                                     OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Masuk' AND nama_rekening = 'CBM' AND referensi = 'PBJ' 
                                                                     OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Masuk' AND nama_rekening = 'CBM' AND referensi =  'Melodi Tani'
                                                                     OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Masuk' AND nama_rekening = 'PBJ' AND referensi =  'CBM'
                                                                     OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Masuk' AND nama_rekening = 'Melodi Tani' AND referensi = 'CBM'
                                                                     OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Keluar' AND nama_rekening = 'CBM' AND referensi =  'CBM' 
                                                                     OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Keluar' AND nama_rekening = 'CBM' AND referensi =  'BALSRI'
                                                                     OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Keluar' AND nama_rekening = 'CBM' AND referensi =  'Kebun Lengkiti'
                                                                     OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Keluar' AND nama_rekening = 'CBM' AND referensi =  'MES/PBR' 
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VRincianCBM'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Rincian Saldo CBM</h5></a>"; ?>
...
<table  class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  ...
  <tbody>
    ...
    <?php 
      ...
      <td style='font-size: 14px'>";?> <?= formatuang($masuk_pbj_cbm + $masuk_mt_cbm + $keluar_cbm_balsri + $keluar_cbm_keling + $keluar_cbm_cbm + $keluar_cbm_pbr ); ?> <?php echo "</td>
      <td style='font-size: 14px'>";?> <?= formatuang($setor_cbm_cbm + $setor_cbm_mt + $setor_cbm_pbj); ?> <?php echo "</td>
      <td style='font-size: 14px'>";?> <?= formatuang(( 15000000 + $masuk_cbm_cbm + $masuk_cbm_mt + $masuk_cbm_pbj) - ($masuk_pbj_cbm + $masuk_mt_cbm + $keluar_cbm_balsri + $setor_cbm_cbm + $setor_cbm_mt + $setor_cbm_pbj + $keluar_cbm_keling + $keluar_cbm_cbm + $keluar_cbm_pbr )); ?> <?php echo "</td>
