...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksipbr, "SELECT * FROM monitoring_cashless_mes WHERE tanggal = '$tanggal_awal'");
    $table2 = mysqli_query($koneksipbr, "SELECT nama_pangkalan,  SUM(jumlah) AS total_jumlah,  SUM(briva) AS total_briva,  SUM(transaksis_transfer) AS total_transfer  FROM monitoring_cashless_mes  WHERE tanggal = '$tanggal_awal' GROUP BY nama_pangkalan");
} else {

    $table = mysqli_query($koneksipbr, "SELECT * FROM monitoring_cashless_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
    $table2 = mysqli_query($koneksipbr, "SELECT nama_pangkalan,  SUM(jumlah) AS total_jumlah,  SUM(briva) AS jumlah_briva,  SUM(transaksi_transfer) AS jumlah_transfer FROM monitoring_cashless_mes  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_pangkalan");
}
