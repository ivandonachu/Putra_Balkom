...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksipbr, "SELECT * FROM riwayat_pengeluaran a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun WHERE tanggal = '$tanggal_awal' AND b.kode_akun = '5-530' AND referensi = 'PBR' OR tanggal = '$tanggal_awal' AND b.kode_akun = '5-530' AND referensi = 'PB' ");
  $table3 = mysqli_query($koneksipbr, "SELECT * FROM pengeluaran_pbr a  WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Transport / Perjalanan Dinas' ");
}
else{
  $table = mysqli_query($koneksipbr, "SELECT * FROM riwayat_pengeluaran a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.kode_akun = '5-530' AND referensi = 'PBR' OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.kode_akun = '5-530' AND referensi = 'PB'");
  $table3 = mysqli_query($koneksipbr, "SELECT * FROM pengeluaran_pbr a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Transport / Perjalanan Dinas' ");
  $table4 = mysqli_query($koneksipbr, "SELECT * FROM keuangan_pbr a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Transport / Perjalanan Dinas' ");
}
 ...
 <head>
  ...
  <title>Rincian Transport / Perjalan Dinas</title>
...
<h3 align = 'center'>Rincian Transport / Perjalanan Dinas (Keuangan Kasir)</h3>
<!-- Tabel -->    
<div style="overflow-x: auto" align = 'center' >
