...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table3 = mysqli_query($koneksipbr, "SELECT * FROM pengeluaran_pbr a  WHERE tanggal = '$tanggal_awal'  AND nama_akun = 'Biaya Penjualan & Pemasaran' ");
}
else{
  ...
  $table3 = mysqli_query($koneksipbr, "SELECT * FROM pengeluaran_pbr a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Penjualan & Pemasaran' ");
  $table4 = mysqli_query($koneksipbr, "SELECT * FROM keuangan_pbr a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Penjualan & Pemasaran' ");
}
...
<h3 align = 'center'>Rincian Biaya Pemasaran (Keuangan Kasir)</h3>
<!-- Tabel -->    
<div style="overflow-x: auto" align = 'center' >
