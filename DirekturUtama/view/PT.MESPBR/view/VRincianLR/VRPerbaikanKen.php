...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRPerbaikanKen?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Perbaikan Kendaraan PBR</h5></a>"; ?>
