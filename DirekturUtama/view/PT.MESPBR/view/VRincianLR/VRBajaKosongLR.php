...
if ($tanggal_awal == $tanggal_akhir) {
 ...
 WHERE tanggal = '$tanggal_awal' AND  a.kode_akun ='4-130' AND a.referensi='PBR' ");
}
else{
  $table = mysqli_query($koneksipbr, "SELECT * FROM riwayat_penjualan a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun INNER JOIN baja c ON a.kode_baja=c.kode_baja
 WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND  a.kode_akun ='4-130' AND a.referensi='PBR' ");
}
 ...
 <head>
  ...
  <title>Rincian Penjualan Baja Kosong PBR</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRRefillLR?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Penjualan Baja Kosong PBR</h5></a>"; ?>
