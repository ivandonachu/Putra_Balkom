...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksipbr, "SELECT * FROM riwayat_pengeluaran a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun WHERE tanggal = '$tanggal_awal' AND b.kode_akun = '5-540' AND referensi = 'PBR' OR tanggal = '$tanggal_awal' AND b.kode_akun = '5-540' AND referensi = 'PB' ");
  $table3 = mysqli_query($koneksipbr, "SELECT * FROM pengeluaran_pbr a  WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Biaya Kantor' ");
}
else{
  $table = mysqli_query($koneksipbr, "SELECT * FROM riwayat_pengeluaran a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.kode_akun = '5-540' AND referensi = 'PBR' OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.kode_akun = '5-540' AND referensi = 'PB'");
  $table3 = mysqli_query($koneksipbr, "SELECT * FROM pengeluaran_pbr a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Kantor' ");
    $table4 = mysqli_query($koneksipbr, "SELECT * FROM keuangan_pbr a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Kantor' ");
}
 ...
 <head>
  ...
  <title>Rincian Biaya Kantor PBR</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRBiayaKantorTK?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '></h5></a>"; ?>
...
<br>
<br>
<h3 align = 'center'>Rincian Biaya Kantor (Kasir)</h3>
<!-- Tabel -->    
...
<h3 align = 'center'>Rincian Biaya Kantor (Keuangan)</h3>
...
<div style="overflow-x: auto" align = 'center' >
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table3)){
      ...
      <td style='font-size: 14px'>"; ?> <a download="" href="/PT.CBM/Oprasional/file_oprasional/<?= $file_bukti ?>"> <?php echo "$file_bukti </a> </td>
       </tr>";
  }
  ?>
...
<h3 align = 'center'>Biaya Kantor (Keuangan Kasir)</h3>
<!-- Tabel -->    
<div style="overflow-x: auto" align = 'center' >
