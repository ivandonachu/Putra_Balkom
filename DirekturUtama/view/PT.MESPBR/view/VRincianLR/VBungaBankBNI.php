...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksicbm, "SELECT * FROM bunga_bank WHERE tanggal = '$tanggal_awal' AND referensi = 'PBR' AND nama_bank = 'Bank BNI'");
  $table2 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_admin WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Bunga Bank' AND referensi = 'PBR' ");
}
else{
  $table = mysqli_query($koneksicbm, "SELECT * FROM bunga_bank WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'PBR' AND nama_bank = 'Bank BNI'");
  $table2 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_admin WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Bunga Bank' AND referensi = 'PBR' ");
}
