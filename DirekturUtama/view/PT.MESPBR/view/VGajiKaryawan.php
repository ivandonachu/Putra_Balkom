...
if (isset($_GET['tanggal1'])) {
  ...
  $tanggal_akhir = date('Y-m-31');
   ...
   if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksipbr, "SELECT * FROM riwayat_penggajian");
   }
   else{

     $table = mysqli_query($koneksipbr, "SELECT * FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
   }
