...
if (isset($_GET['tanggal1'])) {
   ...
   if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksicbm, "SELECT * FROM transport_fee WHERE tanggal = '$tanggal_awal' AND referensi = 'MES'");
    $table2 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_admin WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Transport Fee' AND referensi = 'MES' ");
   }
   else{
    $table = mysqli_query($koneksicbm, "SELECT * FROM transport_fee WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'MES' ");
    $table2 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_admin WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Transport Fee' AND referensi = 'MES' ");
   }
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VTrasnportFee?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Rincian Transport Fee</h5></a>"; ?>
