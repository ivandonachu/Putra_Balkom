...
WHERE  tanggal = '$tanggal_awal' AND b.kode_akun = '5-120' AND referensi = 'MES'");
}
else{
  $table = mysqli_query($koneksipbr, "SELECT * FROM riwayat_pembelian a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun INNER JOIN baja c ON a.kode_baja=c.kode_baja
WHERE  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.kode_akun = '5-120' AND referensi = 'MES' ");
}
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRPembelianBIsi?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Pembelian Baja Isi MES</h5></a>"; ?>
