...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksipbr, "SELECT * FROM riwayat_pengeluaran a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun WHERE tanggal = '$tanggal_awal' AND b.kode_akun = '5-560' AND referensi = 'MES' OR  tanggal = '$tanggal_awal' AND b.kode_akun = '5-560' AND referensi = 'ME' ");
  $table3 = mysqli_query($koneksipbr, "SELECT * FROM pengeluaran_mes a  WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Biaya Konsumsi' ");
}
else{
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px;  '></h5></a>"; ?>
