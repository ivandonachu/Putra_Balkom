...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksipbr, "SELECT * FROM riwayat_penggajian WHERE tanggal = '$tanggal_awal' AND referensi = 'MES'  ");
}
else{
  $table = mysqli_query($koneksipbr, "SELECT * FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND referensi = 'MES' ");
  $table2 = mysqli_query($koneksicbm, "SELECT * FROM rekap_gaji_mes WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href='VRGajiKaryawan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Gaji Karyawan MES</h5></a>"; ?>
