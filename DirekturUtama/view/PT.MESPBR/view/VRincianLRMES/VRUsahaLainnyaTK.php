...
if ($tanggal_akhir == $tanggal_awal) {
  ...
  $table4 = mysqli_query($koneksipbr, "SELECT * FROM keuangan_mes a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Pengeluaran Lainnya' ");
}
 ...
 <head>
  ...
  <title>Rincian Pengeluaran Lainnya Kasir MES</title>
