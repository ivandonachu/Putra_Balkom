...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksicbm, "SELECT * FROM kredit WHERE tanggal = '$tanggal_awal'AND referensi = 'MES' ");
  $table2 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_admin WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Kredit' AND referensi = 'MES' ");
}
else{
  $table = mysqli_query($koneksicbm, "SELECT * FROM kredit WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND referensi = 'MES' ");
  $table2 = mysqli_query($koneksicbm, "SELECT * FROM pengeluaran_admin WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Kredit' AND referensi = 'MES' ");
}
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Kredit MES</h5></a>"; ?>
