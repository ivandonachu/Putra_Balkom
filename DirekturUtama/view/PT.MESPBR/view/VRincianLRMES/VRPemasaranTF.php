...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table4 = mysqli_query($koneksipbr, "SELECT * FROM keuangan_mes a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Penjualan & Pemasaran' ");
}
