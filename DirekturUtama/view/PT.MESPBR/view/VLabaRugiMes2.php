...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table2 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS penjualan_bajaisi FROM riwayat_penjualan WHERE tanggal = '$tanggal_awal' AND kode_akun = '4-120' AND referensi = 'MES' ");
    ...
    $table3 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS penjualan_bajakosong FROM riwayat_penjualan WHERE tanggal = '$tanggal_awal' AND kode_akun = '4-130' AND referensi = 'MES'");
    ...
    $table4 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pembelian_refill_cbm FROM riwayat_pembelian WHERE tanggal = '$tanggal_awal' AND kode_akun = '5-110' AND referensi = 'MES' ");
    ...
    $table5 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pembelian_refill_tk FROM riwayat_pembelian WHERE  tanggal = '$tanggal_awal' AND kode_akun = '5-110' AND referensi = 'MES' ");
    ...
    $table6 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pembelian_bajaisi_cbm FROM riwayat_pembelian WHERE tanggal = '$tanggal_awal'AND kode_akun = '5-120' AND referensi = 'MES' ");
    ...
    //TOTAL PEMBELIAN REFILL TK
    $table7 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pembelian_bajaisi_tk FROM riwayat_pembelian WHERE tanggal = '$tanggal_awal' AND kode_akun = '5-120' AND referensi = 'MES' ");
    ...
    $table8 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pembelian_bajakosong_cbm FROM riwayat_pembelian WHERE tanggal = '$tanggal_awal' AND kode_akun = '5-130' AND referensi = 'MES' ");
    ...
    $table9 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pembelian_bajakosong_tk FROM riwayat_pembelian WHERE tanggal = '$tanggal_awal' AND kode_akun = '5-130' AND referensi = 'MES' ");
    ...
    $table12 = mysqli_query($koneksipbr, "SELECT SUM(jumlah_pengeluaran) AS total_transport FROM riwayat_pengeluaran WHERE tanggal = '$tanggal_awal' AND kode_akun = '5-530' AND referensi = 'MES' OR tanggal = '$tanggal_awal' AND kode_akun = '5-530' AND referensi = 'ME'");
    ...
    //Biaya KANTOR
    $table13 = mysqli_query($koneksipbr, "SELECT SUM(jumlah_pengeluaran) AS total_biaya_kantor_tk FROM riwayat_pengeluaran WHERE tanggal = '$tanggal_awal' AND kode_akun = '5-540' AND referensi = 'MES' OR tanggal = '$tanggal_awal' AND kode_akun = '5-540' AND referensi = 'ME'");
    ...
    $table14 = mysqli_query($koneksipbr, "SELECT SUM(jumlah_pengeluaran) AS total_listrik_tk FROM riwayat_pengeluaran WHERE tanggal = '$tanggal_awal' AND kode_akun = '5-550' AND referensi = 'MES' OR tanggal = '$tanggal_awal' AND kode_akun = '5-550' AND referensi = 'ME'");
    ...
    $table15 = mysqli_query($koneksipbr, "SELECT SUM(uang_jalan) AS total_pemasaran_tk FROM riwayat_keberangkatan WHERE tanggal = '$tanggal_awal' AND referensi = 'MES'");
    ...
    $table15a = mysqli_query($koneksipbr, "SELECT SUM(jumlah_pengeluaran) AS total_pemasaran_kasir FROM riwayat_pengeluaran WHERE tanggal = '$tanggal_awal' AND kode_akun = '5-580' AND referensi = 'MES' OR tanggal = '$tanggal_awal' AND kode_akun = '5-580' AND referensi = 'ME'");
    ...
    //kasir
    $table16 = mysqli_query($koneksipbr, "SELECT SUM(jumlah_pengeluaran) AS total_biaya_usaha_tk FROM riwayat_pengeluaran WHERE tanggal = '$tanggal_awal' AND kode_akun = '5-590' AND referensi = 'MES' OR tanggal = '$tanggal_awal' AND kode_akun = '5-590' AND referensi = 'ME'");
    ...
    $table180x = mysqli_query($koneksicbm, "SELECT SUM(jumlah) AS total_kredit FROM kredit WHERE tanggal = '$tanggal_awal' AND referensi = 'MES' ");
    ...
    if (!isset($data_kredit['total_kredit'])) {
      ...
      //BIAYA Prive
    //kasir
    $table16x = mysqli_query($koneksipbr, "SELECT SUM(jumlah_pengeluaran) AS total_prive FROM riwayat_pengeluaran WHERE  tanggal = '$tanggal_awal' AND kode_akun = '3-500' AND referensi = 'MES' OR tanggal = '$tanggal_awal' AND kode_akun = '3-500' AND referensi = 'ME'");
    ...
    // TOTAL PENJUALAN BAJA + ISI
    $table2 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS penjualan_bajaisi FROM riwayat_penjualan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '4-120'AND referensi = 'MES' ");
    $data_pendapatan_bajaisi = mysqli_fetch_array($table2);
    $total_pendapatan_bajaisi = $data_pendapatan_bajaisi['penjualan_bajaisi'];
    if (!isset($data_pendapatan_bajaisi['penjualan_bajaisi'])) {
        $total_pendapatan_bajaisi = 0;
    ...
    // TOTAL PENJUALAN KOSONG
    $table3 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS penjualan_bajakosong FROM riwayat_penjualan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '4-130'AND referensi = 'MES' ");
    $data_pendapatan_bajakosong = mysqli_fetch_array($table3);
    $total_pendapatan_bajakosong = $data_pendapatan_bajakosong['penjualan_bajakosong'];
    if (!isset($data_pendapatan_bajakosong['penjualan_bajakosong'])) {
        $total_pendapatan_bajakosong = 0;
    ...
    //transport_fee
    $table18 = mysqli_query($koneksicbm, "SELECT SUM(jumlah) AS jml_transport_fee FROM transport_fee WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'MES'");
    ...
    //HARGA POKOK PENJUALAN
    //TOTAL PEMBELIAN REFILL CBM
    $table4 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pembelian_refill_cbm FROM riwayat_pembelian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-110' AND referensi = 'MES'  AND pembayaran = 'Bank BRI MES'  ");
    $data_pembelian_refill_cbm = mysqli_fetch_array($table4);
    $total_pembelian_refill_cbm = $data_pembelian_refill_cbm['pembelian_refill_cbm'];
    if (!isset($data_pembelian_refill_cbm['pembelian_refill_cbm'])) {
        $total_pembelian_refill_cbm = 0;
    ...
    //TOTAL PEMBELIAN REFILL TK
    $table5 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pembelian_refill_tk FROM riwayat_pembelian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-110' AND referensi = 'MES' ");
    $data_pembelian_refill_tk = mysqli_fetch_array($table5);
    $total_pembelian_refill_tk = $data_pembelian_refill_tk['pembelian_refill_tk'];
    if (!isset($data_pembelian_refill_tk['pembelian_refill_tk'])) {
        $total_pembelian_refill_tk = 0;
    ...
    //TOTAL PEMBELIAN BAJA + ISI CBM
    $table6 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pembelian_bajaisi_cbm FROM riwayat_pembelian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-120' AND referensi = 'MES' ");
    $data_pembelian_bajaisi_cbm = mysqli_fetch_array($table6);
    $total_pembelian_bajaisi_cbm = $data_pembelian_bajaisi_cbm['pembelian_bajaisi_cbm'];
    if (!isset($data_pembelian_bajaisi_cbm['pembelian_bajaisi_cbm'])) {
        $total_pembelian_bajaisi_cbm = 0;
    ...
    //TOTAL PEMBELIAN REFILL TK
    $table7 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pembelian_bajaisi_tk FROM riwayat_pembelian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-120' AND referensi = 'MES' ");
    $data_pembelian_bajaisi_tk = mysqli_fetch_array($table7);
    $total_pembelian_bajaisi_tk = $data_pembelian_bajaisi_tk['pembelian_bajaisi_tk'];
    if (!isset($data_pembelian_bajaisi_tk['pembelian_bajaisi_tk'])) {
        $total_pembelian_bajaisi_tk = 0;
    ...
    //TOTAL PEMBELIAN KOSONG CBM
    $table8 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pembelian_bajakosong_cbm FROM riwayat_pembelian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-130' AND referensi = 'MES' ");
    $data_pembelian_bajakosong_cbm = mysqli_fetch_array($table8);
    $total_pembelian_bajakosong_cbm = $data_pembelian_bajakosong_cbm['pembelian_bajakosong_cbm'];
    if (!isset($data_pembelian_bajakosong_cbm['pembelian_bajakosong_cbm'])) {
        $total_pembelian_bajakosong_cbm = 0;
    ...
    //TOTAL PEMBELIAN KOSONG TK
    $table9 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pembelian_bajakosong_tk FROM riwayat_pembelian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-130' AND referensi = 'MES' ");
    $data_pembelian_bajakosong_tk = mysqli_fetch_array($table9);
    $total_pembelian_bajakosong_tk = $data_pembelian_bajakosong_tk['pembelian_bajakosong_tk'];
    if (!isset($data_pembelian_bajakosong_tk['pembelian_bajakosong_tk'])) {
        $total_pembelian_bajakosong_tk = 0;
    ...
    //BIAYA USAHA
    //GAJI
    $table10 = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS total_gaji FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'MES' ");
    $data_gaji = mysqli_fetch_array($table10);
    $total_gaji_karyawan = $data_gaji['total_gaji'];
    if (!isset($data_gaji['total_gaji'])) {
        $total_gaji_karyawan = 0;
    ...
    //ALAT TULIS KANTOR TK
    $table11 = mysqli_query($koneksipbr, "SELECT SUM(jumlah_pengeluaran) AS total_atk_tk FROM riwayat_pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-520' AND referensi = 'MES' OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-520' AND referensi = 'ME' ");
    $data_pengeluaran_atk_tk = mysqli_fetch_array($table11);
    $total_pengeluaran_atk_tk = $data_pengeluaran_atk_tk['total_atk_tk'];
    if (!isset($data_pengeluaran_atk_tk['total_atk_tk'])) {
        $total_pengeluaran_atk_tk = 0;
    ...
    $table111x = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS total_atk_op_new FROM pengeluaran_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Alat Tulis Kantor' ");
    ...
    //ALAT TULIS KANTOR KEUANGAN
    $table111xK = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS total_atk_keuangan FROM keuangan_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Alat Tulis Kantor' ");
    $data_pengeluaran_atk_keuangan =  mysqli_fetch_array($table111xK);
    $total_pengeluaran_atk_keuangan = $data_pengeluaran_atk_keuangan['total_atk_keuangan'];
    if (!isset($data_pengeluaran_atk_keuangan['total_atk_keuangan'])) {
        $total_pengeluaran_atk_keuangan = 0;
    }

    $total_pengeluaran_atk = $total_pengeluaran_atk_tk + $total_pengeluaran_atk_op_new + $total_pengeluaran_atk_keuangan;




    //Transport /Perjalanan Dinas
    $table12 = mysqli_query($koneksipbr, "SELECT SUM(jumlah_pengeluaran) AS total_transport FROM riwayat_pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-530' AND referensi = 'MES' OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-530' AND referensi = 'ME' ");
    $data_pengeluaran_transport = mysqli_fetch_array($table12);
    $total_pengeluaran_transport = $data_pengeluaran_transport['total_transport'];
    if (!isset($data_pengeluaran_transport['total_transport'])) {
        $total_pengeluaran_transport = 0;
    ...
    $table12xx = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS transport_new FROM pengeluaran_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Transport / Perjalanan Dinas' ");
    ...
    //Transport /Perjalanan Dinas KEUANGAN
    $table12xK = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS transport_keuangan FROM keuangan_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Transport / Perjalanan Dinas' ");
    $data_transport_keuangan =  mysqli_fetch_array($table12xK);
    $total_transport_keuangan = $data_transport_keuangan['transport_keuangan'];
    if (!isset($data_transport_keuangan['transport_keuangan'])) {
        $total_transport_keuangan = 0;
    }
    $total_pengeluaran_transport = $total_pengeluaran_transport + $total_transport_new + $total_transport_keuangan;


    //Biaya KANTOR
    $table13 = mysqli_query($koneksipbr, "SELECT SUM(jumlah_pengeluaran) AS total_biaya_kantor_tk FROM riwayat_pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-540' AND referensi = 'MES' OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-540' AND referensi = 'ME'");
    $data_pengeluaran_kantor_tk = mysqli_fetch_array($table13);
    $total_pengeluaran_kantor_tk = $data_pengeluaran_kantor_tk['total_biaya_kantor_tk'];
    if (!isset($data_pengeluaran_kantor_tk['total_biaya_kantor_tk'])) {
        $total_pengeluaran_kantor_tk = 0;
    ...
    //Biaya Kantor new
    $table133x = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS total_biaya_kantor_new FROM pengeluaran_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Kantor'  ");
    ...
    //Biaya Kantor KEUANGAN
    $table133xk = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS total_biaya_kantor_keuangan FROM keuangan_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Kantor' ");
    $data_pengeluaran_kantor_keuangan =  mysqli_fetch_array($table133xk);
    $total_biaya_kantor_keuangan = $data_pengeluaran_kantor_keuangan['total_biaya_kantor_keuangan'];
    if (!isset($data_pengeluaran_kantor_keuangan['total_biaya_kantor_keuangan'])) {
        $total_biaya_kantor_keuangan = 0;
    }
    $total_pengeluaran_kantor = $total_pengeluaran_kantor_tk + $total_pengeluaran_kantor_new + $total_biaya_kantor_keuangan;


    //Biaya listrik $ telepon kasir toko
    $table14 = mysqli_query($koneksipbr, "SELECT SUM(jumlah_pengeluaran) AS total_listrik_tk FROM riwayat_pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-550' AND referensi = 'MES' OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-550' AND referensi = 'ME'");
    $data_pengeluaran_listrik_tk = mysqli_fetch_array($table14);
    $total_pengeluaran_listrik_tk = $data_pengeluaran_listrik_tk['total_listrik_tk'];
    if (!isset($data_pengeluaran_listrik_tk['total_listrik_tk'])) {
        $total_pengeluaran_listrik_tk = 0;
    ...
    $table144x = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS total_listrik_new FROM pengeluaran_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Listrik & Telepon'  ");
    ...
    //Biaya listrik $ telepon KEUANGAN
    $table144xk = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS total_pengeluaran_listrik_keuangan FROM keuangan_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Listrik & Telepon' ");
    $data_pengeluaran_listrik_keuangan =  mysqli_fetch_array($table144xk);
    $total_pengeluaran_listrik_keuangan = $data_pengeluaran_listrik_keuangan['total_pengeluaran_listrik_keuangan'];
    if (!isset($data_pengeluaran_listrik_keuangan['total_pengeluaran_listrik_keuangan'])) {
        $total_pengeluaran_listrik_keuangan = 0;
    }
    $total_pengeluaran_listrik =  $total_pengeluaran_listrik_tk + $total_pengeluaran_listrik_new + $total_pengeluaran_listrik_keuangan;
    ...
    //Biaya konsumsi new
    $table144ax = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS total_listrik_new FROM pengeluaran_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Konsumsi'  ");
    ...
    //Biaya konsumsi KEUANGAN
    $table144axk = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS total_pengeluaran_konsumsi_keuangan FROM keuangan_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Konsumsi' ");
    $data_pengeluaran_konsumsi_keuangan =  mysqli_fetch_array($table144axk);
    $total_pengeluaran_konsumsi_keuangan = $data_pengeluaran_konsumsi_keuangan['total_pengeluaran_konsumsi_keuangan'];
    if (!isset($data_pengeluaran_konsumsi_keuangan['total_pengeluaran_konsumsi_keuangan'])) {
        $total_pengeluaran_konsumsi_keuangan = 0;
    }
    $total_pengeluaran_konsumsi =  $total_pengeluaran_konsumsi_tk + $total_pengeluaran_konsumsi_new + $total_pengeluaran_konsumsi_keuangan;
    ...
    //uang makan KEUANGAN
    $table18k = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS uang_makan_keuangan FROM keuangan_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Uang Makan' ");
    $data_uang_makan_keuangan =  mysqli_fetch_array($table18k);
    $total_uang_makan_keuangan = $data_uang_makan_keuangan['uang_makan_keuangan'];
    if (!isset($data_uang_makan_keuangan['uang_makan_keuangan'])) {
        $total_uang_makan_keuangan = 0;
    }
    $total_uang_makan =  $total_uang_makan + $total_uang_makan_keuangan;
    ...
    //uang antar KEUANGAN
    $table19k = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS uang_antar_gas_keuangan FROM keuangan_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Uang Antar Gas' ");
    $data_uang_antar_gas_keuangan =  mysqli_fetch_array($table19k);
    $total_uang_antar_gas_keuangan = $data_uang_antar_gas_keuangan['uang_antar_gas_keuangan'];
    if (!isset($data_uang_antar_gas_keuangan['uang_antar_gas_keuangan'])) {
        $total_uang_antar_gas_keuangan = 0;
    }
    $total_uang_anter_gas = $total_uang_anter_gas + $total_uang_antar_gas_keuangan;
    ...
    //uang bongkar KEUANGAN
    $table110k = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS uang_bongkar_keuangan FROM keuangan_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Uang Bongkar Ulang'");
    $data_uang_bongkar_keuangan =  mysqli_fetch_array($table110k);
    $total_uang_bongkar_keuangan = $data_uang_bongkar_keuangan['uang_bongkar_keuangan'];
    if (!isset($data_uang_bongkar_keuangan['uang_bongkar_keuangan'])) {
        $total_uang_bongkar_keuangan = 0;
    }
    $total_uang_bongkar_ulang = $total_uang_bongkar_ulang + $total_uang_bongkar_keuangan;
    ...
    //uang lembur KEUANGAN
    $table111k = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS uang_lembur_keuangan FROM keuangan_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Uang Lembur'");
    $data_uang_lembur_keuangan =  mysqli_fetch_array($table111k);
    $total_uang_lembur_keuangan = $data_uang_lembur_keuangan['uang_lembur_keuangan'];
    if (!isset($data_uang_lembur_keuangan['uang_lembur_keuangan'])) {
        $total_uang_lembur_keuangan = 0;
    }
    $total_uang_lembur = $total_uang_lembur + $total_uang_lembur_keuangan;


    //Biaya Penjualan dan Pemasaran

    //pemasaran kebnerangkatan
    $table15 = mysqli_query($koneksipbr, "SELECT SUM(uang_jalan) AS total_pemasaran_tk FROM riwayat_keberangkatan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'MES'");
    $data_pemasaran_tk = mysqli_fetch_array($table15);
    $total_biaya_pemasaran_tk = $data_pemasaran_tk['total_pemasaran_tk'];
    if (!isset($data_pemasaran_tk['total_pemasaran_tk'])) {
        $total_biaya_pemasaran_tk = 0;
    ...
    //pemasaran KEUANGAN
    $table15k = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pemasaran_keuangan FROM keuangan_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Penjualan & Pemasaran'");
    $data_pemasaran_keuangan =  mysqli_fetch_array($table15k);
    $total_pemasaran_keuangan = $data_pemasaran_keuangan['pemasaran_keuangan'];
    if (!isset($data_pemasaran_keuangan['pemasaran_keuangan'])) {
        $total_pemasaran_keuangan = 0;
    }
    //PEMASARAN PENGELUARAN
    $table15a = mysqli_query($koneksipbr, "SELECT SUM(jumlah_pengeluaran) AS total_pemasaran_kasir FROM riwayat_pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-580' AND referensi = 'MES' OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-580' AND referensi = 'ME'");
    $data_pemasaran_kasir = mysqli_fetch_array($table15a);
    $total_biaya_pemasaran_kasir = $data_pemasaran_kasir['total_pemasaran_kasir'];
    if (!isset($data_pemasaran_kasir['total_pemasaran_kasir'])) {
        $total_biaya_pemasaran_kasir = 0;
    ...
    //pemasaran new
    $table155xx = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS total_pemasaran_new FROM pengeluaran_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Penjualan & Pemasaran' ");
    ...
    $total_biaya_pemasaran = $total_biaya_pemasaran_tk + $total_biaya_pemasaran_kasir + $total_biaya_pemasaran_new + $total_pemasaran_keuangan;

    //BIAYA USAHA LAINNYATK
    //kasir
    $table16 = mysqli_query($koneksipbr, "SELECT SUM(jumlah_pengeluaran) AS total_biaya_usaha_tk FROM riwayat_pengeluaran WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-590' AND referensi = 'MES' OR tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'AND kode_akun = '5-590' AND referensi = 'ME'");
    $data_biaya_usaha_tk = mysqli_fetch_array($table16);
    ...
    $table167xx = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS pengeluaran_lainnya_new FROM pengeluaran_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Pengeluaran Lainnya'  ");
    ...
    //pengeluaran lauinnya KEUANGAN
    $table16k = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS biaya_usaha_keuangan FROM keuangan_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Pengeluaran Lainnya'");
    $data_biaya_usaha_keuangan =  mysqli_fetch_array($table16k);
    $total_biaya_usaha_keuangan = $data_biaya_usaha_keuangan['biaya_usaha_keuangan'];
    ...
    //biaya administrasi KEUANGAN
    $table179xk = mysqli_query($koneksipbr, "SELECT SUM(jumlah) AS biaya_administrasi_keuangan FROM keuangan_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Administrasi'");
    $data_biaya_administrasi_keuangan =  mysqli_fetch_array($table179xk);
    $total_biaya_administrasi_keuangan = $data_biaya_administrasi_keuangan['biaya_administrasi_keuangan'];
    if (!isset($data_biaya_administrasi_keuangan['biaya_administrasi_keuangan'])) {
        $total_biaya_administrasi_keuangan = 0;
    }
    $total_biaya_administrasi_new = $total_biaya_administrasi_new + $total_biaya_administrasi_keuangan;
    ...
    //biaya administrasi new
    $table180x = mysqli_query($koneksicbm, "SELECT SUM(jumlah) AS total_kredit FROM kredit WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'MES' ");
    $data_kredit = mysqli_fetch_array($table180x);
    $total_kredit_kendaraan = $data_kredit['total_kredit'];
    if (!isset($data_kredit['total_kredit'])) {
        $total_kredit_kendaraan = 0;
...
<head>
    ...
    <title>Laporan Laba Rugi MES</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container" style="color : black;">
                    <?php echo "<form  method='POST' action='VLabaRugiMes2' style='margin-bottom: 15px;'>" ?>
                    <div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title" align="Center"><strong>Laporan Laba Rugi MES</strong></h3>
                                </div>
                                        ...
                                        <table class="table table-condensed" style="color : black;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left"><?= formatuang(0); ?></td>
                                                    <?php echo "<td class='text-right'><a href='VRincianLRMES/VRRefillLR?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
                                                <tr>
                                                    <td>4-120</td>
                                                    ...
                                                    <td class="text-left"><?= formatuang(0); ?></td>
                                                    <?php echo "<td class='text-right'><a href='VRincianLRMES/VRBajaIsiLR?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
                                                <tr>
                                                    <td>4-130</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php echo "<td class='text-right'><a href='VRincianLRMES/VRPembelianCBM?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
                                                <tr>
                                                    <td>5-120</td>
                                                    ...
                                                    <?php echo "<td class='text-right'><a href='VRincianLRMES/VRPembelianBIsi?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
                                                <tr>
                                                    <td>5-130</td>
                                                    ...
                                                    <?php echo "<td class='text-right'><a href='VRincianLRMES/VRPembelianBKosong?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
                                                <tr>
                                                    <td>5-200</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php echo "<td class='text-right'><a href='VRincianLRMES/VRTransport?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
                                                <tr>
                                                    <td>5-540</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php echo "<td class='text-right'><a href='VRincianLRMES/VRKonsumsi?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'>Rincian</a></td>"; ?>
                                                </tr>
                                                <tr>
                                                    <td>5-580</td>
