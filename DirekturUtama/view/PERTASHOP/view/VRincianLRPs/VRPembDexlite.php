...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksiperta,"SELECT * FROM pembelian a INNER JOIN pertashop b ON b.kode_perta=a.kode_perta  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_barang = 'Dexlite' AND b.lokasi = '$lokasi' ");
  $table2 = mysqli_query($koneksiperta,"SELECT * FROM barang ");
}
...
<head>
  ...
  <title>Rincian Pembelian Dexlite  <?php echo $lokasi ?></title>
