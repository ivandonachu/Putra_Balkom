...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksiperta, "SELECT * FROM pengeluaran  a INNER JOIN pertashop b ON b.kode_perta=a.kode_perta WHERE tanggal = '$tanggal_awal' AND a.status_saldo = 'Keluar' AND b.lokasi = '$lokasi' ");
}
else{
  $table = mysqli_query($koneksiperta, "SELECT * FROM pengeluaran  a INNER JOIN pertashop b ON b.kode_perta=a.kode_perta WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND a.status_saldo = 'Keluar' AND b.lokasi = '$lokasi'");
}
...
<head>
  ...
  <title>Rincian Pengeluaran Pertashop</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
        <?php echo "<a href='VPengeluaran2?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Rincian Pengeluaran $lokasi</h5></a>"; ?>
...
<div>   
 ...
 <div align="left">
      <?php echo "<a href='VLKeuangan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&lokasi=$lokasi'><button type='button' class='btn btn-primary'>Kembali</button></a>"; ?>
    </div>
    <br>
    <br>
...
<table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table)){
     ...
     <td style='font-size: 14px'>"; ?> <a download="/PERTASHOP/Administrasi/file_karyawan/<?= $file_bukti ?>" href="/PERTASHOP/Administrasi/file_karyawan/<?= $file_bukti ?>"> <?php echo "$file_bukti </a> </td>
     "; ?>
