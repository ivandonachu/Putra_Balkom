...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  //pengeluran Pul Biaya Kantor
   ...
   $table7 = mysqli_query($koneksi, "SELECT SUM(jml_pengeluaran) AS jumlah_perbaikan FROM riwayat_perbaikan_p WHERE tanggal = '$tanggal_awal'");
  ...
  //pengiriman
  $table2 = mysqli_query($koneksi, "SELECT SUM(um) AS uang_makan FROM pengiriman_br WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $data2 = mysqli_fetch_array($table2);
  ...
  $total_dexlite = 0;
  $total_bbm = 0;
  $table222 = mysqli_query($koneksi, "SELECT jt_gps, uj , dexlite FROM pengiriman_br WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
 ...
 //Gaji karyawan
   ...
   $table623 = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_denda_kredit FROM pengeluaran_pul_br WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Denda Kredit' ");
