...
if ($tanggal_awal == $tanggal_akhir) {
  // Tagihan
  $table = mysqli_query($koneksi, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihan a INNER JOIN master_tarif b ON a.delivery_point=b.delivery_point  WHERE tanggal = '$tanggal_awal'  AND no_polisi ='$no_polisilr'");
  ...
  // Kredit Mobil 
  $tablee = mysqli_query($koneksi, "SELECT SUM(jumlah) AS total_kredit FROM kredit_kendaraan WHERE tanggal = '$tanggal_awal'  AND no_polisi ='$no_polisilr'");
  ...
  $total_dexlite = $jml_dex * 9700;
   ...
   $jml_perbaikan = $data7['jumlah_perbaikan'];
    ...
    // Tagihan
  $table = mysqli_query($koneksi, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihan a INNER JOIN master_tarif b ON a.delivery_point=b.delivery_point  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND mt = '$no_polisilr'");
  $data = mysqli_fetch_array($table);
  $total_tagihan= $data['total_tagihan'];
 ...
 //pengiriman
 $table2 = mysqli_query($koneksi, "SELECT SUM(um) AS uang_makan FROM pengiriman a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi = '$no_polisilr'");
 $data2 = mysqli_fetch_array($table2);
 ...
 $total_dexlite = 0;
 $total_bbm = 0;
 $table222 = mysqli_query($koneksi, "SELECT jt_gps, uj, dexlite FROM pengiriman a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi = '$no_polisilr'");
...
$selisih_bbm =  $total_dexlite - $uang_bbm;
 //pengiriman Spbus
 $table2_spbu = mysqli_query($koneksi, "SELECT SUM(dexlite) AS total_dex, SUM(um) AS uang_makan FROM pengiriman_spbu a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi = '$no_polisilr'");
 $data2_spbu = mysqli_fetch_array($table2_spbu);

 $total_um_spbu= $data2_spbu['uang_makan'];
 $total_dexlite_spbu = 0;
 $table222_spbu = mysqli_query($koneksi, "SELECT jt_gps, uj FROM pengiriman_spbu a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi = '$no_polisilr'");
 while($data = mysqli_fetch_array($table222_spbu)){
   ...
   // Tagihan spbu
   $table_spbu = mysqli_query($koneksi, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihan_spbu a INNER JOIN master_tarif_spbu b ON a.delivery_point=b.delivery_point  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND mt = '$no_polisilr'");
   $data_spbu = mysqli_fetch_array($table_spbu);
   $total_tagihan_spbu = $data_spbu['total_tagihan'];
   //pengiriman spbu
   $table2_spbu = mysqli_query($koneksi, "SELECT SUM(a.dexlite) AS total_dex, SUM(a.um) AS uang_makan FROM pengiriman_spbu a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi = '$no_polisilr'");
   $data2_spbu = mysqli_fetch_array($table2_spbu);
  ...
  // Kredit Mobil 
  $tablee = mysqli_query($koneksi, "SELECT SUM(jumlah) AS total_kredit FROM kredit_kendaraan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND no_polisi ='$no_polisilr'");
  $dataa = mysqli_fetch_array($tablee);
  $total_kredit= $dataa['total_kredit'];
    ...
    //pengeluran perbaikan
   $table7 = mysqli_query($koneksi, "SELECT SUM(jml_pengeluaran) AS jumlah_perbaikan FROM riwayat_perbaikan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND no_polisi ='$no_polisilr' ");
   $data7 = mysqli_fetch_array($table7);
   $jml_perbaikan = $data7['jumlah_perbaikan'];
    if (!isset($data7['jumlah_perbaikan'])) {
    $jml_perbaikan = 0;
    ...
    //Gaji dRIVER
    $table9 = mysqli_query($koneksi, "SELECT SUM(a.ug) AS jumlah_gaji FROM pengiriman a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi = '$no_polisilr'");
   ...
   <div class="col-md-12">
      <div class="panel panel-default">
         <div class="panel-heading">
            <h3 class="panel-title" align="Center"><strong>Laba Rugi  <?= $no_polisilr; ?> (Lampung)</strong></h3>
        </div>
        ...
        <div class="panel-body">
            ...
            <tr>
                ...
                <?php echo "<td class='text-right'><a href='VRDriverLMG/VRGaji?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-595</td>
               ...
               <?php echo "<td class='text-right'><a href='VRDriverLMG/VRPerbaikan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-596</td>
                <td class="text-left">Uang Makan Pertashop</td>
                <td class="text-left"><?= formatuang(0); ?></td>
            ...
            <tr>
                ...
                <?php echo "<td class='text-right'><a href='VRDriverLMG/VRDexlite?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-581</td>
