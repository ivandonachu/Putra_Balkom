...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $total_dexlite = 0;
  $total_bbm = 0;
  $table222 = mysqli_query($koneksi, "SELECT jt_gps, uj , dexlite FROM pengiriman_ub a INNER JOIN kendaraan b ON a.no=b.no WHERE  tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  AND b.no_polisi = '$no_polisilr' ");
