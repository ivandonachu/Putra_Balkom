...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VRitaseBl?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Riwayat Ritase BL</h5></a>"; ?>
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table)){
      ...
      $tgl_perbaikan = $data['tgl_perbaikan'];
       ...
       INNER JOIN pengiriman_bl b ON a.no=b.no WHERE tanggal BETWEEN '$tgl_perbaikan' AND '$tanggal_akhir' AND no_polisi = '$no_polisi' ");
