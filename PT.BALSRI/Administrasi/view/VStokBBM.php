...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksi, "SELECT * FROM laporan_stok_bbm WHERE tanggal = '$tanggal_awal' AND lokasi = '$lokasi'");
} else {

    $table = mysqli_query($koneksi, "SELECT * FROM laporan_stok_bbm WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND lokasi = '$lokasi' ");
}
...
<head>
    ...
    <title>Laporan Stok BBM <?= $lokasi ?></title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                    <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Laporan Stok BBM $lokasi</h5></a>"; ?>
                ...
                <div>
                    ...
                    <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                        <div style="margin-right: 100px; margin-left: 100px;">
                            ...
                            <?php echo "<form  method='POST' action='VStokBBM'>" ?>
                            <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div align="right">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i> Catat Laporan Stok BBM </button> <br> <br>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"> Form Laporan Stok BBM </h5>
                                            ...
                                            <div class="modal-body" align="left">
                                                <?php echo "<form action='../proses/proses_stok_bbm?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&lokasix=$lokasi' enctype='multipart/form-data' method='POST'>";  ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <input class="form-control form-control-sm" type="float" name="stok_awal" required="">
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label>BBM Masuk</label>
                                                        <input class="form-control form-control-sm" type="float" name="bbm_masuk" required="">
                                                    </div>
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <label>Losis</label>
                                                        <input class="form-control form-control-sm" type="float" name="losis" required="">
                                                    </div>
                                                </div>
                        ...
                        <table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
                            ...
                            <tbody>
                                ...
                                <?php while ($data = mysqli_fetch_array($table)) {
                                    ...
                                    <td style='font-size: 14px'>$stok_awal</td>
                                    <td style='font-size: 14px'>$bbm_masuk</td>
                                    <td style='font-size: 14px'>$bbm_keluar</td>
                                    <td style='font-size: 14px'>$losis</td>
                                    <td style='font-size: 14px'>$stok_akhir</td>
                                    "; ?>
                                    ...
                                    <div class="modal fade" id="formedit<?php echo $data['no_laporan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Edit Laporan Stok BBM </h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="close">
                                                        <span aria-hidden="true"> &times; </span>
                                                    </button>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <form action="../proses/edit_stok_bbm" enctype="multipart/form-data" method="POST">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <label>Stok awal</label>
                                                                <input class="form-control form-control-sm" type="float" name="stok_awal" required="" value="<?php echo $stok_awal; ?>">
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label>BBM Masuk</label>
                                                                <input class="form-control form-control-sm" type="float" name="bbm_masuk" required="" value="<?php echo $bbm_masuk; ?>">
                                                            </div>
                                                            <div class="col-md-3">
                                                                <label>BBM Keluar</label>
                                                            ...
                                                            <div class="col-md-3">
                                                                <label>Losis</label>
                                                                <input class="form-control form-control-sm" type="float" name="losis" required="" value="<?php echo $losis; ?>">
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="modal fade" id="PopUpHapus<?php echo $data['no_laporan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title"> <b> Hapus Laporan Stok BBM </b> </h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="close">
                                                        <span aria-hidden="true"> &times; </span>
                                                    </button>
                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <form action="../proses/hapus_stok_bbm" method="POST">
                                                        <input type="hidden" name="no_laporan" value="<?php echo $no_laporan; ?>">
                                                        <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
                                                        <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir; ?>">
