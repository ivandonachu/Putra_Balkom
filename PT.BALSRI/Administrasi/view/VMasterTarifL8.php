                      ...
                      <div class="modal-body" align="left">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <input class="form-control form-control-sm" type="text" name="supply_point" required="">
                          </div>
                          <div class="col-md-6">
                            <label>delivery_point</label>
                            <input class="form-control form-control-sm" type="text" name="delivery_point" required="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            ...
                            <input class="form-control form-control-sm" type="number" name="hrg_bbm" required="">
                          </div>
                          <div class="col-md-4">
                            <label>Jarak Tempuh</label>
                            <input class="form-control form-control-sm" type="number" name="jt" required="">
                          </div>
                          <div class="col-md-4">
                            <label>KL 5</label>
                            <input class="form-control form-control-sm" type="float" name="kl5" required="">
                          </div>
                        ...
                        <div class="modal-body">
                          <form action="../proses/edit_master_tarif_L8" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <label>Supply Point</label>
                                <input class="form-control form-control-sm" type="text"  name="supply_point" required="" value="<?php echo $supply_point; ?>">
                              </div>
                              <div class="col-md-6">
                            ...
                            <div class="row">
                              <div class="col-md-4">
                                <label>Harga BBM</label>
                                <input class="form-control form-control-sm" type="number"  name="hrg_bbm" required="" value="<?php echo $hrg_bbm; ?>">
                              </div>
                              <div class="col-md-4">
                                <label>Jarak Tempuh</label>
                              ...
                              <div class="col-md-4">
                                <label>KL 5</label>
                                <input class="form-control form-control-sm" type="float" name="kl5" required="" value="<?php echo $kl5; ?>">
                              </div>
