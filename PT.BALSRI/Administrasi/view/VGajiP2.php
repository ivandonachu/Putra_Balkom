...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksi, "SELECT a.nama_driver , SUM(ug) AS total_gaji FROM driver a INNER JOIN pengiriman_p b ON a.no_driver=b.no_driver WHERE tanggal = '$tanggal_awal' GROUP BY a.nama_driver ");

}
else{

  $table = mysqli_query($koneksi, "SELECT a.nama_driver , SUM(ug) AS total_gaji FROM driver a INNER JOIN pengiriman_p b ON a.no_driver=b.no_driver WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY a.nama_driver ");
