...
$result = mysqli_query($koneksi, "SELECT * FROM tagihan_bl WHERE so = '$so' AND tanggal = '$tanggal' ");
...
$result2 = mysqli_query($koneksi, "SELECT * FROM tagihan_bl WHERE lo = '$lo' AND tanggal = '$tanggal' ");
...
$result3 = mysqli_query($koneksi, "SELECT * FROM master_tarif_bl WHERE delivery_point = '$delivery_point' ");
...
$query = mysqli_query($koneksi,"INSERT INTO tagihan_bl VALUES('','$tanggal','$delivery_point','$so','$lo','$amt','$mt','$kode_pesanan','$total',1,'$file')");
