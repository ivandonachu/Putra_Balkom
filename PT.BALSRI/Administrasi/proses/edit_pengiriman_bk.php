...
$no_driver = $data_driver['no_driver'];
	...
	if ($jns_trans == 'Lost') {
		if ($file == '') {
		$query = mysqli_query($koneksi,"UPDATE pengiriman_bk SET no_driver = '$no_driver' ,no = '$no', muatan = '$muatan', jt_gps = '$jt_gps' , jt_odo = '$jt_odo' , dexlite = '$dexlite', u_dex = '$u_dex', um = '$uang_makan', ug = '$uang_gaji', uj = '$uang_jalan', jns_trans = '$jns_trans', jml_trans = '$total_lost', keterangan = '$keterangan'  , kode_input = '$id1' WHERE no_laporan = '$no_laporan'");
	}
		else{
		$query = mysqli_query($koneksi,"UPDATE pengiriman_b SET no_driver = '$no_driver', no = '$no' , muatan = '$muatan', jt_gps = '$jt_gps' , jt_odo = '$jt_odo' , dexlite = '$dexlite', u_dex = '$u_dex', um = '$uang_makan', ug = '$uang_gaji', uj = '$uang_jalan', jns_trans = '$jns_trans', jml_trans = '$total_lost', keterangan = '$keterangan' , file_bukti = '$file'  , kode_input = '$id1' WHERE no_laporan = '$no_laporan'");
	}
		...
		if ($file == '') {
		$query = mysqli_query($koneksi,"UPDATE pengiriman_bk SET no_driver = '$no_driver' , no = '$no', muatan = '$muatan', jt_gps = '$jt_gps' , jt_odo = '$jt_odo' , dexlite = '$dexlite', u_dex = '$u_dex', um = '$uang_makan', ug = '$uang_gaji', uj = '$uang_jalan', jns_trans = '$jns_trans', jml_trans = '$jml_trans', keterangan = '$keterangan'  , kode_input = '$id1' WHERE no_laporan = '$no_laporan'");
	}
		else{
		$query = mysqli_query($koneksi,"UPDATE pengiriman_bk SET no_driver = '$no_driver', no = '$no' , muatan = '$muatan', jt_gps = '$jt_gps' , jt_odo = '$jt_odo' , dexlite = '$dexlite', u_dex = '$u_dex' um = '$uang_makan', ug = '$uang_gaji', uj = '$uang_jalan', jns_trans = '$jns_trans', jml_trans = '$jml_trans', keterangan = '$keterangan' , file_bukti = '$file'  , kode_input = '$id1' WHERE no_laporan = '$no_laporan'");
	}
