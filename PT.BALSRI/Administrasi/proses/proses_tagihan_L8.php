...
$query = mysqli_query($koneksi,"INSERT INTO tagihan_spbu VALUES('','$tanggal','$delivery_point','$so','$lo','$amt','$mt','$kode_pesanan','$total',1,'$file','$id1')");

if ($query != "") {
echo "<script>alert('Data Proses Berhasil :)'); window.location='../view/VTagihanL8?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir';</script>";exit;
