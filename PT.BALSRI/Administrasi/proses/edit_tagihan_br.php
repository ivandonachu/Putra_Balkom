...
if ($nama_file == "") {
	...
	if ($file == '') {
			$query3 = mysqli_query($koneksi,"UPDATE tagihan_br SET delivery_point = '$delivery_point' , so = '$so', lo = '$lo' , amt = '$amt' , mt = '$mt' , jumlah_pesanan = '$kode_pesanan' , total = '$total' , kode_input = '$id1'  WHERE no_tagihan = '$no_tagihan'");
	}
	else{
			$query3 = mysqli_query($koneksi,"UPDATE tagihan_br SET delivery_point = '$delivery_point' , so = '$so', lo = '$lo' , amt = '$amt' , mt = '$mt' , jumlah_pesanan = '$kode_pesanan' , total = '$total' , file_bukti = '$file' , kode_input = '$id1'  WHERE no_tagihan = '$no_tagihan'");
	}
