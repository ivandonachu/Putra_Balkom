...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  //pengiriman
  $table2 = mysqli_query($koneksi, "SELECT SUM(dexlite) AS total_dex, SUM(um) AS uang_makan FROM pengiriman_bl WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $data2 = mysqli_fetch_array($table2);
  $jml_dex= $data2['total_dex'];
  $total_um= $data2['uang_makan'];
  ...
  //pengeluran Pul Biaya Kantor
   ...
   $jml_perbaikan = $data7['jumlah_perbaikan'];
    ...
    $jml_perbaikan = 0;
     ...
     //Gaji karyawan
   $table8 = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_gaji FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'BALSRI BB' ");
   ...
   $gaji_karyawan = $data8['jumlah_gaji'];
    ...
    //Gaji dRIVER
   $table9 = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_gaji FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'Driver BB' ");
