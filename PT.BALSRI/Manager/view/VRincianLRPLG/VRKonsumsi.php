...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM pengeluaran_pul_p WHERE tanggal = '$tanggal_awal' AND nama_akun = 'Biaya Konsumsi' ");
}
else{
  $table = mysqli_query($koneksi, "SELECT * FROM pengeluaran_pul_p WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_akun = 'Biaya Konsumsi'");
}
