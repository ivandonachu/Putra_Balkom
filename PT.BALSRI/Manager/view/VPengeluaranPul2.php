...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM pengeluaran_pul WHERE tanggal = '$tanggal_awal'");
  $table2 = mysqli_query($koneksibalsri, "SELECT nama_akun , SUM(jumlah) FROM pengeluaran_pul WHERE  tanggal = '$tanggal_awal' GROUP BY nama_akun");
}
else{
  
  $table = mysqli_query($koneksi, "SELECT * FROM pengeluaran_pul WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $table2 = mysqli_query($koneksibalsri, "SELECT nama_akun , SUM(jumlah) AS total_pengeluaran FROM pengeluaran_pul WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_akun");
}
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VPengeluaranPul2?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Pengeluaran PUL LMG</h5></a>"; ?>
...
<table  class="table-sm table-striped table-bordered  nowrap" style="width:auto">
  ...
  <tbody>
    <?php while($data = mysqli_fetch_array($table2)){
      ...
      <td style='font-size: 14px' align = 'center'>$total_pengeluaran</td>
