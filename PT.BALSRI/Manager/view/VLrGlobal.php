...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  //pengeluran Pul Biaya Kantor baturaja
   ...
   $table8_bb = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_gaji FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'BALSRI BB' ");
   ...
   $table9_bb = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_gaji FROM riwayat_penggajian WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND referensi = 'Driver BB' ");
