...
if($lokasi == 'BK 3' || $lokasi == 'Pul Baturaja'){
  ...
  if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksiperta,"SELECT * FROM ngecor WHERE tanggal ='$tanggal_awal' AND nama_barang = 'Pertamax' AND lokasi_cor = '$lokasi2' ");
    $table2 = mysqli_query($koneksiperta,"SELECT * FROM barang ");
  }
  
  else{
    $table = mysqli_query($koneksiperta,"SELECT * FROM ngecor WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND nama_barang = 'Pertamax'  AND lokasi_cor = '$lokasi2' ");
    $table2 = mysqli_query($koneksiperta,"SELECT * FROM barang ");
  }
