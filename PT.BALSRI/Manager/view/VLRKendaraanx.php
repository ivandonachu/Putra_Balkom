...
if ($tanggal_awal == $tanggal_akhir) {
  // Tagihan
  $table = mysqli_query($koneksi, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihanx a INNER JOIN master_tarifx b ON a.no=b.no  WHERE tanggal = '$tanggal_awal'  AND no_polisi ='$no_polisilr'");
  ...
  $total_dexlite = $jml_dex * 9700;
   ...
   $jml_perbaikan = $data7['jumlah_perbaikan'];
    ...
    // Tagihan
  $table = mysqli_query($koneksi, "SELECT SUM(total) AS total_tagihan, SUM(jt) AS total_jt, SUM(rit) AS total_rit  FROM tagihanx a INNER JOIN master_tarifx b ON a.no=b.no  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND mt = '$no_polisilr'");
  $data = mysqli_fetch_array($table);
  $total_tagihan= $data['total_tagihan'];
  //pengiriman
  $table2 = mysqli_query($koneksi, "SELECT SUM(a.dexlite) AS total_dex, SUM(a.um) AS uang_makan FROM pengiriman a INNER JOIN kendaraan b ON a.no=b.no WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND b.no_polisi = '$no_polisilr'");
  $data2 = mysqli_fetch_array($table2);
  $jml_dex= $data2['total_dex'];
  $total_um= $data2['uang_makan'];
...
<div class="container" style="color : black;">
   ...
   <div>
   <div align="left">
      <?php echo "<a href='VLabaRugix?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><button type='button' class='btn btn-primary'>Kembali</button></a>"; ?>
    </div>
</div>
</form>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="table-responsive">
             ...
             <tbody>
                ...
                <tr>
                 ...
                 <?php echo "<td class='text-right'><a href='VRDriverLMGX/VRTagihan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
             </tr>
             <tr>
                 <td>4-101</td>
            ...
            <tr>
                ...
                <?php echo "<td class='text-right'><a href='VRDriverLMGX/VRGaji?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-595</td>
               ...
               <?php echo "<td class='text-right'><a href='VRDriverLMGX/VRPerbaikan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-596</td>
                ...
                <?php echo "<td class='text-right'><a href='VRDriverLMGX/VRMakan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-597</td>
                ...
                <?php echo "<td class='text-right'><a href='VRDriverLMGX/VRDexlite?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir&no_polisi=$no_polisilr'>Rincian</a></td>"; ?>
            </tr>
            <tr>
                <td>5-598</td>
