...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VCatatPerbaikan2?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Pencatatan Perbaikan Kendaraan Latex</h5></a>"; ?>
...
<div>   
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
   <div style="margin-right: 100px; margin-left: 100px;">
    ...
    <?php  echo "<form  method='POST' action='VCatatPerbaikan.php'>" ?>
    <div>
     ...
     <div class="modal-content"> 
       ...
       <div class="row">
        ...
        <div class="col-md-6">
         ...
         <select id="amt" name="amt" class="form-control ">
          <?php
          include 'koneksi.php';
          $result1 = mysqli_query($koneksi, "SELECT * FROM driver_1 ");   

          while ($data1 = mysqli_fetch_array($result1)){
            $nama_driver = $data1['nama_driver_1'];
      ...
      <div class="col-md-6">
        ...
        <select id="mt" name="mt" class="form-control">
          <?php
          include 'koneksi.php';
          $result2 = mysqli_query($koneksi, "SELECT * FROM kendaraan");   
