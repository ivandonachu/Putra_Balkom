...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksi, "SELECT a.tgl_perbaikan ,a.no, a.no_polisi , SUM(rit) AS total_rit , SUM(jt_gps) AS total_jt_gps , SUM(jt_odo) AS total_jt_odo FROM kendaraan a INNER JOIN pengiriman b ON a.no=b.no_kendaraan WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY a.no_polisi ");

}

if ($tanggal_awal == $tanggal_akhir) {

  $table2 = mysqli_query($koneksi, "SELECT  a.nama_driver_1 , SUM(rit) AS total_rit , SUM(jt_gps) AS total_jt_gps , SUM(jt_odo) AS total_jt_odo FROM driver_1 a INNER JOIN pengiriman b ON a.no_driver_1=b.no_driver_1 WHERE tanggal = '$tanggal_awal' GROUP BY a.nama_driver_1 ");

}
else{

  $table2 = mysqli_query($koneksi, "SELECT   a.nama_driver_1 , SUM(rit) AS total_rit , SUM(jt_gps) AS total_jt_gps , SUM(jt_odo) AS total_jt_odo FROM driver_1 a INNER JOIN pengiriman b ON a.no_driver_1=b.no_driver_1 WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY a.nama_driver_1 ");
