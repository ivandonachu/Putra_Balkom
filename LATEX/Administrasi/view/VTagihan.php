...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM tagihan a INNER JOIN driver_1 b on b.no_driver_1=a.no_driver_1
                                                           INNER JOIN driver_2 c on c.no_driver_2=a.no_driver_2
                                                           INNER JOIN kendaraan d on d.no = a.no_kendaraan 
                                                           WHERE tanggal = '$tanggal_awal'");

  $table2 = mysqli_query($koneksi, "SELECT SUM(total) AS total_tagihan, SUM(rit) AS total_rit  FROM tagihan  WHERE tanggal = '$tanggal_awal'");
  ...
  $table2 = mysqli_query($koneksi, "SELECT SUM(total) AS total_tagihan, SUM(rit) AS total_rit  FROM tagihan WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $data2 = mysqli_fetch_array($table2);
  $total_tagihan = $data2['total_tagihan'];
  $total_rit = $data2['total_rit'];
...
<head>
  ...
  <title>Tagihan Angkutan Latex</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
          <?php echo "<a href='VTagihan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Tagihan Angkutan Latex</h5></a>"; ?>
        ...
        <div>
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body" align="left">
                        <?php echo "<form action='../proses/proses_tagihan?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                        ...
                        <div class="col-md-6">
                            <label>AMT 1</label>
                            <select id="tokens" class="selectpicker form-control" name="amt_1" multiple data-live-search="true">
                              <?php
                              include 'koneksi.php';
                              $result3 = mysqli_query($koneksi, "SELECT * FROM driver_1");

                              while ($data3 = mysqli_fetch_array($result3)) {
                                $nama_driver = $data3['nama_driver_1'];
                          ...
                          <div class="col-md-6">
                            <label>AMT 2</label>
                            <select id="tokens" class="selectpicker form-control" name="amt_2" multiple data-live-search="true">
                              <?php
                              include 'koneksi.php';
                             $result = mysqli_query($koneksi, "SELECT * FROM driver_2");

                              while ($data = mysqli_fetch_array($result)) {
                                $nama_driver = $data['nama_driver_2'];
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-6">
                            <label>MT</label>
                            <select id="tokens" class="selectpicker form-control" name="mt" multiple data-live-search="true">
                              <?php
                              include 'koneksi.php';
            ...
            <table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
              ...
              <tbody>
                ...
                <?php while ($data = mysqli_fetch_array($table)) {
                  ...
                  $urut = $urut + 1;
                  $total_max_pesanan = $total_max_pesanan + $total;
                  echo "<tr>
                    ...
                    <div class="modal fade bd-example-modal-lg" id="formedit<?php echo $data['no_tagihan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          ...
                          <!-- Form Edit Data -->
                          <div class="modal-body" align="left">
                            <form action="../proses/edit_tagihan" enctype="multipart/form-data" method="POST">
                              ...
                              <div class="row">
                                ...
                                <label>AMT 2</label>
                                  ...
                                  <select id="tokens" class="selectpicker form-control" name="amt_2" multiple data-live-search="true">
                                    <?php
                                     $dataSelect = $data['nama_driver_2'];
                                     include 'koneksi.php';
                                     $result2 = mysqli_query($koneksi, "SELECT * FROM driver_2 ");
 
                                     while ($data2 = mysqli_fetch_array($result2)) {
                                       $nama_driver = $data2['nama_driver_2'];
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="../proses/hapus_tagihan" method="POST">
          ...
          <button href="#" type="submit" class="fas fa-truck-moving bg-info mr-2 rounded" data-toggle="modal" data-target="#PopUpkirim<?php echo $data['no_tagihan']; ?>" data-toggle='tooltip' title='Pengiriman'>Pengiriman</button>

          <div class="modal fade bd-example-modal-lg" id="PopUpkirim<?php echo $data['no_tagihan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role ="document">
            <div class="modal-content"> 
              <div class="modal-header">
                <h4 class="modal-title"> <b> Catat Pengiriman </b> </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="close">
                  <span aria-hidden="true"> &times; </span>
                </button>
              </div>
                  ...
                  <div class="row">
                              ...
                              <div class="row">
                                ...
                                <label>AMT 2</label>
                                  ...
                                  <select id="tokens" class="selectpicker form-control" disabled name="amt_2" multiple data-live-search="true">
                                    <?php
                                     $dataSelect = $data['nama_driver_2'];
                                     include 'koneksi.php';
                                     $result2 = mysqli_query($koneksi, "SELECT * FROM driver_2 ");
