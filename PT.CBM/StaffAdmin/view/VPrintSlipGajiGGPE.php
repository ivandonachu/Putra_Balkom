...
';
    ...
    while($data = mysqli_fetch_array($table)){
        ...
        <h3 class="panel-title" align="center" >PT GEL GEL PUTRA ENERGI </h3>
        ...
        <pre class="panel-title" align="center"  style="font-size: 8px; margin-bottom: 1px; margin-top: 1px;">email : gelgelputraenergi@gmail.com | Telp. 0811-712-856</pre>
        <hr style = "margin-bottom: 1px; margin-top: 1px;">
