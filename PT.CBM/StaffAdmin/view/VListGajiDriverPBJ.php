...
if (isset($_GET['tanggal1'])) {
 ...
 if ($tanggal_awal == $tanggal_akhir) {
   ...
   $table2 = mysqli_query($koneksipbj,"SELECT * FROM laporan_rit  WHERE tanggal ='$tanggal_awal' GROUP BY nama_driver ");
...
<div>   
  ...
  <?php echo "<form  method='POST' action='VListGajiDriverPBJ' style='margin-bottom: 15px;'>" ?>
            <div>
       ...
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/proses_rekap_gaji_driver_pbj?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
