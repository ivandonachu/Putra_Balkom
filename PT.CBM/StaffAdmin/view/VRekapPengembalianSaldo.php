...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  //balsri kembalikan ke PBJ
  $table_balsri_pbj = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_balsri_pbj FROM pengembalian_saldo_admin  WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND dikembalikan_ke_rekening = 'PBJ' AND rekening_peminjam = 'Balsri' ");
  ...
  //balsri kembalikan ke cbm
  $table_balsri_cbm = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_balsri_cbm FROM pengembalian_saldo_admin  WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND dikembalikan_ke_rekening = 'CBM' AND rekening_peminjam = 'Balsri' ");
  ...
  //balsri kembalikan ke MES
  $table_balsri_mes = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_balsri_mes FROM pengembalian_saldo_admin  WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND dikembalikan_ke_rekening = 'MES' AND rekening_peminjam = 'Balsri' ");
  ...
  //balsri kembalikan ke PBR
  $table_balsri_pbr = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_balsri_pbr FROM pengembalian_saldo_admin  WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND dikembalikan_ke_rekening = 'PBR' AND rekening_peminjam = 'Balsri' ");
  ...
  //balsri kembalikan ke KEBUN LENGKITI
  $table_balsri_lengkiti = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_balsri_lengkiti FROM pengembalian_saldo_admin  WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND dikembalikan_ke_rekening = 'Kebun Lengkiti' AND rekening_peminjam = 'Balsri' ");
  ...
  //balsri kembalikan ke KEBUN SEBERUK
  $table_balsri_seberuk = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_balsri_seberuk FROM pengembalian_saldo_admin  WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND dikembalikan_ke_rekening = 'Kebun Seberuk' AND rekening_peminjam = 'Balsri' ");
  ...
  //PBJ kembalikan ke BALSRI
  $table_pbj_balsri = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_pbj_balsri FROM pengembalian_saldo_admin  WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND dikembalikan_ke_rekening = 'Balsri' AND rekening_peminjam = 'PBJ' ");
  ...
  //PBJ kembalikan ke cbm
  $table_pbj_cbm = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_pbj_cbm FROM pengembalian_saldo_admin  WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND dikembalikan_ke_rekening = 'CBM' AND rekening_peminjam = 'PBJ' ");
  ...
  //PBJ kembalikan ke MES
  $table_pbj_mes = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_pbj_mes FROM pengembalian_saldo_admin  WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND dikembalikan_ke_rekening = 'MES' AND rekening_peminjam = 'PBJ' ");
  ...
  //PBJ kembalikan ke PBR
  $table_pbj_pbr = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_pbj_pbr FROM pengembalian_saldo_admin  WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND dikembalikan_ke_rekening = 'PBR' AND rekening_peminjam = 'PBJ' ");
  ...
  //PBJ kembalikan ke KEBUN LENGKITI
  $table_pbj_lengkiti = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_pbj_lengkiti FROM pengembalian_saldo_admin  WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND dikembalikan_ke_rekening = 'Kebun Lengkiti' AND rekening_peminjam = 'PBJ' ");
  ...
  //PBJ kembalikan ke KEBUN SEBERUK
  $table_pbj_seberuk = mysqli_query($koneksi, "SELECT SUM(jumlah) AS jumlah_pbj_seberuk FROM pengembalian_saldo_admin  WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND dikembalikan_ke_rekening = 'Kebun Seberuk' AND rekening_peminjam = 'PBJ' ");
              ...
              <div style="overflow-x: auto" align='center'>
                <table id="example1" class="table-sm table-striped table-bordered  nowrap" style="width:550px">
                  <thead>
                    ...
                    <th style='font-size: 11px'>Dikembalikan Ke PT</th>
                    <th style='font-size: 11px'>Jumlah Pengembalian</th>
                    </tr>
                  </thead>
                  <tbody>
