...
?>
 ...
 <head>
  ...
  <title>List Gaji Karyawan MES</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VListGajiDriverMES'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>List Gaji Karyawan MES</h5></a>"; ?>
      ...
      <div class="modal fade bd-example-modal-lg" id="input" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <!-- Form Input Data -->
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/proses_list_gaji_mes' enctype='multipart/form-data' method='POST'>";  ?>
      ...
      ?>
        ...
        <?php while($data2 = mysqli_fetch_array($table)){
          ...
          <div class="modal-body">
              <form action="../proses/edit_list_gaji_mes" enctype="multipart/form-data" method="POST">
...
<div class="modal fade" id="PopUpHapus<?php echo $no_karyawan; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
 <div class="modal-dialog" role ="document">
   <div class="modal-content"> 
    ...
    <div class="modal-body">
      <form action="../proses/hapus_list_gaji_mes" method="POST">
        <input type="hidden" name="no_karyawan" value="<?php echo $no_karyawan;?>">
