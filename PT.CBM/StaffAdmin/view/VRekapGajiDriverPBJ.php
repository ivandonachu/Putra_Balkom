...
if (isset($_GET['tanggal1'])) {
  ...
  if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM rekap_gaji_driver_pbj WHERE tanggal = '$tanggal_awal'");
...
<div>   
  ...
  <div class="row">
    ...
    <div class="col-md-2">
      ...
      <div align="right">
      <?php echo "<a href='VPrintSlipGajiDriverPBJ?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' target='_blank'><button style='color:black;
       ...
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/hapus_seluruh_rekap_gaji_driver_pbj?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
       ...
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body" align="left">
            ...
            <?php  echo "<form action='../proses/proses_tambah_rekap_gaji_driver_pbj?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
           ...
           <div class="row">
           <div class="col-md-3">
               <label>Rit Semen</label>
               <input class="form-control form-control-sm" type="number" name="rit_semen" required="" value="0">
             </div>
             <div class="col-md-3">
               <label>Upah Semen</label>
               <input class="form-control form-control-sm" type="number" name="upah_semen" required="" value="0">
             </div>
             <div class="col-md-3">
               <label>Rit Batu</label>
               <input class="form-control form-control-sm" type="number" name="rit_batu" required="" value="0">
             </div>
             <div class="col-md-3">
               <label>Upah Batu</label>
               <input class="form-control form-control-sm" type="number" name="upah_batu" required="" value="0">
             </div>
      ...
      ?>
        ...
        <?php while($data2 = mysqli_fetch_array($table)){
          ...
          <div class="modal-body">
              ...
              <?php  echo "<form action='../proses/edit_rekap_gaji_driver_pbj?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
           ...
           <div class="row">
             <div class="col-md-3">
               <label>Rit Semen</label>
               <input class="form-control form-control-sm" type="number" name="rit_semen" required=""   value="<?php echo $rit_semen;?>">
             </div>
             <div class="col-md-3">
               <label>Upah Semen</label>
               <input class="form-control form-control-sm" type="number" name="upah_semen" required=""  value="<?php echo $upah_semen;?>">
             </div>
             <div class="col-md-3">
               <label>Rit Batu</label>
               <input class="form-control form-control-sm" type="number" name="rit_batu" required="" value="<?php echo $rit_batu;?>">
             </div>
             <div class="col-md-3">
               <label>Upah Batu</label>
               <input class="form-control form-control-sm" type="number" name="upah_batu" required="" value="<?php echo $upah_batu;?>">
             </div>
            ...
            <div class="col-md-4">
             ...
             <div class="col-md-4">
                ...
                <select class="form-control form-control-sm" name="keterangan" class="form-control">
                  ...
                  <option <?php echo ($dataSelect == 'Belum di Transfer') ? "selected" : "" ?>>Belum di Transfer</option>
                </select>
           </div>
           </div>
 ...
 <div class="modal-dialog" role ="document">
   <div class="modal-content"> 
    ...
    <div class="modal-body">
      ...
      <?php  echo "<form action='../proses/hapus_rekap_gaji_driver_pbj?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' method='POST'>";  ?>
        <input type="hidden" name="no_riwayat" value="<?php echo $no_riwayat;?>">
