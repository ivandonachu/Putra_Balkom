...
if (isset($_GET['tanggal1'])) {
  ...
  if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM rekap_gaji_driver_cbm WHERE tanggal = '$tanggal_awal'");
...
?>
 ...
 <head>
  ...
  <title>Rekap Gaji Driver CBM</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VRekapGajiDriverCBM'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Rekap Gaji Driver CBM</h5></a>"; ?>
...
<div>   
  ...
  <div class="row">
    ...
    <div class="col-md-2">
      ...
      <div align="right">
      <?php echo "<a href='VPrintSlipGajiDriverCBM?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' target='_blank'><button style='color:black;
       ...
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/hapus_seluruh_rekap_gaji_driver_cbm?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
       ...
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body" align="left">
            ...
            <?php  echo "<form action='../proses/proses_tambah_rekap_gaji_driver_cbm?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
           ...
           <div class="row">
             <div class="col-md-4">
               <label>Rit Lampung</label>
               <input class="form-control form-control-sm" type="number" name="rit_lampung" required="" value="0">
             </div>
             <div class="col-md-4">
...
<div style="overflow-x: auto" align = 'center';>
  ...
  <thead>
    <tr>  
          ...
          <th style="font-size: 14px" scope="col">Rit Nikan</th>
          <th style="font-size: 14px" scope="col">Upah Nikan</th>
          <th style="font-size: 14px" scope="col">Rit Kota Baru</th>
          ...
          <th style="font-size: 14px" scope="col">Rit Lampung</th>
          <th style="font-size: 14px" scope="col">Upah Lampung</th>
      ...
      ?>
        ...
        <?php while($data2 = mysqli_fetch_array($table)){
          ...
          $rit_nikan = $data2['rit_nikan'];
          $upah_nikan = $data2['upah_nikan'];
          $rit_kota_baru = $data2['rit_kota_baru'];
          ...
          $rit_lampung = $data2['rit_lampung'];
          $upah_lampung = $data2['upah_lampung'];
          ...
          <td style='font-size: 14px'>$rit_nikan</td>
          <td style='font-size: 14px'>"; ?> <?= formatuang($upah_nikan); ?> <?php echo "</td>
          <td style='font-size: 14px'>$rit_kota_baru</td>
          ...
          <td style='font-size: 14px'>"; ?> <?= formatuang($upah_melati); ?> <?php echo "</td>
           <td style='font-size: 14px'>$rit_lampung</td>
          <td style='font-size: 14px'>"; ?> <?= formatuang($upah_lampung); ?> <?php echo "</td>
          ...
          <div class="modal-body">
              ...
              <?php  echo "<form action='../proses/edit_rekap_gaji_driver_cbm?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
           ...
           <div class="col-md-4">
             ...
             <div class="col-md-4">
               <label>Rit Nikan</label>
               <input class="form-control form-control-sm" type="number" name="rit_nikan" required="" value="<?php echo $rit_nikan;?>">
             </div>
           ...
           <div class="col-md-4">
               <label>Rit Kota Baru</label>
               <input class="form-control form-control-sm" type="number" name="rit_kota_baru" required="" value="<?php echo $rit_kota_baru;?>">
             </div>
             <div class="col-md-4">
               <label>Rit Batu Marta</label>
               <input class="form-control form-control-sm" type="number" name="rit_batu_marta" required="" value="<?php echo $rit_batu_marta;?>">
             </div>
             <div class="col-md-4">
               <label>Uang Makan</label>
           ...
           <div class="col-md-6">
             ...
             <div class="col-md-6">
               <label>Rit Lampung</label>
               <input class="form-control form-control-sm" type="number" name="rit_lampung" required="" value="<?php echo $rit_lampung;?>">
             </div>
           </div>
 ...
 <div class="modal-dialog" role ="document">
   <div class="modal-content"> 
    ...
    <div class="modal-body">
      ...
      <?php  echo "<form action='../proses/hapus_rekap_gaji_driver_cbm?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' method='POST'>";  ?>
        <input type="hidden" name="no_riwayat" value="<?php echo $no_riwayat;?>">
