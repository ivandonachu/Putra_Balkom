...
';
    ...
    while($data = mysqli_fetch_array($table)){
        ...
        <h3 class="panel-title" align="Center" style = "margin-bottom: 1px; margin-top: 1px;">PT GEL GEL PUTRA ENERGI</h3>
        ...
        <tr>
        <td align="left" style="font-size: 10px; width:30%; ">Ritase PDPDE DUABELAS BELITANG</td>
        <td align="right" style="font-size: 10px; width:79%;">'. $rit_nje .' Rit</td>
        </tr>
        <tr>
        <td align="left" style="font-size: 10px; width:30%; ">Upah PDPDE DUABELAS BELITANG</td>
        <td align="right" style="font-size: 10px; width:79%;">'. formatuangx($upah_nje) .'</td>
        </tr>
        <tr>
        <td align="left" style="font-size: 10px; width:30%; ">Ritase PDPDE DUABELAS MUARA DUA</td>
        <td align="right" style="font-size: 10px; width:79%;">'. $rit_gas_palembang .' Rit</td>
        </tr>
        <tr>
        <td align="left" style="font-size: 10px; width:30%; ">Upah PDPDE DUABELAS MUARA DUA</td>
