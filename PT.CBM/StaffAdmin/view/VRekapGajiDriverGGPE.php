...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM rekap_gaji_driver_ggpe WHERE tanggal = '$tanggal_awal'");
} else {
  $table = mysqli_query($koneksi, "SELECT * FROM rekap_gaji_driver_ggpe WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
}
...
<head>
  ...
  <title>Rekap Gaji Driver GGPE</title>
      ...
      <div id="content">
        ...
        <div>
          ...
          <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
            ...
            <?php echo "<form  method='POST' action='VRekapGajiDriverGGPE' style='margin-bottom: 15px;'>" ?>
            <div>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                ...
                <div align="right">
                  <?php echo "<a href='VPrintSlipGajiDriverGGPE?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' target='_blank'><button style='color:black;
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body" align="left">
                        <?php echo "<form action='../proses/hapus_seluruh_rekap_gaji_driver_ggpe?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body" align="left">
                        ...
                        <?php echo "<form action='../proses/proses_tambah_rekap_gaji_driver_ggpe?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
              ...
              <table id="example" class="table-sm table-striped table-bordered  nowrap" style="width:auto">
                <thead>
                  <tr>
                    ...
                    <th style="font-size: 14px" scope="col">Rit PDPDE DUABELAS BELITANG</th>
                    <th style="font-size: 14px" scope="col">Upah PDPDE DUABELAS BELITANG</th>
                    <th style="font-size: 14px" scope="col">Rit PDPDE DUABELAS MUARA DUA</th>
                    <th style="font-size: 14px" scope="col">Upah PDPDE DUABELAS MUARA DUA</th>
                      ...
                      <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <?php echo "<form action='../proses/edit_rekap_gaji_driver_ggpe?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-4">
                                <label>Rit PDPDE DUABELAS MUARA DUA</label>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <?php echo "<form action='../proses/hapus_rekap_gaji_driver_ggpe?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' method='POST'>";  ?>
                            <input type="hidden" name="no_riwayat" value="<?php echo $no_riwayat; ?>">
