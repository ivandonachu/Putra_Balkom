      ...
      <div class="modal fade bd-example-modal-lg" id="input" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <!-- Form Input Data -->
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/proses_list_gaji_driver_cbm' enctype='multipart/form-data' method='POST'>";  ?>
           ...
           <div class="row">
             ...
             <div class="col-md-3">
               <label>Upah NJE</label>
               <input class="form-control form-control-sm" type="number" name="upah_nje" required="" value="0">
             </div>
             <div class="col-md-3">
             ...
             <div class="col-md-3">
               <label>Upah Gas Palembang</label>
               <input class="form-control form-control-sm" type="number" name="upah_gas_palembang" required="" value="0">
             </div>
           </div>
      ...
      ?>
        ...
        <?php while($data2 = mysqli_fetch_array($table)){
          ...
          <div class="modal-body">
              <form action="../proses/edit_list_gaji_driver_cbm" enctype="multipart/form-data" method="POST">
           ...
           <div class="row">
             ...
             <div class="col-md-3">
               <label>Upah NJE</label>
               <input class="form-control form-control-sm" type="number" name="upah_nje" required="" value="<?php echo $upah_nje;?>">
             </div>
             <div class="col-md-3">
               <label>Rit Gas Palembang</label>
             ...
             <div class="col-md-3">
               <label>Upah Gas Palembang</label>
               <input class="form-control form-control-sm" type="number" name="upah_gas_palembang" required="" value="<?php echo $upah_gas_palembang;?>">
             </div>
           </div>
...
<div class="modal fade" id="PopUpHapus<?php echo $no_karyawan; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
 <div class="modal-dialog" role ="document">
   <div class="modal-content"> 
    ...
    <div class="modal-body">
      <form action="../proses/hapus_list_gaji_driver_cbm" method="POST">
        <input type="hidden" name="no_karyawan" value="<?php echo $no_karyawan;?>">
