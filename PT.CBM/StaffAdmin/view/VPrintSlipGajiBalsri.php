...
';
    ...
    while($data = mysqli_fetch_array($table)){
        ...
        <h3 class="panel-title" align="Center" style = "margin-bottom: 1px; margin-top: 1px;"><img style=" max-height: 60px; width: 100%; text-align:center; " src="../gambar/Logo Balsri.jpg"> </h3>
        <hr style = "margin-bottom: 1px; margin-top: 1px;">
        <pre class="panel-title" align="center"  style="font-size: 12px; margin-bottom: 1px; margin-top: 1px;"><strong>PT BALSRI LENGIS PERKASA<strong></pre>
        <hr style = "margin-bottom: 1px; margin-top: 1px;">
        <h6 class="panel-title" align="Center" style = "margin-bottom: 1px; margin-top: 1px;"><u><strong>Slip Gaji Karyawan</strong></u></h6>
