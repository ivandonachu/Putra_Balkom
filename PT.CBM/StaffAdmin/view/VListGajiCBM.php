...
<div>   
  ...
  <?php echo "<form  method='POST' action='VListGajiCBM' style='margin-bottom: 15px;'>" ?>
            <div>
       ...
       <div class="modal-dialog modal-lg" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body" align="left">
            <?php  echo "<form action='../proses/proses_rekap_gaji_cbm?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
