...
exit;
    ...
    if($nama_karyawan == 'Septian Andriansyah' || $nama_karyawan == 'Okta Mayasari' || $nama_karyawan == 'Dendi Wibowo'|| $nama_karyawan == 'Dioni Saputra'|| $nama_karyawan == 'Devi Ratnasari' || $nama_karyawan == 'Nyoman Serli' || $nama_karyawan == 'Made Serla'  ){
