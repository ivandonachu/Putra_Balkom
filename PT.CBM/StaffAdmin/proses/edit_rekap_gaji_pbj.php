...
$tunjangan_oprasional = $_POST['tunjangan_oprasional'];
...
$query = mysqli_query($koneksi,"UPDATE rekap_gaji_pbj SET    tanggal = '$tanggal' ,nama_karyawan = '$nama_karyawan', jabatan = '$jabatan' , gaji_pokok = '$gaji_pokok' , tunjangan_jabatan = '$tunjangan_jabatan' , tunjangan_akomodasi = '$tunjangan_akomodasi' , tunjangan_oprasional = '$tunjangan_oprasional' , 
