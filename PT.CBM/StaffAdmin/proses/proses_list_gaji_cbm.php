...
$query = mysqli_query($koneksi,"INSERT INTO list_gaji_cbm VALUES('','$nama_karyawan','$jabatan','$gaji_pokok','$tunjangan_jabatan','$tunjangan_operasional','$tunjangan_asuransi','$uang_makan_bulan','$fee_kehadiran','$lembur'
