...
$keterangan = $_POST['keterangan'];
	...
	$query = mysqli_query($koneksi,"UPDATE list_gaji_cbm SET nama_karyawan = '$nama_karyawan', jabatan = '$jabatan' , gaji_pokok = '$gaji_pokok' , tunjangan_jabatan = '$tunjangan_jabatan' , tunjangan_operasional = '$tunjangan_operasional' , 
                                                             tunjangan_asuransi = '$tunjangan_asuransi', uang_makan_bulan = '$uang_makan_bulan', fee_kehadiran = '$fee_kehadiran', lembur = '$lembur' , absen_terlambat = '$absen_terlambat' , denda_absen = '$denda_absen' 
                                                             , angsuran_bon_bulanan = '$angsuran_bon_bulanan' , bonus = '$bonus' , total_gaji_diterima = '$total_gaji_diterima' , keterangan = '$keterangan'   WHERE no_karyawan = '$no_karyawan'");
