...
if($nama_karyawan == 'Septian Andriansyah' || $nama_karyawan == 'Okta Mayasari' || $nama_karyawan == 'Dendi Wibowo'|| $nama_karyawan == 'Dioni Saputra'|| $nama_karyawan == 'Devi Ratnasari' || $nama_karyawan == 'Komang Riski' ){
    $total_gaji_diterima = $gaji_pokok + $tunjangan_jabatan + $tunjangan_akomodasi + $tunjangan_operasional + $uang_makan_bulan + $fee_kehadiran + $lembur + $bonus + $insentif - $bpjs_kesehatan - $bpjs_ketenagakerjaan  - $angsuran_bon_bulanan;
...
if ($query != "") {
    ...
    echo "<script>alert('Data Berhasil di Ubah :)'); window.location='../view/VRekapGajiCBM?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir';</script>";exit;
