...
$keterangan = $_POST['keterangan'];
	...
	$query = mysqli_query($koneksi,"UPDATE list_gaji_ggpe SET nama_karyawan = '$nama_karyawan', jabatan = '$jabatan' , gaji_pokok = '$gaji_pokok' , tunjangan_jabatan = '$tunjangan_jabatan' , tunjangan_akomodasi = '$tunjangan_akomodasi' , tunjangan_operasional = '$tunjangan_operasional' , 
...
if ($query != "") {
	echo "<script>alert('Data Berhasil di Ubah :)'); window.location='../view/VListGajiGGPE';</script>";exit;
