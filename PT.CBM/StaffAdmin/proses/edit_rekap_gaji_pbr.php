...
$keterangan = $_POST['keterangan'];
	...
	$query = mysqli_query($koneksi,"UPDATE rekap_gaji_pbr SET tanggal = '$tanggal', nama_karyawan = '$nama_karyawan', jabatan = '$jabatan' , gaji_pokok = '$gaji_pokok' , tunjangan_jabatan = '$tunjangan_jabatan', tunjangan_akomodasi = '$tunjangan_akomodasi' , tunjangan_operasional = '$tunjangan_operasional' , 
...
if ($query != "") {
    ...
    echo "<script>alert('Data Berhasil di Ubah :)'); window.location='../view/VRekapGajiPBR?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir';</script>";exit;
