...
$keterangan = $_POST['keterangan'];
	...
	$query = mysqli_query($koneksi,"UPDATE list_gaji_balsri SET nama_karyawan = '$nama_karyawan', jabatan = '$jabatan' , gaji_pokok = '$gaji_pokok' , tunjangan_jabatan = '$tunjangan_jabatan' , tunjangan_akomodasi = '$tunjangan_akomodasi' , 
...
if ($query != "") {
	echo "<script>alert('Data Berhasil di Ubah :)'); window.location='../view/VListGajiBalsri';</script>";exit;
