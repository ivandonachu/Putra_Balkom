...
else if($rekening == 'CBM' && $referensi == 'Kebun Seberuk' ){

}
else if($rekening == 'Kebun Seberuk' && $referensi == 'Kebun Seberuk' ){

}
else if($rekening == 'Kebun Lengkiti' && $referensi == 'Kebun Lengkiti' ){
