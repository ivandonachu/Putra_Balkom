...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksipbr, "SELECT * FROM keuangan_pbr  WHERE tanggal = '$tanggal_awal'");
  $table2 = mysqli_query($koneksipbr, "SELECT nama_akun, SUM(jumlah) AS total_jumlah  FROM keuangan_pbr  WHERE tanggal = '$tanggal_awal' GROUP BY nama_akun");

}
else{

  $table = mysqli_query($koneksipbr, "SELECT * FROM keuangan_pbr a  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $table2 = mysqli_query($koneksipbr, "SELECT nama_akun, SUM(jumlah) AS total_jumlah  FROM keuangan_pbr  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_akun");
...
<div>   
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
    ...
    <?php  echo "<form  method='POST' action='VKeuanganPTPBR' style='margin-bottom: 15px;'>" ?>
    <div>
