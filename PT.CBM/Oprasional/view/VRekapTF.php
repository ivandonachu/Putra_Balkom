...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM rekap_uang_keluar WHERE tanggal = '$tanggal_awal'");
}
else{
  $table = mysqli_query($koneksi, "SELECT * FROM rekap_uang_keluar WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
...
<head>
  ...
  <title>Rekapitulasi Uang Keluar Melody Group</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VBungaBank'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Rekapitulasi Uang Keluar Melody Group</h5></a>"; ?>
...
<div>   
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
    <?php  echo "<form  method='POST' action='VRekapTF' style='margin-bottom: 15px;'>" ?>
    <div>
  ...
  <div class="row">
   ...
   <div class="col-md-6">
    ...
    <div align="right">
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i> Catat Uang Keluar </button> <br> <br>
    </div>
     ...
     <div class="modal-dialog modal-lg" role ="document">
       <div class="modal-content"> 
        <div class="modal-header">
          <h5 class="modal-title"> Form Pencatatan Uang Keluar </h5>
        ...
        <div class="modal-body" align="left">
          <?php  echo "<form action='../proses/proses_rekap_tf?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
        ...
        <div class="col-md-6">
          ...
          <select id="tujuan" name="tujuan" class="form-control">
            <option>Rek BRI Buk Mery</option>
            <option>Rek BRI PBJ</option>
          </select>
        </div>   
...
<table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table)){
     ...
     if($asal == 'CBM' && $tujuan == 'Rek BRI Buk Mery'){
        $cbm_mery = $cbm_mery + $jumlah;
     }
     else if($asal == 'PBJ' && $tujuan == 'Rek BRI Buk Mery'){
        $pbj_mery = $pbj_mery + $jumlah;
     }
     else if($asal == 'Melodi' && $tujuan == 'Rek BRI Buk Mery'){
      $melodi_mery = $melodi_mery + $jumlah;
     }
     else if($asal == 'CBM' && $tujuan == 'Rek BRI PBJ'){
      $cbm_pbj = $cbm_pbj + $jumlah;
      }
    else if($asal == 'PBJ' && $tujuan == 'Rek BRI PBJ'){
          $pbj_pbj = $pbj_pbj + $jumlah;
      }
    else if($asal == 'Melodi' && $tujuan == 'Rek BRI PBJ'){
        $melodi_pbj = $melodi_pbj + $jumlah;
      }
          ...
          <div class="modal-dialog" role ="document">
            <div class="modal-content"> 
              ...
              <div class="modal-body">
                <form action="../proses/edit_rekap_tf" enctype="multipart/form-data" method="POST">
                 ...
                 <div class="col-md-6">
                      ...
                      <select id="tujuan" name="tujuan" class="form-control">
                      <?php $dataSelect = $data['asal']; ?>
                      <option <?php echo ($dataSelect == 'Rek BRI Buk Mery') ? "selected": "" ?> >Rek BRI Buk Mery</option>
                      <option <?php echo ($dataSelect == 'Rek BRI PBJ') ? "selected": "" ?> >Rek BRI PBJ</option>
                      </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <option <?php echo ($dataSelect == 'Bank') ? "selected": "" ?> >Bank</option>
                            <option <?php echo ($dataSelect == 'Terpakai') ? "selected": "" ?> >Terpakai</option>
                            </select>
                            ...
                            <div class="col-md-6">
                             ...
                             <textarea id = "keterangan" name="keterangan" style="width: 215px;"><?php echo $keterangan;?></textarea>
                            </div>           
      ...
      <div class="modal fade" id="PopUpHapus<?php echo $data['no_laporan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
       <div class="modal-dialog" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body">
            <form action="../proses/hapus_rekap_tf" method="POST">
              <input type="hidden" name="no_laporan" value="<?php echo $no_laporan; ?>">
              <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
              <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir;?>">
    ...
    <div class="card border-left-success shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
            Total CBM TF ke BRI Mery</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"> <?= formatuang($cbm_mery)  ?></div>
          </div>
          <div class="col-auto">
            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
          </div>
    ...
    <div class="card border-left-success shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
            Total PBJ TF ke BRI Mery</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"> <?= formatuang($pbj_mery)  ?></div>
          </div>
          <div class="col-auto">
            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
          </div>
    ...
    <div class="card border-left-success shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
            Total Melodi Tani TF ke BRI Mery</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= formatuang($melodi_mery)  ?></div>
          </div>
          <div class="col-auto">
            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
          </div>
    ...
    <div class="card border-left-success shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
            Total CBM TF ke BRI PBJ</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"> <?= formatuang($cbm_pbj)  ?></div>
          </div>
          <div class="col-auto">
            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
          </div>
    ...
    <div class="card border-left-success shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
            Total PBJ TF ke BRI PBJ</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"> <?= formatuang($pbj_pbj)  ?></div>
          </div>
          <div class="col-auto">
            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
          </div>
    ...
    <div class="card border-left-success shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
            Total Melodi Tani TF ke BRI PBJ</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= formatuang($melodi_pbj)  ?></div>
          </div>
          <div class="col-auto">
            <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
          </div>
