...
if ($tanggal_awal == $tanggal_akhir) {
  $table  = mysqli_query($koneksi, "SELECT * FROM riwayat_saldo_armada WHERE tanggal = '$tanggal_awal' AND status_saldo = 'Masuk' AND nama_rekening = 'CBM' AND referensi = 'CBM' 
...
$table = mysqli_query($koneksi, "SELECT * FROM riwayat_saldo_armada  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND status_saldo = 'Masuk' AND nama_rekening = 'CBM' AND referensi ='CBM' 
