...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksipbr, "SELECT * FROM mocash_mes WHERE tanggal = '$tanggal_awal'");
  $table2 = mysqli_query($koneksipbr, "SELECT nama_akun, akun_mocash,  SUM(jumlah) AS total_jumlah FROM mocash_mes  WHERE tanggal = '$tanggal_awal' GROUP BY akun_mocash");
} else {

  $table = mysqli_query($koneksipbr, "SELECT * FROM mocash_mes WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $table2 = mysqli_query($koneksipbr, "SELECT nama_akun, akun_mocash,  SUM(jumlah) AS total_jumlah FROM mocash_mes  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY akun_mocash");
}
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
          <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Mocash MES</h5></a>"; ?>
        ...
        <div>
          ...
          <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
            ...
            <?php echo "<form  method='POST' action='VMocashMES' style='margin-bottom: 15px;'>" ?>
            <div>
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div align="right">
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i> Catat Mocash </button> <br> <br>
                </div>
                <!-- Form Modal  -->
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title"> Form Mocash </h5>
                      ...
                      <div class="modal-body" align="left">
                        <?php echo "<form action='../proses/proses_mocash_mes?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            ...
                            <select class="form-control form-control-sm" name="rekening" class="form-control">
                              <option>BRI Koder</option>
                              <option>BRI Baharuddin</option>
                            </select>
                          </div>
                        </div>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="../proses/edit_mocash_mes" enctype="multipart/form-data" method="POST">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <select class="form-control form-control-sm" name="rekening" class="form-control ">
                                      ...
                                      <option <?php echo ($dataSelect == 'BRI Koder') ? "selected" : "" ?>>BRI Koder</option>
                                      <option <?php echo ($dataSelect == 'BRI Baharuddin') ? "selected" : "" ?>>BRI Baharuddin</option>
                      ...
                      <div class="modal fade bd-example-modal-lg" id="PopUpHapus<?php echo $data['no_pengeluaran']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="../proses/hapus_mocash_mes" method="POST">
                                <input type="hidden" name="no_pengeluaran" value="<?php echo $no_pengeluaran; ?>">
                                <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
                                <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir; ?>">
