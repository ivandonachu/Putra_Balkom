...
if ($tanggal_awal == $tanggal_akhir) {
  ...
  $table = mysqli_query($koneksipbr, "SELECT * FROM pengeluaran_mes  WHERE tanggal = '$tanggal_awal'");
  $table2 = mysqli_query($koneksipbr, "SELECT nama_akun, SUM(jumlah) AS total_jumlah  FROM pengeluaran_mes  WHERE tanggal = '$tanggal_awal' GROUP BY nama_akun");
  ...
  $table = mysqli_query($koneksipbr, "SELECT * FROM pengeluaran_mes  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
  $table2 = mysqli_query($koneksipbr, "SELECT nama_akun, SUM(jumlah) AS total_jumlah  FROM pengeluaran_mes  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_akun");
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VPengeluaranMES?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Pengeluaran MES</h5></a>"; ?>
...
<div>   
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
    ...
    <?php  echo "<form  method='POST' action='VPengeluaranMES' style='margin-bottom: 15px;'>" ?>
    <div>
        ...
        <div class="modal-body" align="left">
          ...
          <div class="col-md-4">
            ...
            <select class="form-control form-control-sm"  name="rekening" class="form-control">
              ...
              <option>BRI Mulia Elpiji Sejahtera</option>
              <option>Cash</option>
            </select>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <select class="form-control form-control-sm"  name="rekening" class="form-control">
              ...
              <option <?php echo ($dataSelect == 'BRI Mulia Elpiji Sejahtera') ? "selected": "" ?> >BRI Mulia Elpiji Sejahtera</option>
...
<h5 align="center" >Rincian Pengeluaran Kebun Kota Batu</h5>
<!-- Tabel -->    
<table class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  <thead>
    <tr>
...
<h5 align="center" >Rincian Pengeluaran Gek Gel</h5>
<!-- Tabel -->    
<table class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  <thead>
    <tr>
