...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksikebun, "SELECT * FROM pengeluaran_keb_mesuji WHERE tanggal = '$tanggal_awal'");
  $table2 = mysqli_query($koneksikebun, "SELECT SUM(jumlah) AS total_pengeluaran  FROM pengeluaran_keb_mesuji 
  WHERE  tanggal = '$tanggal_awal'");
  $data2 = mysqli_fetch_array($table2);
  $total_pengeluaran = $data2['total_pengeluaran'];

  $table3 = mysqli_query($koneksikebun, "SELECT SUM(jumlah) AS total_karet_sawit  FROM pengeluaran_keb_mesuji 
  WHERE  tanggal = '$tanggal_awal' AND referensi = 'Sawit' ");
  $data3 = mysqli_fetch_array($table3);
  $total_karet_sawit = $data3['total_karet_sawit'];

  $table4 = mysqli_query($koneksikebun, "SELECT SUM(jumlah) AS total_buah  FROM pengeluaran_keb_mesuji 
  WHERE  tanggal = '$tanggal_awal' AND referensi = 'Buah' ");
  $data4 = mysqli_fetch_array($table4);
  $total_buah = $data4['total_buah'];

  $table5 = mysqli_query($koneksikebun, "SELECT SUM(jumlah) AS total_umum  FROM pengeluaran_keb_mesuji 
WHERE  tanggal = '$tanggal_awal' AND referensi = 'Umum' ");
  $data5 = mysqli_fetch_array($table5);
  $total_umum = $data5['total_umum'];
} else {
  $table = mysqli_query($koneksikebun, "SELECT * FROM pengeluaran_keb_mesuji WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
      ...
      <div id="content">
        ...
        <div>
          ...
          <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
            <?php echo "<form  method='POST' action='VLPengeluaranMesuji' style='margin-bottom: 15px;'>" ?>
            <div>
