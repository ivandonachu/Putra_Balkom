...
if ($nama_file == "") {
	...
	if ($file == '') {
		...
		$query3 = mysqli_query($koneksi,"UPDATE riwayat_pengeluaran_workshop SET tanggal = '$tanggal' , nama_driver = '$nama_driver' , no_polisi = '$no_polisi' , jumlah_bengkel = '$jumlah_bengkel' , jumlah_sparepart = '$jumlah_sparepart', file_gambar = '$file'   WHERE no_laporan = '$no_laporan'");
	}
