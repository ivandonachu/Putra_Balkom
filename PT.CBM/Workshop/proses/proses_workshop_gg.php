...
if ($nama_file == "") {
	...
	$query = mysqli_query($koneksibalsri,"INSERT INTO riwayat_pengeluaran_workshop_gg VALUES ('','$tanggal','$nama_driver','$no_polisi','$jumlah_bengkel','$jumlah_sparepart','$file')");
