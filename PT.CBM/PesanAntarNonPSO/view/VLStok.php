...
if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM laporan_stok_pesan_antar WHERE tanggal = '$tanggal_awal'");
} else {
    $table = mysqli_query($koneksi, "SELECT * FROM laporan_stok_pesan_antar WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY tanggal ASC");
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                    <?php echo "<a href='VLSaldo'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Laporan Stok</h5></a>"; ?>
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title"> Form Pencatatan Stok </h5>
                                            ...
                                            <div class="modal-body" align="left">
                                                <?php echo "<form action='../proses/proses_stok_pesan_antar?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label>Stok Area</label>
                                                        <select name="stok_area" class="form-control">
                                                            <option>BK 3</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control form-control-sm" type="number" id="B12K11" name="B12K11" value='0' required="">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label>Bright Gas 12 KG Kosong</label>
                                                        <input class="form-control form-control-sm" type="number" id="B12K10" name="B12K10" value='0' required="">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label>Bright Gas 12 KG Retur</label>
                                                        <input class="form-control form-control-sm" type="number" id="B12K00" name="B12K00" value='0' required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <input class="form-control form-control-sm" type="number" id="B05K11" name="B05K11" value='0' required="">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label>Bright Gas 5,5 KG Kosong</label>
                                                        <input class="form-control form-control-sm" type="number" id="B05K10" name="B05K10" value='0' required="">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label>Bright Gas 5,5 KG Retur</label>
                                                        <input class="form-control form-control-sm" type="number" id="B05K00" name="B05K00" value='0' required="">
                                                    </div>
                                                </div>
                            ...
                            <table id="example" class="table-sm table-striped table-bordered  nowrap" style="width:auto">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Stok Area</th>
                                        <th>BG 12 KG Isi</th>
                                        <th>BG 12 KG Kosong</th>
                                        <th>BG 12 KG Retur</th>
                                        <th>BG 5,5 KG Isi</th>
                                        <th>BG 5,5 KG Kosong</th>
                                        <th>BG 5,5 KG Retur</th>
                                        <th></th>
                                ...
                                <tbody>
                                    ...
                                    <?php while ($data = mysqli_fetch_array($table)) {
                                        ...
                                        <td style='font-size: 14px'>$stok_area</td>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="../proses/edit_stok_pesan_antar" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <label>Stok Area</label>
                                                                    <select id="stok_area" name="stok_area" class="form-control">
                                                                        <?php $dataSelect = $data['stok_area']; ?>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <label>Bright Gas 5,5 KG Kosong</label>
                                                                    <input class="form-control form-control-sm" type="number" id="B05K10" name="B05K10" required="" value="<?php echo $B05K10; ?>">
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <label>Bright Gas 5,5 KG Retur</label>
                                        ...
                                        <div class="modal fade" id="PopUpHapus<?php echo $data['no_laporan']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="../proses/hapus_stok_pesan_antar" method="POST">
                                                            <input type="hidden" name="no_laporan" value="<?php echo $no_laporan; ?>">
                                                            <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
                                                            <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir; ?>">
