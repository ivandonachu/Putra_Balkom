...
$table2 = mysqli_query($koneksi, "SELECT * FROM stok_bbm ");
$table3 = mysqli_query($koneksi, "SELECT SUM(jumlah) as total_jumlah, no_polisi  FROM penggunaan_bbm  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY no_polisi  ");
...
?>
 ...
 <br>
  <br>
  <div style="margin-right: 100px; margin-left: 100px;">
  <h6 align="Center">Penggunaan BBM / No Polisi</h6>
<table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  <thead>
      <th>No Polisi</th>
  ...
  <tbody>
    <?php while($data = mysqli_fetch_array($table3)){
      ...
      <td style='font-size: 14px' align = 'center'>$total_jumlah</td>
