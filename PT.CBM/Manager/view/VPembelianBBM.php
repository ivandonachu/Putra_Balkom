  ...
  <tbody>
   ...
   <?php
    ...
    <?php while($data = mysqli_fetch_array($table)){
      ...
      $asal = $data['asal'];
      $total_minyak = $total_minyak + $jumlah;
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            ...
            Total Liter</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_minyak; ?></div>
          </div>
          <div class="col-auto">
      ...
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
            Total Pembelain</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= formatuang($total_uang); ?></div>
          </div>
          <div class="col-auto">
