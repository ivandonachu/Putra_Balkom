       ...
       <!-- Sidebar - Brand -->
             ...
             <!-- Nav Item - Pages Collapse Menu -->
                ...
                <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" style="font-size: 15px;" href="VLPenjualanpbr1">Laporan Penjualan MES/PBR</a>
                        <a class="collapse-item" style="font-size: 15px;" href="VLKeuanganpbr1">Laporan Keuangan MES/PBR</a>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
                ...
                <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header" style="font-size: 15px;">Menu Laporan CBM</h6>
                        <a class="collapse-item" style="font-size: 15px;" href="VLPenjualan1">Laporan Penjualan MES/PBR</a>
                        <a class="collapse-item" style="font-size: 15px;" href="VLKeuangan1">Laporan Keuangan MES/PBR</a>
                    </div>
                </div>
            </li>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VDataKaryawan'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>List Karyawan</h5></a>"; ?>
