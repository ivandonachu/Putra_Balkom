...
<tbody>
    ...
    <?php while($data = mysqli_fetch_array($table)){
      ...
      <?php echo "<td style='font-size: 12px' align = 'center'>"; ?>
       <button href="#" type="button" class="fas fa-pen btn btn-secondary btn-sm mr-2 rounded" data-toggle="modal" data-target="#aksi<?php echo $data['no_sparepart']; ?>">Proses Sparepart</button>
