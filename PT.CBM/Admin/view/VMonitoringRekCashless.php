...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksi, "SELECT * FROM monitoring_rek_cashless_cbm WHERE tanggal = '$tanggal_awal'");
    $table2 = mysqli_query($koneksi, "SELECT nama_akun, rekening,  SUM(jumlah) AS total_jumlah FROM monitoring_rek_cashless_cbm  WHERE tanggal = '$tanggal_awal' GROUP BY nama_akun");
} else {

    $table = mysqli_query($koneksi, "SELECT * FROM monitoring_rek_cashless_cbm WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
    $table2 = mysqli_query($koneksi, "SELECT nama_akun, rekening,  SUM(jumlah) AS total_jumlah FROM monitoring_rek_cashless_cbm  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_akun");
}
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion" style=" background-color: #004445" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="DsAdmini">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                    <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Monitoring Rekening Cashless CBM</h5></a>"; ?>
                ...
                <div>
                    ...
                    <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                        ...
                        <?php echo "<form  method='POST' action='VMonitoringRekCashless' style='margin-bottom: 15px;'>" ?>
                        <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div align="right">
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i> Catat Transaksi </button> <br> <br>
                                </div>
                                <!-- Form Modal  -->
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" align="left">
                                                <?php echo "<form action='../proses/proses_monitoring_rek_cbm?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select class="form-control form-control-sm" name="nama_akun" class="form-control">
                                                            ...
                                                            <option>Pembayaran Pangkalan</option>
                                                            <option>Penebusan</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="../proses/edit_monitoring_rek_cashless_cbm" enctype="multipart/form-data" method="POST">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <select class="form-control form-control-sm" name="nama_akun" class="form-control">
                                                                            ...
                                                                            <option <?php echo ($dataSelect == 'Pembayaran Pangkalan') ? "selected" : "" ?>>Pembayaran Pangkalan</option>
                                                                            <option <?php echo ($dataSelect == 'Penebusan') ? "selected" : "" ?>>Penebusan</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <label>Rekening</label>
                                            ...
                                            <div class="modal fade bd-example-modal-lg" id="PopUpHapus<?php echo $data['no_transaksi']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="../proses/hapus_monitoring_rekening_cashless_cbm" method="POST">
                                                                <input type="hidden" name="no_transaksi" value="<?php echo $no_transaksi; ?>">
                                                                <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
                                                                <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir; ?>">
                        ...
                        <h5 align="center">Rincian Monitoring Rekening Cashless CBM</h5>
                        <!-- Tabel -->
