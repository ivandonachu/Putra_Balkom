...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion" style=" background-color: #004445" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="DsKasirGudang.php">
            ...
            <li class="nav-item active" >
                <a class="nav-link" href="DsKasirGudang.php">
...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
               <a href="VKeberangkatan"><h5 class="text-center sm" style="color:white; margin-top: 8px;  ">Keberangkatan Gudang</h5></a>
...
<div>   
  ...
  <div style="margin-right: 100px; margin-left: 100px;">
      ...
      <?php  echo "<form  method='POST' action='VKeberangkatan2.php'>" ?>
      <div>
