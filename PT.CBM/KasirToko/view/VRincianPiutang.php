...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    INNER JOIN piutang_dagang d ON d.no_transaksi = a.no_transaksi WHERE tanggal = '$tanggal_awal' AND pembayaran = 'Bon' AND status_piutang = 'Sudah di Bayar'");
        ...
        $table = mysqli_query($koneksi, "SELECT * FROM riwayat_penjualan a INNER JOIN kode_akun b ON a.kode_akun=b.kode_akun INNER JOIN baja c ON a.kode_baja=c.kode_baja
       INNER JOIN piutang_dagang d ON d.no_transaksi = a.no_transaksi WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' AND pembayaran = 'Bon' AND status_piutang = 'Sudah di Bayar'");
    }
 ...
 <head>
  ...
  <title>Rincian Pembayayan Piutang Cash Toko</title>
