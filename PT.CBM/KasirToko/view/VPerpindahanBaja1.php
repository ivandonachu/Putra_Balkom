...
$table = mysqli_query($koneksi, "SELECT * FROM riwayat_perpindahan_baja a INNER JOIN baja b ON a.kode_baja=b.kode_baja WHERE referensi = 'TK'");
$table2 = mysqli_query($koneksi, "SELECT * FROM inventory a INNER JOIN baja b ON a.kode_baja=b.kode_baja WHERE b.kode_baja != 'L03K01' AND b.kode_baja != 'L12K01' AND b.kode_baja != 'B05K01' AND b.kode_baja != 'B12K01'");
 ...
 <head>
  ...
  <title>Perpindahan Baja Toko</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VPepindahanBaja1'><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Perpindahan Baja Toko</h5></a>"; ?>
...
<div>   
  ...
  <div class="row">
   ...
   <div class="col-md-2">
    <!-- Button Pindah Baja -->
    <div align="right">
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i> Perpindahan Baja </button> <br> <br>
    </div>
    <!-- Form Modal  -->
     ...
     <div class="modal-dialog modal-lg" role ="document">
       <div class="modal-content"> 
        <div class="modal-header">
          <h5 class="modal-title"> Form Perpindahan Baja </h5>
        ...
        <div class="modal-body" align="left">
          <?php  echo "<form action='../proses/proses_perpindahan_baja' enctype='multipart/form-data' method='POST'>";  ?>
        ...
        <div class="col-md-6">
          ...
          <select id="lokasi_tujuan" name="lokasi_tujuan" class="form-control">
            <option>Gudang</option>
            <option>Toko</option>
          </select>
        </div>            
...
<table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table)){
      ...
      <td style='font-size: 14px'>$lokasi_awal</td>
      <td style='font-size: 14px'>$lokasi_tujuan</td>
       ...
       <div class="modal-dialog" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body">
            <form action="../proses/hapus_perpindahan_baja" method="POST">
              <input type="hidden" name="no_pindah" value="<?php echo $no_pindah;?>">
              <input type="hidden" name="lokasi_awal" value="<?php echo $lokasi_awal; ?>">
              <input type="hidden" name="lokasi_tujuan" value="<?php echo $lokasi_tujuan;?>">
