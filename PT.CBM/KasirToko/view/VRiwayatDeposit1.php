...
if (isset($_GET['tanggal1'])) {
  ...
  if ($tanggal_awal == $tanggal_akhir) {
    $table = mysqli_query($koneksi, "SELECT * FROM riwayat_penjualan a INNER JOIN riwayat_deposit b ON a.no_transaksi=b.no_transaksi INNER JOIN baja c ON c.kode_baja=a.kode_baja WHERE tanggal = '$tanggal_awal'");
 
  } else {
    $table = mysqli_query($koneksi, "SELECT * FROM riwayat_penjualan a INNER JOIN riwayat_deposit b ON a.no_transaksi=b.no_transaksi INNER JOIN baja c ON c.kode_baja=a.kode_baja WHERE tanggal  BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
...
<head>
  ...
  <title>Riwayat Deposit Toko</title>
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <a href="VRiwayatDeposit1"><h5 class="text-center sm" style="color:white; margin-top: 8px; ">Riwayat Deposit Toko</h5></a>
...
<div>   
  ...
  <?php echo "<form  method='POST' action='VRiwayatDeposit1' style='margin-bottom: 15px;'>" ?>
            <div>
    ...
    <table id="example" class="table-sm table-striped table-bordered dt-responsive nowrap" style="width:100%; ">
      ...
      <tbody>
        ...
        <?php while($data = mysqli_fetch_array($table)){
          ...
          <td style='font-size: 14px'>$tanggal_ambil</td>
           ...
           <div class="modal-dialog" role ="document">
             <div class="modal-content"> 
              <div class="modal-header">
                <h4 class="modal-title"> <b> Penyelesaian Deposit</b> </h4>
              ...
              $queryH = mysqli_query($koneksi, "SELECT * FROM riwayat_deposit where no_deposit = '$no_deposit'");
              $dataH = mysqli_fetch_array($queryH);
              ?> 
