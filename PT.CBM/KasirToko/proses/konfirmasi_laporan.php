...
$tanggal = $_POST['tanggal'];
			...
			if ($kasir == 1) {
				...
				if (mysqli_num_rows($result) === 1) {
					...
					$query3 = mysqli_query($koneksi,"UPDATE konfirmasi_laporan  SET  jam_kasir = '$jam',kasir = 1  WHERE no_konfirmasi = '$no_konfirmasi'");
					...
					//input
					$query1 = mysqli_query($koneksi,"INSERT INTO konfirmasi_laporan VALUES ('','$tanggal','','$jam',0,1,0)");
