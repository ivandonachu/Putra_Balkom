...
if ($referensi == 'TK') {
	if ($pembayaran=="Cash") {
		...
		//baja + isi
			...
			$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_b_new' WHERE kode_baja = 'L03K11' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new' WHERE kode_baja = '$kode_baja' ");
			$query3 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal','$no_transaksi','Toko','Keluar','$qty')");
		...
		//isi
			...
			$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_b_new' WHERE kode_baja = 'L03K01' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new' WHERE kode_baja = '$kode_baja' ");
			$query3 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal','$no_transaksi','Toko','Keluar','$qty')");
		//aktivitas rekening
			$akses_rekening = mysqli_query($koneksi, "SELECT * FROM rekening WHERE kode_akun = '1-111'");
		...
		//baja + isi
			...
			$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_b_new' WHERE kode_baja = 'L12K11' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new' WHERE kode_baja = '$kode_baja' ");
			$query3 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal','$no_transaksi','Toko','Keluar','$qty')");
		...
		//isi
			...
			$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_b_new' WHERE kode_baja = 'L12K01' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new' WHERE kode_baja = '$kode_baja' ");
			$query3 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal','$no_transaksi','Toko','Keluar','$qty')");
		//aktivitas rekening
			$akses_rekening = mysqli_query($koneksi, "SELECT * FROM rekening WHERE kode_akun = '1-111'");
		...
		//baja + isi
			...
			$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_b_new' WHERE kode_baja = 'B05K11' ");
		...
		// isi
			...
			$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_b_new' WHERE kode_baja = 'B05K01' ");
		...
		//baja + isi
			...
			$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_b_new' WHERE kode_baja = 'B12K11' ");
		...
		//baja + isi
			...
			$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_b_new' WHERE kode_baja = 'B12K01' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new' WHERE kode_baja = '$kode_baja' ");
			$query3 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal','$no_transaksi','Toko','Keluar','$qty')");
		//aktivitas rekening
			$akses_rekening = mysqli_query($koneksi, "SELECT * FROM rekening WHERE kode_akun = '1-111'");
