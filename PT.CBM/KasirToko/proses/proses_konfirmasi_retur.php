...
$keterangan = $_POST['keterangan'];
		...
		$query = mysqli_query($koneksi,"INSERT INTO riwayat_konfirmasi_retur VALUES ('','$tanggal','TK','$kode_baja','$qty','$keterangan')");
		...
		if ($nama_baja == 'Elpiji 3 Kg Baja + Isi') {
			...
			$jumlah_baja_toko2 = $data_inventory_toko2['toko'];
			...
			$jumlah_baja_ken = $data_inventory_ken['toko'];
			...
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ken_new' WHERE kode_baja = 'L03K00' ");
			$query3= mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_toko_new' WHERE kode_baja = 'L03K01' ");
		...
		elseif ($nama_baja =='Elpiji 12 Kg Baja + Isi') {
			...
			$query1= mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_toko_new' WHERE kode_baja = '$kode_baja' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ken_new' WHERE kode_baja = 'L12K00' ");
			$query3= mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_toko_new' WHERE kode_baja = 'L12K01' ");
		...
		elseif ($nama_baja =='Bright Gas 5,5 Kg Baja + Isi') {
			...
			$query1= mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_toko_new' WHERE kode_baja = '$kode_baja' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ken_new' WHERE kode_baja = 'B05K00' ");
			$query3= mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_toko_new' WHERE kode_baja = 'B05K01' ");
		...
		elseif ($nama_baja =='Bright Gas 12 Kg Baja + Isi') {
			...
			$query1= mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_toko_new' WHERE kode_baja = '$kode_baja' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ken_new' WHERE kode_baja = 'B12K00' ");
			$query3= mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_toko_new' WHERE kode_baja = 'B12K01' ");
