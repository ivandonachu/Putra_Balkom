...
$no_laporan = $_POST['no_laporan'];
		...
		$result = mysqli_query($koneksi, "SELECT * FROM riwayat_pengeluaran WHERE no_pengeluaran = '$no_laporan' ");
		$data_pengeluaran = mysqli_fetch_array($result);
		$kode_akun = $data_pengeluaran['kode_akun'];
		$jumlah = $data_pengeluaran['jumlah_pengeluaran'];

		//hapus
		$query = mysqli_query($koneksi,"DELETE FROM riwayat_pengeluaran WHERE no_pengeluaran = '$no_laporan'");
		//aktivitas rekening
