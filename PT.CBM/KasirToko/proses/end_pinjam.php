	...
	if ($referensi == 'TK') {
		...
		if ($kode_baja == 'L03K11') {
			if ($nama_baja_kembali == 'Elpiji 3 Kg Baja + Isi') {
				...
				$query1 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'L03K01' ");
				$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'L03K11' ");
				$query2 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal_kembali','$no_laporan','Toko','Masuk','$qty_kembali')");
			...
			elseif ($nama_baja_kembali == 'Elpiji 3 Kg Baja Kosong') {
				...
				$query91 = mysqli_query($koneksi,"UPDATE inventory SET dipinjam = '$jumlah_baja_pinjam_new' WHERE kode_baja = 'L03K01' ");
				$query9 = mysqli_query($koneksi,"UPDATE inventory SET dipinjam = '$jumlah_baja_pinjam_new' WHERE kode_baja = 'L03K11' ");
				$query1 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'L03K10' ");
				$query2 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal_kembali','$no_laporan','Toko','Masuk','$qty_kembali')");
		...
		elseif($kode_baja == 'L03K10'){
			if ($nama_baja_kembali == 'Elpiji 3 Kg Baja + Isi') {
				...
				$query1 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'L03K11' ");
				$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'L03K01' ");
				$query2 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal_kembali','$no_laporan','Toko','Masuk','$qty_kembali')");
		...
		elseif($kode_baja == 'L12K11'){
			if ($nama_baja_kembali == 'Elpiji 12 Kg Baja + Isi') {
				...
				$query1 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'L12K01' ");
				$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'L12K11' ");
				$query2 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal_kembali','$no_laporan','Toko','Masuk','$qty_kembali')");
			...
			elseif ($nama_baja_kembali == 'Elpiji 12 Kg Baja Kosong') {
				...
				$query91 = mysqli_query($koneksi,"UPDATE inventory SET dipinjam = '$jumlah_baja_pinjam_new' WHERE kode_baja = 'L12K01' ");
				$query9 = mysqli_query($koneksi,"UPDATE inventory SET dipinjam = '$jumlah_baja_pinjam_new' WHERE kode_baja = 'L12K11' ");
				$query1 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'L12K10' ");
				$query2 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal_kembali','$no_laporan','Toko','Masuk','$qty_kembali')");
		...
		elseif($kode_baja == 'L12K10'){
			if ($nama_baja_kembali == 'Elpiji 12 Kg Baja + Isi') {
				...
				$query1 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'L12K11' ");
				$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'L12K01' ");
				$query2 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal_kembali','$no_laporan','Toko','Masuk','$qty_kembali')");
		...
		elseif($kode_baja == 'B05K11'){
			if ($nama_baja_kembali == 'Bright Gas 5,5 Kg Baja + Isi') {
				...
				$query1 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'B05K01' ");
				$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'B05K11' ");
				$query2 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal_kembali','$no_laporan','Toko','Masuk','$qty_kembali')");
			...
			elseif ($nama_baja_kembali == 'Bright Gas 5,5 Kg Baja Kosong') {
				...
				$query91 = mysqli_query($koneksi,"UPDATE inventory SET dipinjam = '$jumlah_baja_pinjam_new' WHERE kode_baja = 'B05K01' ");
				$query9 = mysqli_query($koneksi,"UPDATE inventory SET dipinjam = '$jumlah_baja_pinjam_new' WHERE kode_baja = 'B05K11' ");
				$query1 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'B05K10' ");
				$query2 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal_kembali','$no_laporan','Toko','Masuk','$qty_kembali')");
		...
		elseif($kode_baja == 'B05K10'){
			if ($nama_baja_kembali == 'Bright Gas 5,5 Kg Baja + Isi') {
				...
				$query1 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'B05K11' ");
				$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'B05K01' ");
				$query2 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal_kembali','$no_laporan','Toko','Masuk','$qty_kembali')");
		...
		elseif($kode_baja == 'B12K11'){
			if ($nama_baja_kembali == 'Bright Gas 12 Kg Baja + Isi') {
				...
				$query1 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'B12K01' ");
				$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'B12K11' ");
				$query2 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal_kembali','$no_laporan','Toko','Masuk','$qty_kembali')");
			...
			elseif ($nama_baja_kembali == 'Bright Gas 12 Kg Baja Kosong') {
				...
				$query91 = mysqli_query($koneksi,"UPDATE inventory SET dipinjam = '$jumlah_baja_pinjam_new' WHERE kode_baja = 'B12K01' ");
				$query9 = mysqli_query($koneksi,"UPDATE inventory SET dipinjam = '$jumlah_baja_pinjam_new' WHERE kode_baja = 'B12K11' ");
				$query1 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'B12K10' ");
				$query2 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal_kembali','$no_laporan','Toko','Masuk','$qty_kembali')");
		...
		elseif($kode_baja == 'B12K10'){
			if ($nama_baja_kembali == 'Bright Gas 12 Kg Baja + Isi') {
				...
				$query1 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'B12K11' ");
				$query11 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_ksg_new' WHERE kode_baja = 'B12K01' ");
				$query2 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal_kembali','$no_laporan','Toko','Masuk','$qty_kembali')");
