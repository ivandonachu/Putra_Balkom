...
if ($referensi == 'TK') {
	...
	if ($nama_baja == "Elpiji 3 Kg Baja + Isi") {
		...
		$query3 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new2' WHERE kode_baja = 'L03K01' ");
		$query4 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal','$no_transaksi','Toko','Keluar','$qty')");
		...
		$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new' WHERE kode_baja = '$kode_baja' ");
		$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new2' WHERE kode_baja = 'L12K01' ");
		...
		$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new' WHERE kode_baja = '$kode_baja' ");
		$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new2' WHERE kode_baja = 'B05K01' ");
		$query3 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal','$no_transaksi','Toko','Keluar','$qty')");
		...
		$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new' WHERE kode_baja = '$kode_baja' ");
		$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new2' WHERE kode_baja = 'B12K01' ");
		$query3 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal','$no_transaksi','Toko','Keluar','$qty')");
...
if ($pembayaran=="Transfer") {
	if ($nama_baja == "Elpiji 3 Kg Baja + Isi") {
		...
		$query10 = mysqli_query($koneksi,"UPDATE inventory SET dipinjam = '$jumlah_baja_pinjam_new2' WHERE kode_baja = 'L03K01' ");
		$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new' WHERE kode_baja = '$kode_baja' ");
		$query2 = mysqli_query($koneksi,"UPDATE inventory SET toko = '$jumlah_baja_isi_new2' WHERE kode_baja = 'L03K01' ");
		$query3 = mysqli_query($koneksi,"INSERT INTO aktivitas_inventory VALUES ('','$tanggal','$no_transaksi','Toko','Keluar','$qty')");
