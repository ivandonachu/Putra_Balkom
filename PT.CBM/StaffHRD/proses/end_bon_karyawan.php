...
if ($jumlah_bayar + $jumlah > $jumlah_bon) {
	echo "<script> alert('Kembalinya Kebanyakan Gaes!'); window.location='../view/VBonKaryawan2?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir';</script>";exit;
	...
	echo "<script> alert('Pembayaran Berhasil!'); window.location='../view/VBonKaryawan2?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir';</script>";exit;
}
