            ...
            <div class="modal-body" align="left">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control form-control-sm"  name="nama_karyawan" >
                        <option>Komang Riski</option>
                        <option>Gede Rio</option>
                        <option>Farhan Zawari</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <select name="nama_karyawan" class="form-control">
                        <?php $dataSelect = $data['nama_karyawan']; ?>
                        <option <?php echo ($dataSelect == 'Komang Riski') ? "selected": "" ?> >Komang Riski</option>
                        <option <?php echo ($dataSelect == 'Gede Rio') ? "selected": "" ?> >Gede Rio</option>
                        <option <?php echo ($dataSelect == 'Farhan Zawari') ? "selected": "" ?> >Farhan Zawari</option>
                    </select>
                  </div>
                </div>
