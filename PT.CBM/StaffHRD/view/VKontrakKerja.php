...
$nama = $data['nama_karyawan'];
  ...
  $table = mysqli_query($koneksi, "SELECT * FROM kontrak_kerja a INNER JOIN seluruh_karyawan b on b.nik=a.nik");
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Kontrak Kerja</h5></a>"; ?>
...
<div>   
  ...
  <div class="row">
   ...
   <div class="col-md-2">
    <!-- Button Pindah Baja -->
    <div align="right">
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#input"> <i class="fas fa-plus-square mr-2"></i> Catat Kontrak Kerja</button> <br> <br>
    </div>
  </div>
</div>
    <!-- Form Modal  -->
     ...
     <div class="modal-dialog modal-lg" role ="document">
       <div class="modal-content"> 
        <div class="modal-header">
          <h5 class="modal-title"> Form Pencatatan Kontrak Kerja </h5>
...
<div style="overflow-x: auto" align = 'center'>
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table)){
      ...
      <td style='font-size: 14px'>$tanggal_bekerja</td>
       ...
       <button href="#" type="button" class="fas fa-edit bg-warning mr-2 rounded" data-toggle="modal" data-target="#formedit<?php echo $data['no_surat']; ?>">Edit</button>
        ...
        <div class="modal fade" id="formedit<?php echo $data['no_surat']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
          <div class="modal-dialog" role ="document">
            <div class="modal-content"> 
              <div class="modal-header">Form Edit Kontrak Kerja </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="close">
                  <span aria-hidden="true"> &times; </span>
                </button>
              </div>
              ...
              <div class="modal-body">
                <form action="../proses/edit_kontrak_kerja" enctype="multipart/form-data" method="POST">
      ...
      <div class="modal fade" id="PopUpHapus<?php echo $data['no_surat']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
       <div class="modal-dialog" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body">
            <form action="../proses/hapus_kontrak_kerja" method="POST">
