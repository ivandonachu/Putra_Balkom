...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi, "SELECT * FROM surat_keluar_masuk WHERE tanggal = '$tanggal_awal' ORDER BY tanggal ASC");
}
else{
  $table = mysqli_query($koneksi, "SELECT * FROM surat_keluar_masuk WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ORDER BY tanggal ASC");
}
...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
    ...
    <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
      <?php echo "<a href='VKasKecil'><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Surat Keluar Masuk</h5></a>"; ?>
...
<div>   
  ...
  <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
    ...
    <?php  echo "<form  method='POST' action='VSuratKeluarMasuk' style='margin-bottom: 15px;'>" ?>
    <div>
     ...
     <div class="modal-dialog modal-lg" role ="document">
       <div class="modal-content"> 
        <div class="modal-header">
          <h5 class="modal-title"> Form Pencatatan Suarat Keluar/Masuk </h5>
        ...
        <div class="modal-body" align="left">
          <?php  echo "<form action='../proses/proses_surat_keluar_masuk?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
        ...
        <div class="col-md-4">
          ...
          <select id="status_surat" name="status_surat" class="form-control">
            <option>Masuk</option>
        ...
        <div class="col-md-4">
            <label>Asal</label>
            <input class="form-control form-control-sm" type="text" id="asal" name="asal"  required="">
          </div>
          <div class="col-md-4">
            <label>Tujuan</label>
            <input class="form-control form-control-sm" type="text" id="tujuan" name="tujuan"  required="">
          </div>
      </div>
...
<div style="overflow-x: auto" align = 'center'>
  ...
  <tbody>
    ...
    <?php while($data = mysqli_fetch_array($table)){
      ...
      <td style='font-size: 14px'>$status_surat</td>
          ...
          <div class="modal-dialog" role ="document">
            <div class="modal-content"> 
              ...
              <div class="modal-body">
                <form action="../proses/edit_surat_keluar_masuk" enctype="multipart/form-data" method="POST">
                ...
                <div class="row">
                    ...
                    <label>Tanggal</label>
                    <div class="col-sm-10">
                    <input type="date" id="tanggal" name="tanggal"  value="<?php echo $tanggal;?>" required="" class="form-control form-control-sm" >
                    </div>
                </div>
                <div class="col-md-6">
                    <label>Perihal</label>
               ...
               <br>
                ...
                <label>Status Surat</label>
                <select id="status_surat" name="status_surat" class="form-control">
                    <?php $dataSelect = $data['status_surat']; ?>
                ...
                <div class="col-md-4">
                    <label>Asal</label>
                    <input class="form-control form-control-sm" type="text" id="asal" name="asal" value="<?php echo $asal;?>" required="">
                </div>
                <div class="col-md-4">
                    <label>Tujuan</label>
      ...
      <div class="modal fade" id="PopUpHapus<?php echo $data['no_surat']; ?>" role="dialog" arialabelledby="modalLabel" aria-hidden="true">
       <div class="modal-dialog" role ="document">
         <div class="modal-content"> 
          ...
          <div class="modal-body">
            <form action="../proses/hapus_surat_keluar_masuk" method="POST">
