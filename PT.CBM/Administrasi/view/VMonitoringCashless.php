...
if ($tanggal_awal == $tanggal_akhir) {
    ...
    $table = mysqli_query($koneksi, "SELECT * FROM monitoring_cashless_cbm WHERE tanggal = '$tanggal_awal'");
    $table2 = mysqli_query($koneksi, "SELECT nama_pangkalan,  SUM(jumlah) AS total_jumlah,  SUM(briva) AS total_briva,  SUM(transaksis_transfer) AS total_transfer  FROM monitoring_cashless_cbm  WHERE tanggal = '$tanggal_awal' GROUP BY nama_pangkalan");
} else {

    $table = mysqli_query($koneksi, "SELECT * FROM monitoring_cashless_cbm WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'");
    $table2 = mysqli_query($koneksi, "SELECT nama_pangkalan,  SUM(jumlah) AS total_jumlah,  SUM(briva) AS jumlah_briva,  SUM(transaksi_transfer) AS jumlah_transfer FROM monitoring_cashless_cbm  WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' GROUP BY nama_pangkalan");
}
...
<head>
    ...
    <title>Monitoring Cashless CBM</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light  topbar mb-4 static-top shadow" style="background-color:#2C7873;">
                    <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px;  '>Monitoring Cashless CBM</h5></a>"; ?>
                ...
                <div>
                    ...
                    <div class="pinggir1" style="margin-right: 20px; margin-left: 20px;">
                        ...
                        <?php echo "<form  method='POST' action='VMonitoringCashless' style='margin-bottom: 15px;'>" ?>
                        <div>
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" align="left">
                                                <?php echo "<form action='../proses/proses_monitoring_cashless_cbm?tanggal1=$tanggal_awal&tanggal2=$tanggal_akhir' enctype='multipart/form-data' method='POST'>";  ?>
                            ...
                            <table id="example" class="table-sm table-striped table-bordered  nowrap" style="width:auto">
                                ...
                                <tbody>
                                    ...
                                    <?php while ($data = mysqli_fetch_array($table)) {
                                        ...
                                        <td style='font-size: 14px'>"; ?> <a download="/PT.CBM/Administrasi/file_administrasi/<?= $file_bukti ?>" href="/PT.CBM/Administrasi/file_administrasi/<?= $file_bukti ?>"> <?php echo "$file_bukti </a> </td>
                                        <td style='font-size: 12px'>"; ?>
                                            ...
                                            <div class="modal fade bd-example-modal-lg" id="formedit<?php echo $data['no_transaksi']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">Form Edit Monitoring Cashles </h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="close">
                                                                <span aria-hidden="true"> &times; </span>
                                                            </button>
                                                        </div>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="../proses/edit_monitoring_cashless_cbm" enctype="multipart/form-data" method="POST">
                                            ...
                                            <div class="modal fade bd-example-modal-lg" id="PopUpHapus<?php echo $data['no_transaksi']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="../proses/hapus_monitoring_cashless_cbm" method="POST">
                                                                <input type="hidden" name="no_transaksi" value="<?php echo $no_transaksi; ?>">
                                                                <input type="hidden" name="tanggal1" value="<?php echo $tanggal_awal; ?>">
                                                                <input type="hidden" name="tanggal2" value="<?php echo $tanggal_akhir; ?>">
