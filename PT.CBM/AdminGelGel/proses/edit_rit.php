...
if($nama_rute == 'PDPDE DUABELAS BELITANG'){
    ...
    $uang_gaji = 200000;
			...
			$query = mysqli_query($koneksi,"UPDATE laporan_rit_ggpe SET  tanggal = '$tanggal', nama_driver = '$nama_driver' ,nama_rute = '$nama_rute' , uang_gaji = '$uang_gaji'   WHERE no_laporan = '$no_laporan'");
