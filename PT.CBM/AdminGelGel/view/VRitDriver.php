...
if ($tanggal_awal == $tanggal_akhir) {
  $table = mysqli_query($koneksi,"SELECT * FROM laporan_rit_ggpe  WHERE tanggal ='$tanggal_awal' ");
  $table2 = mysqli_query($koneksi,"SELECT * FROM laporan_rit_ggpe  WHERE tanggal ='$tanggal_awal' GROUP BY nama_driver ");

}

else{
  $table = mysqli_query($koneksi,"SELECT * FROM laporan_rit_ggpe WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir' ");
...
<div id="content">
    ...
    <?php echo "<a href=''><h5 class='text-center sm' style='color:white; margin-top: 8px; '>Rit Driver GGPE</h5></a>"; ?>
         ...
         <div class="row">
             ...
             <div class="col-md-6">
                ...
                <select id="nama_rute" name="nama_rute" class="form-control">
                    <option>PDPDE DUABELAS BELITANG</option>
                    <option>PDPDE DUABELAS MUARA DUA</option>
                </select>
             </div>  
         </div>
        ...
        <form action="../proses/edit_rit" enctype="multipart/form-data" method="POST">
         ...
         <div class="row">
                ...
                <select id="nama_rute" name="nama_rute" class="form-control">
                    ...
                    <option <?php echo ($dataSelect == 'PDPDE DUABELAS BELITANG') ? "selected": "" ?>>PDPDE DUABELAS BELITANG</option>
                    <option <?php echo ($dataSelect == 'PDPDE DUABELAS MUARA DUA') ? "selected": "" ?>>PDPDE DUABELAS MUARA DUA</option>
                </select>
                </div>          
      </div>
...
<div style="overflow-x: auto" align = 'center';>
  ...
  <thead>
    <tr>
      <th>Nama Driver</th>
      <th>Jabatan</th>
      <th>Rit PDPDE DUABELAS BELITANG</th>
      <th>Upah PDPDE DUABELAS BELITANG</th>
      <th>Rit PDPDE DUABELAS MUARA DUA</th>
      <th>Upah PDPDE DUABELAS MUARA DUA</th>
      <th>Upah Total</th>
    </tr>
  </thead>
  <tbody>
  ...
  ?>
    <?php while($data = mysqli_fetch_array($table2)){
      ...
      $table4 = mysqli_query($koneksi,"SELECT SUM(uang_gaji) AS uang_gaji_gas_palembang , SUM(rit) AS rit_gas_palembang FROM laporan_rit WHERE tanggal BETWEEN '$tanggal_awal' AND '$tanggal_akhir'  AND  nama_driver = '$nama_driver'AND nama_rute = 'PDPDE DUABELAS MUARA DUA'");
