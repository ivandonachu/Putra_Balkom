...
$table = mysqli_query($koneksi, "SELECT * FROM riwayat_perpindahan_baja a INNER JOIN baja b ON a.kode_baja=b.kode_baja WHERE referensi = 'GD' ");
$table2 = mysqli_query($koneksi, "SELECT * FROM inventory a INNER JOIN baja b ON a.kode_baja=b.kode_baja");
 ...
 <head>
  ...
  <title>Perpindahan Baja Gudang</title>
 ...
 <thead>
  ...
  <tbody>
    ...
    <?php while($data2 = mysqli_fetch_array($table2)){
      ...
      $toko =$data2['toko'];
      $gudang = $data2['gudang'];
      $kendaraan = $data2['kendaraan'];
      $dipinjam = $data2['dipinjam'];
      $passive = $data2['passive'];

      $total = $toko + $gudang + $kendaraan + $passive;
