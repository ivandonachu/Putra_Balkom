...
$table = mysqli_query($koneksi, "SELECT * FROM riwayat_konfirmasi_retur a INNER JOIN baja b ON a.kode_baja=b.kode_baja WHERE referensi = 'GD' ");
$table2 = mysqli_query($koneksi, "SELECT * FROM inventory a INNER JOIN baja b ON a.kode_baja=b.kode_baja");
 ...
 <head>
  ...
  <title>Konfirmasi Retur Baja Gudang</title>
