...
if ($lokasi_awal == 'Gudang') {
	if ($lokasi_tujuan =='Mobil') {
		//riwayat pengeluran
		$query = mysqli_query($koneksi,"DELETE FROM riwayat_perpindahan_baja WHERE no_pindah = '$no_pindah'");
		...
		if ($kode_baja == 'L03K11') {
			...
			// baja ken 2
			$akses_inventory_ken2 = mysqli_query($koneksi, "SELECT * FROM inventory WHERE kode_baja = 'L03K10'");
			$data_inventory_ken2 = mysqli_fetch_array($akses_inventory_ken2);
			$jumlah_baja_ken2 = $data_inventory_ken2['kendaraan'];
			$jumlah_baja_ken2_new = $jumlah_baja_ken2 - $qty;			// baja ken 2

			$query1 = mysqli_query($koneksi,"UPDATE inventory SET gudang = '$jumlah_baja_toko2' WHERE kode_baja = 'L03K01' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET kendaraan = '$jumlah_baja_ken2_new' WHERE kode_baja = 'L03K10' ");
			$query3 = mysqli_query($koneksi,"UPDATE inventory SET gudang = '$jumlah_baja_toko1' WHERE kode_baja = '$kode_baja' ");
		...
		elseif ($kode_baja == 'L03K10') {
			...
			$jumlah_baja_ken = $data_inventory_ken['kendaraan'];
			...
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET kendaraan = '$jumlah_baja_ken_new' WHERE kode_baja = '$kode_baja' ");
		...
		elseif ($kode_baja == 'L03K00') {
			...
			$jumlah_baja_toko_new = $jumlah_baja_toko + $qty;
			//baja kendaraan
			$akses_inventory_ken = mysqli_query($koneksi, "SELECT * FROM inventory WHERE kode_baja = 'L03K10'");
			$data_inventory_ken = mysqli_fetch_array($akses_inventory_ken);
			$jumlah_baja_ken = $data_inventory_ken['kendaraan'];
			$jumlah_baja_ken_new = $jumlah_baja_ken - $qty;

			$query1= mysqli_query($koneksi,"UPDATE inventory SET gudang = '$jumlah_baja_toko_new' WHERE kode_baja = '$kode_baja' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET kendaraan = '$jumlah_baja_ken_new' WHERE kode_baja = 'L03K10' ");
		...
		elseif ($kode_baja == 'L12K11') {
			...
			$jumlah_baja_toko2 = $jumlah_baja_b + $qty;
			// baja ken 2
			$akses_inventory_ken2 = mysqli_query($koneksi, "SELECT * FROM inventory WHERE kode_baja = 'L12K10'");
			$data_inventory_ken2 = mysqli_fetch_array($akses_inventory_ken2);
			$jumlah_baja_ken2 = $data_inventory_ken2['kendaraan'];
			$jumlah_baja_ken2_new = $jumlah_baja_ken2 - $qty;			// baja ken 2

			$query1 = mysqli_query($koneksi,"UPDATE inventory SET gudang = '$jumlah_baja_toko2' WHERE kode_baja = 'L12K01' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET kendaraan = '$jumlah_baja_ken2_new' WHERE kode_baja = 'L12K10' ");
			$query3 = mysqli_query($koneksi,"UPDATE inventory SET gudang = '$jumlah_baja_toko1' WHERE kode_baja = '$kode_baja' ");
		...
		elseif ($kode_baja == 'L12K00') {
			...
			$jumlah_baja_toko_new = $jumlah_baja_toko + $qty;
			//baja kendaraan
			$akses_inventory_ken = mysqli_query($koneksi, "SELECT * FROM inventory WHERE kode_baja = 'L12K10'");
			$data_inventory_ken = mysqli_fetch_array($akses_inventory_ken);
			$jumlah_baja_ken = $data_inventory_ken['kendaraan'];
			$jumlah_baja_ken_new = $jumlah_baja_ken - $qty;

			$query1= mysqli_query($koneksi,"UPDATE inventory SET gudang = '$jumlah_baja_toko_new' WHERE kode_baja = '$kode_baja' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET kendaraan = '$jumlah_baja_ken_new' WHERE kode_baja = 'L12K10' ");
		...
		elseif ($kode_baja == 'B05K11') {
			...
			$jumlah_baja_toko1 = $jumlah_baja_isi1 + $qty;
			//baja kendaraan 1
			$akses_inventory_ken1 = mysqli_query($koneksi, "SELECT * FROM inventory WHERE kode_baja = '$kode_baja'");
			$data_inventory_ken1 = mysqli_fetch_array($akses_inventory_ken1);
			$jumlah_baja_ken1 = $data_inventory_ken1['kendaraan'];
			$jumlah_baja_ken1_new = $jumlah_baja_ken1 - $qty;
			//baja toko 2
			...
			$jumlah_baja_toko2 = $jumlah_baja_b + $qty;
			// baja ken 2
			$akses_inventory_ken2 = mysqli_query($koneksi, "SELECT * FROM inventory WHERE kode_baja = 'B05K10'");
			$data_inventory_ken2 = mysqli_fetch_array($akses_inventory_ken2);
			$jumlah_baja_ken2 = $data_inventory_ken2['kendaraan'];
			$jumlah_baja_ken2_new = $jumlah_baja_ken2 - $qty;			// baja ken 2

			$query1 = mysqli_query($koneksi,"UPDATE inventory SET gudang = '$jumlah_baja_toko2' WHERE kode_baja = 'B05K01' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET kendaraan = '$jumlah_baja_ken2_new' WHERE kode_baja = 'B05K10' ");
			$query3 = mysqli_query($koneksi,"UPDATE inventory SET gudang = '$jumlah_baja_toko1' WHERE kode_baja = '$kode_baja' ");
		...
		elseif ($kode_baja == 'B05K00') {
			...
			$jumlah_baja_toko_new = $jumlah_baja_toko + $qty;
			//baja kendaraan
			$akses_inventory_ken = mysqli_query($koneksi, "SELECT * FROM inventory WHERE kode_baja = 'B05K10'");
			$data_inventory_ken = mysqli_fetch_array($akses_inventory_ken);
			$jumlah_baja_ken = $data_inventory_ken['kendaraan'];
			$jumlah_baja_ken_new = $jumlah_baja_ken - $qty;

			$query1= mysqli_query($koneksi,"UPDATE inventory SET gudang = '$jumlah_baja_toko_new' WHERE kode_baja = '$kode_baja' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET kendaraan = '$jumlah_baja_ken_new' WHERE kode_baja = 'B05K10' ");
		...
		elseif ($kode_baja == 'B12K11') {
			...
			$jumlah_baja_toko2 = $jumlah_baja_b + $qty;
			// baja ken 2
			$akses_inventory_ken2 = mysqli_query($koneksi, "SELECT * FROM inventory WHERE kode_baja = 'B12K10'");
			$data_inventory_ken2 = mysqli_fetch_array($akses_inventory_ken2);
			$jumlah_baja_ken2 = $data_inventory_ken2['kendaraan'];
			$jumlah_baja_ken2_new = $jumlah_baja_ken2 - $qty;			// baja ken 2

			$query1 = mysqli_query($koneksi,"UPDATE inventory SET gudang = '$jumlah_baja_toko2' WHERE kode_baja = 'B12K01' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET kendaraan = '$jumlah_baja_ken2_new' WHERE kode_baja = 'B12K10' ");
			$query3 = mysqli_query($koneksi,"UPDATE inventory SET gudang = '$jumlah_baja_toko1' WHERE kode_baja = '$kode_baja' ");
		...
		elseif ($kode_baja == 'B12K00') {
			...
			$jumlah_baja_toko_new = $jumlah_baja_toko + $qty;
			//baja kendaraan
			$akses_inventory_ken = mysqli_query($koneksi, "SELECT * FROM inventory WHERE kode_baja = 'B12K10'");
			$data_inventory_ken = mysqli_fetch_array($akses_inventory_ken);
			$jumlah_baja_ken = $data_inventory_ken['kendaraan'];
			$jumlah_baja_ken_new = $jumlah_baja_ken - $qty;

			$query1= mysqli_query($koneksi,"UPDATE inventory SET gudang = '$jumlah_baja_toko_new' WHERE kode_baja = '$kode_baja' ");
			$query2 = mysqli_query($koneksi,"UPDATE inventory SET kendaraan = '$jumlah_baja_ken_new' WHERE kode_baja = 'B12K10' ");
