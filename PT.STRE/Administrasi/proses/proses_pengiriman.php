...
if ($jns_trans == 'Lost') {
	$query = mysqli_query($koneksi,"INSERT INTO pengiriman VALUES('','$tanggal','$no','$no_driver','$muatan','$rit','$jt_gps','$jt_odo','$dexlite','$u_dex','$uang_makan','$uang_gaji','$uang_jalan','$jns_trans','$total_lost','$keterangan','$file')");

}
else {
	$query = mysqli_query($koneksi,"INSERT INTO pengiriman VALUES('','$tanggal','$no','$no_driver','$muatan','$rit','$jt_gps','$jt_odo','$dexlite','$u_dex','$uang_makan','$uang_gaji','$uang_jalan','$jns_trans','$jml_trans','$keterangan','$file')");
