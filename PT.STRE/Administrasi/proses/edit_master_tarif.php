...
$kl3 = $_POST['kl3'];
		...
		$query = mysqli_query($koneksi,"UPDATE master_tarif SET supply_point = '$supply_point' , kf = '$kf' , sk_pola = '$sk_pola' , jt = '$jt' , hrg_bbm = '$hrg_bbm' , kl1 = '$kl1' , kl2 = '$kl2' , kl3 = '$kl3'  WHERE delivery_point = '$delivery_point'");
